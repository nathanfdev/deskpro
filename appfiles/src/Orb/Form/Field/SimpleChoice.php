 ...
 *
 * This is a "simple choice" field because its not a composite of checkbox or radio fields. It's
 * choices are options on this object instead.
 *
 * The default renderer also allows attribute options 'type' to be 'select', 'checkbox' (multiple), and 'radio' (single)
 */
class SimpleChoice extends Field
{
