...
class InstallController extends \Symfony\Bundle\FrameworkBundle\Controller\Controller
{
	public function indexAction()
	{
		...
		return $this->render('SysBundle:Install:index.html.php', array(
	...
	public function checkAction()
	{
		...
		if (!@file_put_contents(DP_ROOT.'/sys/VERSION', date('Y-m-d H:i:s'))) {
		...
		return $this->render('SysBundle:Install:check.html.php', array(
			'checks' => $checks,
	...
	public function createTablesAction()
	{
		...
		*/
		...
		return $this->render('SysBundle:Install:create-tables.html.php', array(
			'db' => $db,
			'all_sql' => $all_sql
		));
	}
	...
	public function createDataAction()
	{
		...
		return $this->render('SysBundle:Install:create-data.html.php', array(
			'error' => $error,
			'results' => $results
		));
	}
	...
	protected function _createNewUser($output)
	{
		...
		$person['creation_system'] = 'web.agent';
