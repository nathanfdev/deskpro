    ...
    public function step1() {
        ...
        try {
            ...
            App::getDb()->exec("INSERT INTO `deals` (`id`, `deal_type_id`, `deal_stage_id`, `person_id`, `assigned_agent_id`, `currency_id`, `title`, `status`, `probability`, `deal_value`, `visibility`, `date_created`) VALUES
                            (1, 1, 1, 1, 1, 1, 'Deal 1', 0, 0.87, 123456, 0, '2011-11-06 21:11:52'),
                            (2, 2, 1, 1, 1, 2, 'Deal 2', 0, 0.45, 23121, 0, '2011-11-07 00:09:19'),
                            (3, 3, 2, 1, 1, 1, 'Deal 3', 0, 0.45, 23121, 0, '2011-11-07 00:09:19'),
                            (4, 1, 1, NULL, 1, 1, 'Deal 4', 0, 0.45, 23121, 0, '2011-11-07 18:57:47'),
                            (5, 1, 1, 1, 1, 1, 'Deal 5', 0, 0.87, 23121, 0, '2011-11-07 19:03:26'),
                            (6, 1, 1, 1, 1, 1, 'Deal 6', 1, 0.45, 23121, 0, '2011-11-07 19:20:38'),
                            (7, 1, 2, 1, 1, 2, 'Deal 7', 2, 0.45, 23121, 0, '2011-11-07 19:21:40'),
                            (11, 1, 1, NULL, NULL, 1, 'Deal 8', 2, 0.45, 23121, 0, '2011-11-07 19:25:14');");
        } catch (\Exception $e) {
