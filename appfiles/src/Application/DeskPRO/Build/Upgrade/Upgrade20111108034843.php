...
class Upgrade20111108034843 extends UpgradeAbstract {
    ...
    public function step1() {
        ...
        try {
            ...
            App::getDb()->exec("CREATE TABLE IF NOT EXISTS `deals_stage` (
                                  `id` int(11) NOT NULL AUTO_INCREMENT,
                                  `name` varchar(255) NOT NULL,
                                  PRIMARY KEY (`id`)
                                ) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
            ...
            App::getDb()->exec("CREATE TABLE IF NOT EXISTS `deals_type` (
                                  `id` int(11) NOT NULL AUTO_INCREMENT,
                                  `name` varchar(255) NOT NULL,
                                  PRIMARY KEY (`id`)
                                ) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
            ...
            App::getDb()->exec("CREATE TABLE IF NOT EXISTS `deals` (
                              `id` int(11) NOT NULL AUTO_INCREMENT,
            ...
            App::getDb()->exec("CREATE TABLE IF NOT EXISTS `custom_def_deal` (
                              `id` int(11) NOT NULL AUTO_INCREMENT,
            ...
            App::getDb()->exec("CREATE TABLE IF NOT EXISTS `deal_attachments` (
                                  `id` int(11) NOT NULL AUTO_INCREMENT,
            ...
            App::getDb()->exec("INSERT INTO `deals_stage` (`id`, `name`) VALUES
                            (1, 'Proposal'),
                            (2, 'Bid'),
                            (3, 'Demo'),
                            (4, 'Contract'),
            ...
            App::getDb()->exec("INSERT INTO `deals_type` (`id`, `name`) VALUES
                            (1, 'Enterprise Sale '),
                            (2, 'PR Deal '),
                            (3, 'Upgrade Sale'),
                            (4, 'License Transfer');");

            App::getDb()->exec("INSERT INTO `deal_type_stage` (`deal_type_id`, `deal_stage_id`, `display_order`) VALUES
                            (1, 1,1),
                            (1, 2,2),
                            (2, 1, 1),
                            (2, 5, 2),
            ...
            App::getDb()->exec("INSERT INTO `deals` (`id`, `deal_type_id`, `deal_stage_id`, `person_id`, `assigned_agent_id`, `currency_id`, `title`, `status`, `probability`, `deal_value`, `visibility`, `date_created`) VALUES
                            (1, 1, 1, 1, 1, 1, 'Deal 1', 0, 87.0, 123456, 0, '2011-11-06 21:11:52'),
                            (2, 2, 1, 1, 1, 2, 'Deal 2', 0, 45.0, 23121, 0, '2011-11-07 00:09:19'),
                            (3, 3, 2, 1, 1, 1, 'Deal 3', 0, 45.0, 23121, 0, '2011-11-07 00:09:19'),
                            (4, 1, 1, NULL, 1, 1, 'Deal 4', 0, 45.0, 23121, 0, '2011-11-07 18:57:47'),
                            (5, 1, 1, 1, 1, 1, 'Deal 5', 0, 87.0, 23121, 0, '2011-11-07 19:03:26'),
                            (6, 1, 1, 1, 1, 1, 'Deal 6', 1, 45.0, 23121, 0, '2011-11-07 19:20:38'),
                            (7, 1, 2, 1, 1, 2, 'Deal 7', 2, 45.0, 23121, 0, '2011-11-07 19:21:40'),
                            (11, 1, 1, NULL, NULL, 1, 'Deal 8', 2, 45.0, 23121, 0, '2011-11-07 19:25:14');");
        } catch (\Exception $e) {
