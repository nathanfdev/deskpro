...
class Upgrade20111102111118 extends UpgradeAbstract
{
	public function step1()
	{
		...
		try {
			...
			App::getDb()->exec("CREATE TABLE stat_dashboard (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, date_created DATETIME NOT NULL, PRIMARY KEY(id)) ENGINE = InnoDB;");
		} catch (\Exception $e) {
