...
class Upgrade20111028232230 extends UpgradeAbstract
{
	public function step1()
	{
		...
		try {
			...
			App::getDb()->exec("CREATE TABLE idea_category2usergroup (category_id INT NOT NULL, usergroup_id INT NOT NULL, INDEX IDX_878F350B12469DE2 (category_id), INDEX IDX_878F350BD2112630 (usergroup_id), PRIMARY KEY(category_id, usergroup_id)) ENGINE = InnoDB");
			App::getDb()->exec("ALTER TABLE idea_category2usergroup ADD FOREIGN KEY (category_id) REFERENCES idea_categories(id) ON DELETE CASCADE");
			App::getDb()->exec("ALTER TABLE idea_category2usergroup ADD FOREIGN KEY (usergroup_id) REFERENCES usergroups(id) ON DELETE CASCADE");
			...
			App::getDb()->exec("ALTER TABLE idea_category_permissions ADD FOREIGN KEY (category_id) REFERENCES download_categories(id) ON DELETE CASCADE");
