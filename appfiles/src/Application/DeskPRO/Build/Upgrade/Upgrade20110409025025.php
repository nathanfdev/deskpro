...
class Upgrade20110409025025 extends UpgradeAbstract
{
	public function step1()
	{
		...
		try {
			...
			App::getDb()->exec("CREATE TABLE IF NOT EXISTS visitors (id INT AUTO_INCREMENT NOT NULL, person_id INT DEFAULT NULL, auth VARCHAR(15) NOT NULL, ip_address VARCHAR(80) NOT NULL, user_agent VARCHAR(255) NOT NULL, date_created DATETIME NOT NULL, date_last DATETIME NOT NULL, INDEX IDX_7B74A43F217BBB47 (person_id), INDEX date_last_idx (date_last), PRIMARY KEY(id)) ENGINE = InnoDB");
		} catch (\Exception $e) {
