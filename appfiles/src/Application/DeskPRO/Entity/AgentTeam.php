...
class AgentTeam extends \Application\DeskPRO\Domain\DomainObject
{
     ...
     * @orm:JoinTable(name="AgentTeamMember", joinColumns={@orm:JoinColumn(name="person_id", referencedColumnName="id")}, inverseJoinColumns={@orm:JoinColumn(name="team_id", referencedColumnName="id")})
