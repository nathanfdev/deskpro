...
class Person extends \Application\DeskPRO\Domain\DomainObject
{
    ...
    /**
     * Set is_agent_confirmed
     *
     * @param boolean $isAgentConfirmed
     */
    public function setIsAgentConfirmed($isAgentConfirmed)
    {
        $this->is_agent_confirmed = $isAgentConfirmed;
    }
    ...
    {
        return $this->is_agent_confirmed;
    }
    ...
    /**
     * Set organization_position
     *
     * @param string $organizationPosition
     */
    public function setOrganizationPosition($organizationPosition)
    {
        $this->organization_position = $organizationPosition;
    }
    ...
    /**
     * Set date_picture_check
     *
     * @param datetime $datePictureCheck
     */
    public function setDatePictureCheck($datePictureCheck)
    {
        $this->date_picture_check = $datePictureCheck;
    }
    ...
    {
        return $this->date_picture_check;
    }
     ...
     */
    public function setLocale(\Application\DeskPRO\Entity\Locale $locale)
    {
        $this->locale = $locale;
    }
     ...
     * Set primary_email
     *
     * @param Application\DeskPRO\Entity\PersonEmail $primaryEmail
     */
    public function setPrimaryEmail(\Application\DeskPRO\Entity\PersonEmail $primaryEmail)
    {
     ...
     * Add emails
     *
     * @param Application\DeskPRO\Entity\PersonEmail $emails
     */
    public function addPersonEmail(\Application\DeskPRO\Entity\PersonEmail $emails)
    {
        $this->emails[] = $emails;
    }
     ...
     * Add labels
     *
     * @param Application\DeskPRO\Entity\LabelPerson $labels
     */
    public function addLabelPerson(\Application\DeskPRO\Entity\LabelPerson $labels)
    {
        $this->labels[] = $labels;
    }
     ...
     * Add custom_data
     *
     * @param Application\DeskPRO\Entity\CustomDataPerson $customData
     */
    public function addCustomDataPerson(\Application\DeskPRO\Entity\CustomDataPerson $customData)
    {
     ...
     * Add contact_data
     *
     * @param Application\DeskPRO\Entity\PersonContactData $contactData
     */
    public function addPersonContactData(\Application\DeskPRO\Entity\PersonContactData $contactData)
    {
     ...
     * Add preferences
     *
     * @param Application\DeskPRO\Entity\PersonPref $preferences
     */
    public function addPersonPref(\Application\DeskPRO\Entity\PersonPref $preferences)
    {
    ...
    /**
     * Add usersource_assoc
     *
     * @param Application\DeskPRO\Entity\PersonUsersourceAssoc $usersourceAssoc
     */
    public function addPersonUsersourceAssoc(\Application\DeskPRO\Entity\PersonUsersourceAssoc $usersourceAssoc)
    {
        $this->usersource_assoc[] = $usersourceAssoc;
    }
    ...
    /**
     * Add personscraper_assoc
     *
     * @param Application\DeskPRO\Entity\PersonScraperAssoc $personscraperAssoc
     */
    public function addPersonScraperAssoc(\Application\DeskPRO\Entity\PersonScraperAssoc $personscraperAssoc)
    {
        $this->personscraper_assoc[] = $personscraperAssoc;
    }
    ...
    {
        return $this->personscraper_assoc;
    }

    /**
     * Add twitter_accounts
     *
     * @param Application\DeskPRO\Entity\TwitterAccount $twitterAccounts
     */
    public function addTwitterAccount(\Application\DeskPRO\Entity\TwitterAccount $twitterAccounts)
    {
        $this->twitter_accounts[] = $twitterAccounts;
    }
    ...
    /**
     * Add twitter_status_notes
     *
     * @param Application\DeskPRO\Entity\TwitterStatusNote $twitterStatusNotes
     */
    public function addTwitterStatusNote(\Application\DeskPRO\Entity\TwitterStatusNote $twitterStatusNotes)
    {
        $this->twitter_status_notes[] = $twitterStatusNotes;
    }
    ...
    {
        return $this->twitter_status_notes;
    }

    /**
     * Add created_tasks
     *
     * @param Application\DeskPRO\Entity\Task $createdTasks
     */
    public function addTask(\Application\DeskPRO\Entity\Task $createdTasks)
    {
        $this->created_tasks[] = $createdTasks;
    }
     ...
     * Add task_comments
     *
     * @param Application\DeskPRO\Entity\TaskComment $taskComments
     */
    public function addTaskComment(\Application\DeskPRO\Entity\TaskComment $taskComments)
    {
     ...
     *
     * @param Application\DeskPRO\Entity\TaskAssociatedPerson $taskAssociations
     */
    public function addTaskAssociatedPerson(\Application\DeskPRO\Entity\TaskAssociatedPerson $taskAssociations)
    {
