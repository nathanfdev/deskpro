...
/**
 * Defines what custom fields and widgets are displayed on tickets.
 *
 * @orm:Entity
 * @orm:Table(name="department_ticket_display")
 */
class DepartmentTicketDisplay extends \Application\DeskPRO\Domain\DomainObject
{
	/**
	 * @var int
	...
	/**
	 * Is this element only applicable in the agent interface?
	 *
	 * @var bool
	 * @orm:Column(name="is_agent_only", type="boolean")
	 */
	protected $is_agent_only = false;
