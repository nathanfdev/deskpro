...
<form action="<?php echo $view['router']->generate('dev_cm') ?>" method="post">
	...
	For Person ID: <input type="text" name="client_message[for_person_id]" value="<?php echo $cm->for_person ? $cm->for_person->id : ''; ?>" /><br />
	Data (k=v for arrays): <textarea name="client_message[data]"><?php echo $data_str; ?></textarea><br />
