...
/**
 * Get the total amount of time a user is awaiting for a ticket to be resolved
 */
class TotalUserWaitingTicketResolvedTime extends AbstractTicket
{
	...
	public function buildConceptQueries()
	{
		...
		$query = $this->createQuery()
		      ->select('SUM(t.total_user_waiting) AS user_waiting')
		      ->from('tickets', 't')
