...
DeskPRO.Agent.PageFragment.NavPane.TicketFlagged = new Class({
	...
	initPage: function(el) {
		...
		// Set up listener
		DeskPRO_Window.getMessageBroker().addMessageListener('filter-flagged.counts', this.updateCounts.bind(this));
		DeskPRO_Window.getMessageBroker().addMessageListener('filter-flagged.view-activated', this.highlightActiveFlag.bind(this));
		DeskPRO_Window.getMessageBroker().addMessageListener('filter-flagged.view-deactivated', this.unhighlightActiveFlag.bind(this));
		DeskPRO_Window.getMessageBroker().addMessageListener('filter-flagged.flag-changed', this.changeCountsForSwitch.bind(this));
	},
