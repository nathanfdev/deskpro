...
{
	protected function appToUsersource(AppInstance $app, Usersource $us, EntityManager $em)
	{
		$us->options           = array(
	...
	{
		$this->appToUsersource($context->getApp(), $context->getUsersource(), $context->getEm());
	}
