...
class TicketCustomFieldsDataService extends AbstractDataService
{
    ...
    {
        return $this->getEm()->getRepository('DeskPRO:CustomDefTicket')->findAll();
    }

    public function getCustomFieldsForTicket($ticket_id)
    {
        $ticket = $this->getEm()->getRepository('DeskPRO:Ticket')->find($ticket_id);
    ...
    public function getSingleCustomFieldForTicket($ticket_id, $field_id)
    {
        ...
        $repo = $this->getEm()->getRepository('DeskPRO:CustomDataTicket');
