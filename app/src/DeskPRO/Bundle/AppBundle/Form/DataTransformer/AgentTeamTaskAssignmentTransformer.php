...
class AgentTeamTaskAssignmentTransformer implements DataTransformerInterface
{
    /**
     * @var EntityManager
     */
    ...
    /**
     * Transform a Task Assignment into a team.
     *
    ...
    /**
     * Transform a team entity into a Task Assignment.
     *
     * @param string $team
     *
    ...
    public function reverseTransform($team)
    {
        ...
        $member = $this->entityManager->getRepository('App:TaskAssignment')
            ->findOneBy(array('team' => $team, 'task' => $this->task));
