...
/**
 * Class PrimaryEmailConstraintValidator.
 */
class PrimaryEmailConstraintValidator extends ConstraintValidator
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        if (!$constraint instanceof PrimaryEmailConstraint) {
            throw new \Exception('Expected PersonPrimaryEmailConstraint instance, got '.$constraint);
        }
