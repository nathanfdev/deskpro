...
class AgentPermissionsManager
{
    public function getPermissionsBagForAgent(Person $person)
    {
        ...
        // the implementation details behind this will be different than the PortalPermissionsManager, but you can
        // look at that class to see how we do it for Portal.
    }
}
