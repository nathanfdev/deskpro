...
class TeamsController extends BaseController implements ClassResourceInterface
{
    /**
     * @ApiDoc(
     ...
     *      }
     * )
     * @Get("/teams", name="api_teams")
     * @param Request $request
     * @return View
     */
    public function cgetAction(Request $request)
    {
        $teams = $this->getDoctrine()->getManager()->getRepository('DeskPRO:AgentTeam')->findAll();

        $page = $request->query->get('page', 1);
        $count = $request->query->get('count', 10);

        $pager = new Pagerfanta(new ArrayAdapter($teams));
     ...
     * )
     * @Get("/teams/{id}", name="api_teams_get")
     * @param int $id
     * @return View
     */
     ...
     *      output="Application\DeskPRO\Entity\AgentTeam"
     * )
     * @Post("/teams", name="api_teams_post")
     * @param Request $request
     ...
     *      }
     * )
     * @Put("/teams/{id}", name="api_teams_put")
     * @param Request $request
     * @param $id
     * @throws WrappedApiErrorException
     * @return View
     ...
     *      }
     * )
     * @Delete("/teams/{id}", name="api_teams_delete")
     * @param $id
     * @return View
     */
