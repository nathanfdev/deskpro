...
/**
 * Class PeopleNamesController
 */
class PeopleNamesController extends BaseController implements ClassResourceInterface
{
    /**
     * @ApiDoc(
     ...
     *              "name"="ids",
     *              "requirement"="\d+[,\d]+",
     *              "description"="comma separated people ids",
     *              "dataType"="string",
     *              "required"=true
     *          }
     *      },
     ...
     */
    private function selectPeopleNames(array $ids)
    {
