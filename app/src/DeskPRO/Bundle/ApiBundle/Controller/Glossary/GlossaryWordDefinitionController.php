...
{
    static $entity = \Application\DeskPRO\Entity\GlossaryWordDefinition::class;
    static $type   = \DeskPRO\Bundle\AppBundle\Form\Type\Glossary\GlossaryWordDefinitionType::class;
}