...
class CustomDataFeedbackType extends AbstractType
{
    /**
    ...
    public function preDataEvent(FormEvent $event)
    {
        ...
        /** @var \Application\DeskPRO\Entity\CustomDefFeedback $custom_data_field */
    ...
    {
        return 'deskpro_custom_data_feedback';
    }
}
