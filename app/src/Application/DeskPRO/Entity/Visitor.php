...
class Visitor extends \Application\DeskPRO\Domain\DomainObject
{
	...
	{
		$this->setModelField('id', VisitorIdentificationProvider::generateRandomIdentifier());
	...
	public static function loadMetadata(ClassMetadata $metadata)
	{
		...
		$metadata->mapField(array( 'fieldName' => 'id', 'type' => 'string', 'precision' => 0, 'scale' => 0, 'nullable' => false, 'columnName' => 'id', 'id' => true, ));
