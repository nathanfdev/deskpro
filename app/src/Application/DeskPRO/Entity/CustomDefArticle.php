 ...
 *
 * @ORM_Mapping\Entity(repositoryClass="Application\DeskPRO\EntityRepository\CustomDefArticle")
 * @ORM_Mapping\HasLifecycleCallbacks
 * @ORM_Mapping\Table(name="custom_def_article")
 */
class CustomDefArticle extends CustomDefAbstract
{
	 ...
	 * @ORM_Mapping\OneToMany(targetEntity="CustomDefArticle", mappedBy="parent", cascade={"persist", "remove", "merge"}, fetch="EAGER")
	...
	public static function loadMetadata(ClassMetadata $metadata)
	{
		...
		$metadata->customRepositoryClassName = 'Application\DeskPRO\EntityRepository\CustomDefArticle'; 
		$metadata->setPrimaryTable(array( 'name' => 'custom_def_article', )); 
		...
		$metadata->mapOneToOne(array( 'fieldName' => 'parent', 'targetEntity' => 'Application\\DeskPRO\\Entity\\CustomDefArticle', 'cascade' => array( ), 'mappedBy' => NULL, 'inversedBy' => 'children', 'joinColumns' => array( 0 => array( 'name' => 'parent_id', 'referencedColumnName' => 'id', 'unique' => false, 'nullable' => true, 'onDelete' => 'cascade', 'columnDefinition' => NULL, ), ), 'orphanRemoval' => false, )); 
		$metadata->mapOneToMany(array( 'fieldName' => 'children', 'targetEntity' => 'Application\\DeskPRO\\Entity\\CustomDefArticle', 'cascade' => array( 0 => 'remove', 1 => 'persist', 3 => 'merge', ), 'mappedBy' => 'parent', 'orphanRemoval' => false, 'orderBy' => array( 'display_order' => 'ASC', ), )); 
