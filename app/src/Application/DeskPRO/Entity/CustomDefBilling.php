 ...
 */
class CustomDefBilling extends CustomDefAbstract
{
    /**
     ...
     * Set parent.
     *
     * @param CustomDefBilling $parent
     *
     * @return $this
     */
    public function setParent(CustomDefBilling $parent = null)
    {
    ...
    public static function loadMetadata(ClassMetadata $metadata)
    {
        ...
        $metadata->customRepositoryClassName = 'Application\DeskPRO\EntityRepository\CustomDefBilling';
        $metadata->setPrimaryTable(array('name' => 'custom_def_billing'));
