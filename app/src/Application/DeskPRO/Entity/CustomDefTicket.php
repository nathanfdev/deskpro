 ...
 *
 * @ORM_Mapping\Entity(repositoryClass="Application\DeskPRO\EntityRepository\CustomDefTicket")
 * @ORM_Mapping\HasLifecycleCallbacks
 * @ORM_Mapping\Table(name="custom_def_ticket")
 */
class CustomDefTicket extends CustomDefAbstract
{
	/**
	 * @var CustomDefPeople
	 * @ORM_Mapping\ManyToOne(targetEntity="CustomDefTicket", inversedBy="children", fetch="EAGER")
	...
	public static function loadMetadata(ClassMetadata $metadata)
	{
		...
		$metadata->customRepositoryClassName = 'Application\DeskPRO\EntityRepository\CustomDefTicket'; 
		$metadata->setPrimaryTable(array( 'name' => 'custom_def_ticket', )); 
		...
		$metadata->mapOneToOne(array( 'fieldName' => 'parent', 'targetEntity' => 'Application\\DeskPRO\\Entity\\CustomDefTicket', 'cascade' => array( ), 'mappedBy' => NULL, 'inversedBy' => 'children', 'joinColumns' => array( 0 => array( 'name' => 'parent_id', 'referencedColumnName' => 'id', 'unique' => false, 'nullable' => true, 'onDelete' => 'cascade', 'columnDefinition' => NULL, ), ), 'orphanRemoval' => false, )); 
		$metadata->mapOneToMany(array( 'fieldName' => 'children', 'targetEntity' => 'Application\\DeskPRO\\Entity\\CustomDefTicket', 'cascade' => array( 0 => 'remove', 1 => 'persist', 3 => 'merge', ), 'mappedBy' => 'parent', 'orphanRemoval' => false, 'orderBy' => array( 'display_order' => 'ASC', ), )); 
