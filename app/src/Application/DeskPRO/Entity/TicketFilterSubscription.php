...
class TicketFilterSubscription extends \Application\DeskPRO\Domain\DomainObject
{
	...
	public static function loadMetadata(ClassMetadata $metadata)
	{
		...
		$metadata->mapField(array( 'fieldName' => 'email_agent_activity', 'type' => 'boolean', 'length' => NULL, 'precision' => 0, 'scale' => 0, 'nullable' => false, 'unique' => false, 'columnName' => 'email_agent_activity', ));
		$metadata->mapField(array( 'fieldName' => 'email_property_change', 'type' => 'boolean', 'length' => NULL, 'precision' => 0, 'scale' => 0, 'nullable' => false, 'unique' => false, 'columnName' => 'email_property_change', ));
		$metadata->mapField(array( 'fieldName' => 'alert_new', 'type' => 'boolean', 'length' => NULL, 'precision' => 0, 'scale' => 0, 'nullable' => false, 'unique' => false, 'columnName' => 'alert_new', ));
		$metadata->mapField(array( 'fieldName' => 'alert_user_activity', 'type' => 'boolean', 'length' => NULL, 'precision' => 0, 'scale' => 0, 'nullable' => false, 'unique' => false, 'columnName' => 'alert_user_activity', ));
		$metadata->mapField(array( 'fieldName' => 'alert_agent_activity', 'type' => 'boolean', 'length' => NULL, 'precision' => 0, 'scale' => 0, 'nullable' => false, 'unique' => false, 'columnName' => 'alert_agent_activity', ));
		$metadata->mapField(array( 'fieldName' => 'alert_property_change', 'type' => 'boolean', 'length' => NULL, 'precision' => 0, 'scale' => 0, 'nullable' => false, 'unique' => false, 'columnName' => 'alert_property_change', ));
