 ...
 */
abstract class JiraEntity //extends \Application\DeskPRO\Domain\DomainObject
{
    /**
     * Entity ID
	 * 
	 ...
	 */
	static public function initFromArray(array $array = array())
	{
	 ...
	 */
	public function getAvatars($key = null)
	{
		if ($key) {
			if (isset($this->_avatars[$key])) {
