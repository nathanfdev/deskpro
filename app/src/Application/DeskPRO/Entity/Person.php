...
class Person extends DomainObject implements HighlightableModelInterface
{
    ...
    public static function loadMetadata(ClassMetadata $metadata)
    {
        ...
        $metadata->mapOneToMany(array( 'fieldName' => 'usersource_assoc', 'targetEntity' => 'Application\\DeskPRO\\Entity\\PersonUsersourceAssoc', 'mappedBy' => 'person', 'cascade' => array('persist', 'remove')  ));
