...
class PersonEditManager implements PersonContextInterface
{
	...
	{
		$valid_names = array(
			'email_created', 'email_new', 'email_leave', 'email_user_activity', 'email_agent_activity', 'email_property_change',
			'alert_created', 'alert_new', 'alert_leave', 'alert_user_activity', 'alert_agent_activity', 'alert_property_change',
		);
