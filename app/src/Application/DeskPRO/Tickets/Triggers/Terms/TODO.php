...
class CheckUserName                            extends AbstractTriggerTerm { public function isTriggerMatch(Ticket $ticket, ExecutorContextInterface $ticket_changelog) { return true; } }
...
class CheckOrgName                             extends AbstractTriggerTerm { public function isTriggerMatch(Ticket $ticket, ExecutorContextInterface $ticket_changelog) { return true; } }
