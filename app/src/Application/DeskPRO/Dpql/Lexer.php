...
class Lexer
{
    ...
    function yylex1()
    {
        ...
        $yy_global_pattern = '/\G(\\s+)|\G(,)|\G(\\()|\G(\\))|\G(;)|\G(\'([^\\\\\']+|\\\\.)*\')|\G(-?([0-9]+|[0-9]*\\.[0-9]+))|\G(%[a-zA-Z0-9_]+%)|\G([a-zA-Z_][a-zA-Z0-9_]*\\.[a-zA-Z_][a-zA-Z0-9_]*)|\G(\\+|-|\\*|\/|!=|<>|>=|<=|<|>|=|&&|\\|\\||!)|\G([a-zA-Z_][a-zA-Z0-9_]*)/';
        ...
        1 => array(0, "\G(,)|\G(\\()|\G(\\))|\G(;)|\G('([^\\\\']+|\\\\.)*')|\G(-?([0-9]+|[0-9]*\\.[0-9]+))|\G(%[a-zA-Z0-9_]+%)|\G([a-zA-Z_][a-zA-Z0-9_]*\\.[a-zA-Z_][a-zA-Z0-9_]*)|\G(\\+|-|\\*|\/|!=|<>|>=|<=|<|>|=|&&|\\|\\||!)|\G([a-zA-Z_][a-zA-Z0-9_]*)"),
        2 => array(0, "\G(\\()|\G(\\))|\G(;)|\G('([^\\\\']+|\\\\.)*')|\G(-?([0-9]+|[0-9]*\\.[0-9]+))|\G(%[a-zA-Z0-9_]+%)|\G([a-zA-Z_][a-zA-Z0-9_]*\\.[a-zA-Z_][a-zA-Z0-9_]*)|\G(\\+|-|\\*|\/|!=|<>|>=|<=|<|>|=|&&|\\|\\||!)|\G([a-zA-Z_][a-zA-Z0-9_]*)"),
        3 => array(0, "\G(\\))|\G(;)|\G('([^\\\\']+|\\\\.)*')|\G(-?([0-9]+|[0-9]*\\.[0-9]+))|\G(%[a-zA-Z0-9_]+%)|\G([a-zA-Z_][a-zA-Z0-9_]*\\.[a-zA-Z_][a-zA-Z0-9_]*)|\G(\\+|-|\\*|\/|!=|<>|>=|<=|<|>|=|&&|\\|\\||!)|\G([a-zA-Z_][a-zA-Z0-9_]*)"),
        4 => array(0, "\G(;)|\G('([^\\\\']+|\\\\.)*')|\G(-?([0-9]+|[0-9]*\\.[0-9]+))|\G(%[a-zA-Z0-9_]+%)|\G([a-zA-Z_][a-zA-Z0-9_]*\\.[a-zA-Z_][a-zA-Z0-9_]*)|\G(\\+|-|\\*|\/|!=|<>|>=|<=|<|>|=|&&|\\|\\||!)|\G([a-zA-Z_][a-zA-Z0-9_]*)"),
        5 => array(0, "\G('([^\\\\']+|\\\\.)*')|\G(-?([0-9]+|[0-9]*\\.[0-9]+))|\G(%[a-zA-Z0-9_]+%)|\G([a-zA-Z_][a-zA-Z0-9_]*\\.[a-zA-Z_][a-zA-Z0-9_]*)|\G(\\+|-|\\*|\/|!=|<>|>=|<=|<|>|=|&&|\\|\\||!)|\G([a-zA-Z_][a-zA-Z0-9_]*)"),
        6 => array(1, "\G(-?([0-9]+|[0-9]*\\.[0-9]+))|\G(%[a-zA-Z0-9_]+%)|\G([a-zA-Z_][a-zA-Z0-9_]*\\.[a-zA-Z_][a-zA-Z0-9_]*)|\G(\\+|-|\\*|\/|!=|<>|>=|<=|<|>|=|&&|\\|\\||!)|\G([a-zA-Z_][a-zA-Z0-9_]*)"),
        8 => array(2, "\G(%[a-zA-Z0-9_]+%)|\G([a-zA-Z_][a-zA-Z0-9_]*\\.[a-zA-Z_][a-zA-Z0-9_]*)|\G(\\+|-|\\*|\/|!=|<>|>=|<=|<|>|=|&&|\\|\\||!)|\G([a-zA-Z_][a-zA-Z0-9_]*)"),
        10 => array(2, "\G([a-zA-Z_][a-zA-Z0-9_]*\\.[a-zA-Z_][a-zA-Z0-9_]*)|\G(\\+|-|\\*|\/|!=|<>|>=|<=|<|>|=|&&|\\|\\||!)|\G([a-zA-Z_][a-zA-Z0-9_]*)"),
        11 => array(2, "\G(\\+|-|\\*|\/|!=|<>|>=|<=|<|>|=|&&|\\|\\||!)|\G([a-zA-Z_][a-zA-Z0-9_]*)"),
        12 => array(2, "\G([a-zA-Z_][a-zA-Z0-9_]*)"),
        13 => array(2, ""),
    );
