...
class TicketsResponseTime extends AbstractTableOverviewStat
{
	/**
	 * @var GroupingField
	 */
	...
	public function getValues()
	{
		...
		$field = $this->makeTimeFieldSelect();
	...
	public function makeTimeFieldSelect()
	{
		...
		$parts = array();
		foreach ($times as $t) {
			$parts[] = " WHEN tickets.total_to_first_reply <= $t THEN $t ";
		}
