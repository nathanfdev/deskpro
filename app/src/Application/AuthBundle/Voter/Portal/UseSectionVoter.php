    ...
    protected function isGranted($attribute, $object, $user = null)
    {
        ...
        switch($attribute) {
            case static::USE_ARTICLES:
                return $permissionBag->hasPermission('articles.use');
            case static::USE_FEEDBACK:
                return $permissionBag->hasPermission('feedback.use');
            case static::USE_CHAT:
                return $permissionBag->hasPermission('chat.use');
            case static::USE_DOWNLOADS:
                return $permissionBag->hasPermission('downloads.use');
            case static::USE_NEWS:
                return $permissionBag->hasPermission('news.use');
            case static::USE_TICKETS:
                return $permissionBag->hasPermission('tickets.use');
        }
