...
final class Ticket extends AbstractEntity implements PersonAwareInterface, LabelAwareInterface, LanguageAwareInterface
{
    ...
    public function isStatusValid()
    {
        $statuses = array(
            ...
            DeskPROEntity\Ticket::HIDDEN_STATUS_VALIDATING,
            DeskPROEntity\Ticket::HIDDEN_STATUS_SPAM,
            DeskPROEntity\Ticket::HIDDEN_STATUS_DELETED,
            DeskPROEntity\Ticket::HIDDEN_STATUS_TEMP,
        );
