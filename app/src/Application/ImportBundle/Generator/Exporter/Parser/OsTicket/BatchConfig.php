...
final class BatchConfig extends AbstractBatchSizeConfig
{
    ...
    {
        return ExporterInterface::TYPE_OS_TICKET;
    }

    /**
     * Returns staff table offset.
     *
     * @return int
     */
    public function getStaffMinId()
    {
        return $this->staff_min_id;
    }

    /**
     * Set staff table offset.
     *
     * @param int $min_id
     *
     * @return $this
     */
    public function setStaffMinId($min_id)
    {
        $this->staff_min_id = (int) $min_id;
    ...
    public function toArray()
    {
        return array_merge(parent::toArray(), array(
            'staff_min_id'   => $this->staff_min_id,
