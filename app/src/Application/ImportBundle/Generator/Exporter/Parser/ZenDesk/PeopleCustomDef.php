...
final class PeopleCustomDef extends AbstractParser
{
    ...
    public function export()
    {
        ...
        foreach ($custom_def as $num => $data) {
            try {
                ...
                $this->logSkippingException('ZDPersonCustomDef', $this->getEntityType(), 'id', $e);
            } catch (TransformerException $e) {
                $this->logTransformerException('ZDPersonCustomDef', $this->getEntityType(), 'id', $e);
            } catch (\Exception $e) {
                $this->logUnknownException('ZDPersonCustomDef', $this->getEntityType(), 'id', $e, $data);
            }
        }
    ...
    {
        return $this->reader->getPeopleFields();
    }
}
