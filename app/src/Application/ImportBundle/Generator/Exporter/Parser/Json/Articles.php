...
final class Articles extends AbstractParser
{
    ...
    {
        return $this->reader->getDirectoryFilesCount(DestinationInterface::ENTITY_ARTICLE_PATH, $this->getBatchNum());
    }
    ...
    public function export()
    {
        ...
        $config
            ->setData($this->reader->getData(DestinationInterface::ENTITY_ARTICLE_PATH, $this->getBatchNum()))
