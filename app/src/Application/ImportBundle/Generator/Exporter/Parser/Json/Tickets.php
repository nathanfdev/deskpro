...
final class Tickets extends AbstractParser
{
    ...
    {
        return $this->reader->getDirectoryFilesCount(DestinationInterface::ENTITY_TICKET_PATH, $this->getBatchNum());
    }
    ...
    public function export()
    {
        ...
        $config
            ->setData($this->reader->getData(DestinationInterface::ENTITY_TICKET_PATH, $this->getBatchNum()))
