...
{
    /**
     * @var EntityRepository\LabelPerson
     */
    private $repository;
     ...
     */
    public function __construct(EntityRepository\LabelPerson $repository)
    {
    ...
    {
        $criteria = array('person' => $id);
        $records  = $this->repository->findBy($criteria);

        if (empty($records) && $throw_exception) {
            throw new MapperException('Person labels not found', $criteria);
        }
