...
class FeedbackCategory implements MapperInterface
{
     ...
     * Constructor
     *
     * @param EntityRepository\FeedbackCategory $repository
     */
    public function __construct(EntityRepository\FeedbackCategory $repository)
    {
    ...
    {
        return self::TYPE_FEEDBACK_CATEGORY;
    }
