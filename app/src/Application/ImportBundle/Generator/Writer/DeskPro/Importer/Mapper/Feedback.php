 ...
 */
final class Feedback implements MapperInterface, MapperByTitleInterface
{
    /**
     ...
     * Constructor
     *
     * @param EntityRepository\Feedback $repository
     */
    public function __construct(EntityRepository\Feedback $repository)
    {
    ...
    {
        /** @var Entity\Feedback $record */
        $record = $this->repository->findOneBy($criteria);
        if (!$record && $throw_exception) {
            throw new MapperException('Feedback not found', $criteria);
        }
