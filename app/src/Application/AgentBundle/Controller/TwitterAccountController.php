...
class TwitterAccountController extends AbstractController
{
	public function starredTweetsAction()
	{
		...
		$statuses = $this->em->getRepository('DeskPRO:TwitterAccountStatus')->findStarredTweetsForAgentId($agentId);
	...
	public function myTweetsAction()
	{
		...
		$statuses = $this->em->getRepository('DeskPRO:TwitterAccountStatus')->findTweetsForAgentId($agentId);
	...
	public function teamTweetsAction()
	{
		...
		$statuses = $this->em->getRepository('DeskPRO:TwitterAccountStatus')->findTweetsForAgentTeamByAgentId($agentId);
