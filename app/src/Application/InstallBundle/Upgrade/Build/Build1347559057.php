...
class Build1347559057 extends AbstractBuild
{
	public function run()
	{
		...
		$this->execMutateSql("CREATE TABLE report_builder_favorite (id INT AUTO_INCREMENT NOT NULL, report_builder_id INT DEFAULT NULL, person_id INT DEFAULT NULL, params VARCHAR(100) NOT NULL, INDEX IDX_70A94B3486DD4ADF (report_builder_id), INDEX IDX_70A94B34217BBB47 (person_id), UNIQUE INDEX unique_key_idx (report_builder_id, person_id, params), PRIMARY KEY(id)) ENGINE = InnoDB");
