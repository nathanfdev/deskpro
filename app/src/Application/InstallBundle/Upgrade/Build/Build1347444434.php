...
class Build1347444434 extends AbstractBuild
{
	public function run()
	{
		...
		$this->execMutateSql("CREATE TABLE labels_chat_conversations (chat_id INT NOT NULL, `label` VARCHAR(255) NOT NULL, INDEX IDX_99205D121A9A7125 (chat_id), INDEX label_idx (label), PRIMARY KEY(chat_id, label)) ENGINE = InnoDB");
