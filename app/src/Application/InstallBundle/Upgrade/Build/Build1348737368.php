...
class Build1348737368 extends AbstractBuild
{
	public function run()
	{
		...
		$this->execMutateSql("CREATE TABLE usersource_plugins (id INT AUTO_INCREMENT NOT NULL, plugin_id VARCHAR(255) DEFAULT NULL, unique_key VARCHAR(50) NOT NULL, title VARCHAR(255) NOT NULL, form_model_class VARCHAR(255) NOT NULL, form_type_class VARCHAR(255) NOT NULL, form_template VARCHAR(255) NOT NULL, adapter_class VARCHAR(255) NOT NULL, INDEX IDX_E484A367EC942BCF (plugin_id), UNIQUE INDEX unique_key_idx (unique_key), PRIMARY KEY(id)) ENGINE = InnoDB");
