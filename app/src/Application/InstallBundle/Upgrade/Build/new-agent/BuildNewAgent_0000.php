...
class BuildNewAgent_0000 extends AbstractBuild
{
    public function run()
    {
        $this->out('add new subscription worker jobs');

        $this->execMutateSql("
            INSERT INTO `worker_jobs` (`id`, `worker_group`, `title`, `description`, `job_class`, `data`, `run_interval`, `last_run_date`, `last_start_date`)
            VALUES ('news_subscriptions', 'news_subscriptions', 'News Subscriptions', 'Sends notifications to users who are subscribed to news articles or news categories', 'Application\\\\DeskPRO\\\\WorkerProcess\\\\Job\\\\NewsSubscriptions', X'613A303A7B7D', '7200', NULL, NULL)
        ");
