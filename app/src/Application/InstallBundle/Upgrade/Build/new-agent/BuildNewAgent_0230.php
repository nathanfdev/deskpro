...
class BuildNewAgent_0230 extends AbstractBuild
{
    public function run()
    {
        $this->out('add kb_subscriptions table');
        $this->execMutateSql('CREATE TABLE kb_subscriptions (id INT AUTO_INCREMENT NOT NULL, person_id INT DEFAULT NULL, article_id INT DEFAULT NULL, category_id INT DEFAULT NULL, INDEX IDX_1F05AAF5217BBB47 (person_id), INDEX IDX_1F05AAF57294869C (article_id), INDEX IDX_1F05AAF512469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci');
        ...
        $this->execMutateSql('ALTER TABLE filters CHANGE term term LONGTEXT NOT NULL');
    }
}
