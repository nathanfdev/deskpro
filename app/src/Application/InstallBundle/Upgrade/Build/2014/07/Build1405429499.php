...
class Build1405429499 extends AbstractBuild
{
	public function run()
	{
		...
		$this->execMutateSql("CREATE TABLE round_robin (id INT AUTO_INCREMENT NOT NULL, next_agent_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_A56034E1C0E3DE5 (next_agent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci");
