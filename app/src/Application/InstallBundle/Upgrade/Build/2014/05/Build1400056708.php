...
class Build1400056708 extends AbstractBuild
{
	public function run()
	{
		...
		$db->exec("CREATE TABLE app_instances (id INT AUTO_INCREMENT NOT NULL, package_name VARCHAR(255) DEFAULT NULL, perm_type VARCHAR(15) NOT NULL, title VARCHAR(255) NOT NULL, secret_key VARCHAR(40) NOT NULL, auth_key VARCHAR(40) NOT NULL, settings LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json_array)\', date_created DATETIME NOT NULL, INDEX IDX_D2485F5CE56E1BCE (package_name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci");
