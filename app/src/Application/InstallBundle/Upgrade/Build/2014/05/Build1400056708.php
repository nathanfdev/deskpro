...
class Build1400056708 extends AbstractBuild
{
	public function run()
	{
		...
		$this->execMutateSql("CREATE TABLE app_instances (id INT AUTO_INCREMENT NOT NULL, package_name VARCHAR(255) DEFAULT NULL, perm_type VARCHAR(15) NOT NULL, title VARCHAR(255) NOT NULL, secret_key VARCHAR(40) NOT NULL, auth_key VARCHAR(40) NOT NULL, settings LONGTEXT DEFAULT NULL COMMENT '(DC2Type:json_array)', date_created DATETIME NOT NULL, INDEX IDX_D2485F5CE56E1BCE (package_name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci");
		$this->execMutateSql("CREATE TABLE app_packages (name VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(1000) NOT NULL, author_name VARCHAR(255) NOT NULL, author_email VARCHAR(255) NOT NULL, author_link VARCHAR(255) NOT NULL, api_version INT NOT NULL, version INT NOT NULL, version_name VARCHAR(100) NOT NULL, native_name VARCHAR(255) DEFAULT NULL, is_single TINYINT(1) NOT NULL, is_custom TINYINT(1) NOT NULL, tags LONGTEXT NOT NULL COMMENT '(DC2Type:simple_array)', trigger_events longtext NOT NULL COMMENT '(DC2Type:json_array)', settings_def LONGTEXT NOT NULL COMMENT '(DC2Type:json_array)', scopes LONGTEXT DEFAULT NULL COMMENT '(DC2Type:simple_array)', PRIMARY KEY(name)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci");
