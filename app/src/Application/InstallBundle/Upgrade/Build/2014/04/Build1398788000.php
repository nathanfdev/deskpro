...
class Build1398788000 extends AbstractBuild
{
	public function run()
	{
		...
		if (!isset($old_layouts[0])) {
			...
			$gen = new Build1396876120_LayoutGenerator($this->container);
		...
		foreach ($old_layouts as $dep_id => $old) {
			...
			$up = new Build1396876120_LayoutUpgrader($form_new, $form_view, $form_edit);
...
class Build1396876120_LayoutUpgrader
{
	/**
	 * @var array
	 */
...
class Build1396876120_LayoutGenerator
{
	/**
