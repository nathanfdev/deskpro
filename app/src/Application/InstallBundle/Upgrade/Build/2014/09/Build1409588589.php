...
class Build1409588589 extends AbstractBuild
{
	public function run()
	{
...
ALTER TABLE people ADD primaryTeam_id INT DEFAULT NULL;
ALTER TABLE people ADD CONSTRAINT FK_28166A26E715BE01 FOREIGN KEY (primaryTeam_id) REFERENCES agent_teams (id);
CREATE INDEX IDX_28166A26E715BE01 ON people (primaryTeam_id);
SQL
		);
	}
}