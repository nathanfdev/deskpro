...
class Build1345106506 extends AbstractBuild
{
	public function run()
	{
		...
		$this->execMutateSql("CREATE TABLE report_builder_favorite (report_builder_id INT NOT NULL, person_id INT NOT NULL, INDEX IDX_CCD5CB1186DD4ADF (report_builder_id), INDEX IDX_CCD5CB11217BBB47 (person_id), PRIMARY KEY(report_builder_id, person_id)) ENGINE = InnoDB");
