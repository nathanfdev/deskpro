...
##BEGIN:create_trigger.set_gatewayaddress##
$em->getConnection()->exec("INSERT INTO `ticket_triggers` (`id`, `title`, `event_trigger`, `is_enabled`, `terms`, `actions`, `sys_name`, `run_order`, `date_created`, `event_trigger_options`, `terms_any`)
VALUES
...
##BEGIN:create_trigger.set_fromname##
