...
class DataInitializer
{
	...
	public function runInitPerms()
	{
		...
		$this->container->getDb()->insert('department_permissions', array('department_id' => 1, 'person_id' => 1, 'app' => 'tickets', 'name' => 'full'));
		$this->container->getDb()->insert('department_permissions', array('department_id' => 2, 'person_id' => 1, 'app' => 'tickets', 'name' => 'full'));
		$this->container->getDb()->insert('department_permissions', array('department_id' => 3, 'person_id' => 1, 'app' => 'chat', 'name' => 'full'));
		$this->container->getDb()->insert('department_permissions', array('department_id' => 4, 'person_id' => 1, 'app' => 'chat', 'name' => 'full'));
		...
		$this->container->getDb()->insert('department_permissions', array('department_id' => 3, 'usergroup_id' => 1, 'app' => 'chat'));
		$this->container->getDb()->insert('department_permissions', array('department_id' => 4, 'usergroup_id' => 1, 'app' => 'chat'));
	}
