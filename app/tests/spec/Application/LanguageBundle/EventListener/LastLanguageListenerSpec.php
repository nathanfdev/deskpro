...
/**
 * @mixin \Application\LanguageBundle\EventListener\LastLanguageListener
 */
class LastLanguageListenerSpec extends ObjectBehavior
{
    ...
    function it_does_nothing_if_there_is_no_active_language_on_the_stack(
        LanguageStack $language_stack,
        FilterResponseEvent $event,
        ResponseHeaderBag $headers
    )
    ...
    function it_sets_a_cookie_with_last_lang_code_if_language_exists_on_stack(
        LanguageStack $language_stack,
        FilterResponseEvent $event,
        ResponseHeaderBag $headers,
        Language $en
