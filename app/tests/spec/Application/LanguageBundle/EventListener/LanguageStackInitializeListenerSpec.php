...
namespace spec\Application\LanguageBundle\EventListener;
...
use Application\LanguageBundle\EventListener\LanguageStackInitializeListener;
...
/**
 * @mixin \Application\LanguageBundle\EventListener\LanguageStackInitializeListener
 */
class LanguageStackInitializeListenerSpec extends ObjectBehavior
{
    ...
    {
        $cookies->get(LastLanguageListener::COOKIE_NAME)->willReturn('fr');
