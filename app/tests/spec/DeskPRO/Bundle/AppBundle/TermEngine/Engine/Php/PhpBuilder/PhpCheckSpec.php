...
class PhpCheckSpec extends ObjectBehavior
{
    ...
    function it_must_be_constructed_with_its_expression()
    {
    ...
    function it_always_trims_the_expression()
    {
    ...
    function it_lets_you_freeze_variable_names_meaning_it_removes_colon_from_expression_string()
    {
