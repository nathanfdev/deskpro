...
/**
 * @mixin \DeskPRO\Bundle\ApiBundle\View\Representation\StandardRepresentation
 */
class StandardRepresentationSpec extends ObjectBehavior
{
    function it_constructs_with_data_and_meta()
    {
    ...
    function it_holds_data()
    {
        $this->setData('data');
        $this->getData()->shouldReturn('data');
    }

    function it_holds_meta()
    {
