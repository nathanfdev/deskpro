...
{
    public function it_returns_a_view_representation_for_an_object(\stdClass $object)
    {
    ...
    public function it_returns_a_view_representation_for_an_array()
    {
    ...
    public function it_returns_a_view_representation_for_a_pager(
        Pagerfanta $pager
    ) {
    ...
    public function it_can_generate_a_batch_representation_of_responses(
        Response $response1,
        Response $response2
    ) {
