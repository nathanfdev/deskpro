...
class CustomFieldTicketContextSpec extends ObjectBehavior
{
    ...
    function it_extends_the_base_context_calss()
    {
        $this->shouldHaveType('DeskPRO\Bundle\PortalBundle\CustomField\Context\CustomFieldContext');
    }

    function it_always_uses_the_ticket_as_the_owner(
        Ticket $ticket
    )
    {
    ...
    function it_can_get_the_correct_context_for_person(
        Person $person
    )
    {
    ...
    function it_can_get_the_correct_context_for_organization(
