...
class TagRequestFactorySpec extends ObjectBehavior
{
    ...
    public function it_retains_the_current_requests_session(
        Tag $tag,
        SessionInterface $session
    ) {
        $arguments   = array();
    ...
    public function it_returns_a_tag_request_with_the_same_headers_as_current_request(
        Tag $tag,
        HeaderBag $headers
    ) {
    ...
    public function it_converts_entity_objects_in_the_query_to_their_id_value_and_rejects_other_objects(
        Tag $tag,
        Article $article
    ) {
        $tag->getName()->willReturn('tag_name');
    ...
    public function it_clones_most_attributes_but_not_all_plus_adds_tag_name(
        Tag $tag,
        ParameterBag $attributes
    ) {
        $tag->getName()->willReturn('tag_name');
    ...
    public function it_will_not_allow_route_attributes_if_tag_says_not_to(
        Tag $tag,
        ParameterBag $attributes
    ) {
        $tag->getName()->willReturn('tag_name');
