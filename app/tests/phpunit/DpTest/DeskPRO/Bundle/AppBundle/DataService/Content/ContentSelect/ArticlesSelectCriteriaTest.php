...
/**
 * Class ArticlesSelectCriteriaTest
 */
class ArticlesSelectCriteriaTest extends DeskProTestCase
{
    ...
    {
        $this->assertInstanceOf(ArticlesSelectCriteria::class, $this->instance([]));
    }
    ...
    {
        $this->assertInstanceOf(ArticlesSelectCriteria::class, $this->instance(self::$dummyProperParams));
    }

    /**
     * @test
     */
    function it_should_extend_ArticlesCountCriteria()
    {
     ...
     * @test
     */
    function it_should_inherit_all_OptionsResolver_configurations_from_ArticlesCountCriteria_except_group_by_option()
    {
        $data = [new \Application\DeskPRO\Entity\Person()];
        ArticlesCountCriteria::configureResolver($countOptionsResolver = new OptionsResolver(), $data);
        ArticlesSelectCriteria::configureResolver($selectOptionsResolver = new OptionsResolver(), $data);
     ...
     * @return ArticlesSelectCriteria
     */
    private function instance(array $parameters = [])
    {
        return ArticlesSelectCriteria::fromParameters(
            $parameters,
