...
class PhpTicketSlaTermCompilerTest extends AbstractPhpTermCompilerTest
{
    /**
     * @var \DeskPRO\Bundle\AppBundle\TermEngine\Term\TicketSla\PhpTicketSlaTermCompiler
     */
    ...
    {
        $this->term_compiler = $this->get('term_engine.php_ticket_checker.compiler.ticket_sla');
    }
