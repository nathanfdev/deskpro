...
<div style="text-align:center;margin-bottom:2em;">
    <p>
        <a href="<?php echo url(array('page' => 'overview')) ?>" class="button">Overview</a>
        <a href="<?php echo url(array('page' => 'files')) ?>" class="button">File usage</a>
        <a href="<?php echo url(array('page' => 'reset')) ?>" class="button" onclick="return confirm('Are you sure you want to reset the cache?');">Reset cache</a>
    </p>
</div>
                ...
                <tr class="<?php rc(); ?>">
                    <td class="pathname"><p><?php
                        ...
                        <?php if ($settings['allow_invalidate'] && function_exists('opcache_invalidate')): ?>
                            <a href="<?php echo url(array('page' => 'invalidate', 'file' => $s['full_path'])) ?>">Force file invalidation</a>
                        <?php endif; ?>
                    </td>
                    <td>
                        <p>
