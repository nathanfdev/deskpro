...
class PortalPermissionLoaderTest extends PortalTestCase
{
    ...
    public function load_all_categories($entityClass, $method)
    {
        ...
        $em->persist($communityForum3);
        $em->flush();

        $this->assertEquals(
            [
                $communityForum1->getId(),
                $communityForum2->getId(),
                $communityForum3->getId(),
            ],
    ...
    {
        return [
            [CommunityForum::class, 'getAllowedCommunityForums'],
