...
class DbalTicketDateArchivedTermCompilerTest extends AbstractDbalTicketFilterTermCompilerTest
{
    /**
     * @var DbalTicketDateArchivedTermCompiler
     */
    protected $term_compiler;

    public function setUp()
    {
        $this->term_compiler = $this->get('term_engine.dbal_ticket_filters.compiler.ticket_date_archived');
    }
    ...
    public function testSimpleCases()
    {
        ...
        $ops = [
            ...
            TermInterface::OP_LT        => 'ticket.date_archived < :date',
            TermInterface::OP_GTE       => 'ticket.date_archived >= :date',
