...
class PhpTicketDateLastUserReplyTermCompilerTest extends AbstractPhpTermCompilerTest
{
    /**
    ...
    {
        $this->term_compiler = $this->get('term_engine.php_ticket_checker.compiler.ticket_date_last_user_reply');
    }
    ...
    public function testCompileIs()
    {
        ...
        $term = new TicketDateLastUserReplyTerm(
            [
                'date' => $date,
            ]
        );
        ...
        $ticket->offsetGet('date_last_user_reply')->willReturn($date);
        $this->assertTicketCheck(
            $php_check,
            true,
            $ticket
        );
        $ticket->offsetGet('date_last_user_reply')->willReturn($date2);
        $this->assertTicketCheck(
            $php_check,
            false,
            $ticket
    ...
    public function testGreaterThan()
    {
        ...
        $ticket->offsetGet('date_last_user_reply')->willReturn($tomorrow);
        $this->assertTicketCheck(
            $php_check,
            true,
            $ticket
        );
        $ticket->offsetGet('date_last_user_reply')->willReturn($yesterday);
        $this->assertTicketCheck(
            $php_check,
            false,
            $ticket
    ...
    public function testInRange()
    {
        ...
        $ticket->offsetGet('date_last_user_reply')->willReturn($today);
        $this->assertTicketCheck(
            $php_check,
            true,
            $ticket
        );
        $ticket->offsetGet('date_last_user_reply')->willReturn($two_days_ago);
        $this->assertTicketCheck(
            $php_check,
            false,
            $ticket
