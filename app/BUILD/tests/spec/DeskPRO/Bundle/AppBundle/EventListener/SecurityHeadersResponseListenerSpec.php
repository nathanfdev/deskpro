...
class SecurityHeadersResponseListenerSpec extends ObjectBehavior
{
    ...
    public function it_adds_security_headers_to_every_response(
        ...
        $headers->add(['Content-Security-Policy' => 'default-src \'self\'; script-src * data: \'unsafe-inline\' \'unsafe-eval\'; style-src * data: \'unsafe-inline\'; img-src * data: blob:; font-src * data:; connect-src *; media-src * data: blob:; object-src *; child-src *; form-action *; frame-ancestors \'self\''])->shouldBeCalled();
