...
Feature: Downloads brand settings Setup
  ...
  Scenario: I get default brand settings
    When I send a GET request to "/api/v2/settings/brands/1/portal/downloads"
    Then the response should be in JSON
    And the response status code should be 200

  Scenario: I update default brand settings
    When I send a POST request to "/api/v2/settings/brands/1/portal/downloads" with body:
    """
{
  "brand": "1",
  "enabled":true,
