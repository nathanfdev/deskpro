@new
Feature: Knowledgebase brand settings Setup
  ...
  Scenario: I get default brand settings
    When I send a GET request to "/api/v2/settings/brands/{defaultBrandId}/portal/kb"
    Then the response should be in JSON
    And the response status code should be 200

  Scenario: I update default brand settings
    When I send a POST request to "/api/v2/settings/brands/{defaultBrandId}/portal/kb" with body:
    """
{
  "enabled":true,
  "tab_enabled":false,
    ...
    """
{
  ...
  "url": "my.domain.com"
    ...
    Then I send a POST request to "/api/v2/settings/brands/{lastCreatedId}/portal/kb" with body:
    """
{
  "enabled":false,
  "tab_enabled":true,
  "subscriptions":false
    ...
    When I send a GET request to "/api/v2/settings/brands/{lastCreatedId}/portal/kb"
    Then the response should be in JSON
    And the response status code should be 200
