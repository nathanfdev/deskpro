Feature: /tickets/{id}/followers and /tickets/{id}/cc endpoints
  ...
  Scenario: I retrieve lists of participants w/o sideloading
    ...
    When I send a GET request to "/api/v2/tickets/{ticket}/followers"
    Then the response status code should be 200
    ...
    """
{
  ...
  Scenario: I add followers
    When I send a POST request to "/api/v2/tickets/{ticket}/followers" with body:
    """
{
  "person": "agent@deskpro.dev"
}
    ...
    """
{
  ...
  Scenario: I get follower with sideloading
    When I send a GET request to "/api/v2/tickets/{ticket}/followers/2?include=organization"
    Then the response status code should be 200
  ...
  Scenario: I get follower w/o sideloading
    When I send a GET request to "/api/v2/tickets/{ticket}/followers/2"
    Then the response status code should be 200
  ...
  Scenario: I delete follower
    When I send a DELETE request to "/api/v2/tickets/{ticket}/followers/2"
    Then the response status code should be 200
