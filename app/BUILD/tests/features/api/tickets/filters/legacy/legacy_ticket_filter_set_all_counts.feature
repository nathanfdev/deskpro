...
Feature: /ticket_filter_sets/all/counts endpoint
  ...
  Scenario: I retrieve list of all ticket filter sets counts
    ...
    And the JSON node "data[0].nested[0].id" should be equal to 5
    ...
    And the JSON node "data[0].nested[1].id" should be equal to 15
    ...
    And the JSON node "data[1].nested[0].id" should be equal to 8
    ...
    And the JSON node "data[1].nested[1].id" should be equal to 6
    ...
    And the JSON node "data[2].nested[0].id" should be equal to 16
