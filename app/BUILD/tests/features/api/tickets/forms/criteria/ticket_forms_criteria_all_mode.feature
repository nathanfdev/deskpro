...
Feature: /ticket_forms endpoint
  ...
  Background:
    ...
    And the only default ticket layout exists with fields:
      ...
      | ticket_field_{f1} |                                                                                                                                                                                                                                                                                                             |
      | ticket_field_{f2} |                                                                                                                                                                                                                                                                                                             |
      | ticket_field_{f3} | {"on_newticket": true, "criteria":{"version":1,"mode":"all","terms":[{"type":"CheckTicketField~f1~","op":"contains","options":{"value": "val 1", "type_name":"text","field_id":"~f1~"}}, {"type":"CheckTicketField~f2~","op":"contains","options":{"value": "val 2","type_name":"text","field_id":"~f2~"}}]}} |
