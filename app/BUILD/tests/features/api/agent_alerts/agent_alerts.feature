Feature: /me/notifications endpoint
  ...
  Scenario: I get notifications with limits
    When I send a GET request to "/api/v2/me/notifications?limit=2"
    Then the response status code should be 200
    And the response should be in JSON
    And the JSON node "data" should have 2 elements

  Scenario: I get notifications with over-limits
    When I send a GET request to "/api/v2/me/notifications?limit=50"
    Then the response status code should be 200
    And the response should be in JSON
    And the JSON node "data" should have 4 elements
    ...
    """
{
  ...
  Scenario: I get notification counts
    When I send a GET request to "/api/v2/me/notifications/counts?group_by=is_dismissed"
    Then the response status code should be 200
    And the response should be in JSON
