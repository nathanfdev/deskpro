...
{
  "name": "New Person",
  "primary_email": "email@deskpro.dev",
  "contact_data": {
    ...
    And the JSON node "errors.fields.contact_data.fields.website.fields.website_0.fields.url.errors[0].message" should be equal to "This value should not be blank."
    ...
    And the JSON node "errors.fields.contact_data.fields.website.fields.website_1.fields.url.errors[0].message" should be equal to "This value should not be blank."
    ...
    And the JSON node "errors.fields.contact_data.fields.website.fields.website_2.fields.url.errors[0].message" should be equal to "This value is not a valid URL."
    ...
    And the JSON node "errors.fields.contact_data.fields.website.fields.website_3.fields.url.errors[0].message" should be equal to "This value is not a valid URL."
    ...
    And the JSON node "errors.fields.contact_data.fields.facebook.fields.facebook_0.fields.url.errors[0].message" should be equal to "This value should not be blank."
    ...
    And the JSON node "errors.fields.contact_data.fields.linked_in.fields.linked_in_0.fields.url.errors[0].message" should be equal to "This value should not be blank."
    ...
    And the JSON node "errors.fields.contact_data.fields.instant_message.fields.instant_message_0.fields.username.errors[0].message" should be equal to "This value should not be blank."
    ...
    And the JSON node "errors.fields.contact_data.fields.twitter.fields.twitter_0.fields.username.errors[0].message" should be equal to "This value should not be blank."
    ...
    And the JSON node "errors.fields.contact_data.fields.address.fields.address_0.fields.address.errors[0].message" should be equal to "This value should not be blank."
    ...
    And the JSON node "errors.fields.contact_data.fields.address.fields.address_0.fields.city.errors[0].message" should be equal to "This value should not be blank."
    ...
    And the JSON node "errors.fields.contact_data.fields.address.fields.address_0.fields.country.errors[0].message" should be equal to "This value should not be blank."
    ...
    And the JSON node "errors.fields.contact_data.fields.phone.fields.phone_0.fields.code.errors[0].message" should be equal to "This value should not be blank."
    ...
    And the JSON node "errors.fields.contact_data.fields.phone.fields.phone_0.fields.number.errors[0].message" should be equal to "This value should not be blank."
    ...
    And the JSON node "errors.fields.contact_data.fields.phone.fields.phone_0.fields.type.errors[0].message" should be equal to "This value should not be blank."
    ...
    And the JSON node "errors.fields.contact_data.fields.phone.fields.phone_1.fields.number.errors[0].message" should be equal to "Invalid phone number format."
