    ...
    """
{
  ...
  Scenario: I GET a single task
    When I send a GET request to "/api/v2/tasks/{lastCreatedId}"
    Then the response should be in JSON
  ...
  Scenario: I modify a task
    When I send a PUT request to "/api/v2/tasks/{lastCreatedId}" with body:
    """
{
    ...
    """
{
  ...
  Scenario: I DELETE a single task
    When I send a DELETE request to "/api/v2/tasks/{lastCreatedId}"
    Then the response should be in JSON
    And the response status code should be 200
