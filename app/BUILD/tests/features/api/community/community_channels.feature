...
Feature: /community_forums endpoint
  ...
  Scenario: I GET all community forums
    ...
    And the JSON node "data[0].noun" should be equal to "Feature"
    And the JSON node "data[1].noun" should be equal to "Garbage"
    And the JSON node "data[2].noun" should be equal to "Question"
