...
Feature:
  ...
  Background:
    ...
    And I have the following "CommunityForum" records:
      | #  | Title                  | Noun                   | Plural                  | VerbAction |
      | c1 | First community forum  | First community forum  | First community forums  | New Forum  |
      | c2 | Second community forum | Second community forum | Second community forums | New Forum  |
    ...
    And I have the following "CommunityTopic" records:
      | #   | Person  | Forum   | StatusCategory | Title        | Status | IsReviewed | Content |
  ...
  Scenario: I GET list of community topics in CSV format
    When I send a GET request to "/api/v2/community_topics/csv?forum=First+community+forum&status_category={sc1}&count=200"
