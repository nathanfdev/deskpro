...
Feature: /twilio_numbers endpoint
  ...
  Scenario: I get twilio number
    ...
    When I send a GET request to "/api/v2/twilio_numbers/{n1}"
    Then the response status code should be 200
    And the JSON node "data.id" should be equal to "{n1}"

  Scenario: I add twilio number
    When I send a POST request to "/api/v2/twilio_numbers" with body:
    """
{
  "account": ~a1~,
  "sid": "sidcode",
  ...
  Scenario: I update twilio number
    ...
    When I send a PUT request to "/api/v2/twilio_numbers/{n1}" with body:
    """
{
    ...
    """
{
  ...
  Scenario: I delete twilio number
    ...
    When I send a DELETE request to "/api/v2/twilio_numbers/{n1}"
    Then the response status code should be 200
