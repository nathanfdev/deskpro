    ...
    """
{
  "custom_scss": ".my-important-custom-css-class {color: red;}"
    ...
    """
    And I send a PUT request to "/brand-{defaultBrandId}/portal/api/style/edit-theme-set/variable-values"
    And I go to "/brand-{defaultBrandId}/portal/api/style/edit-theme-set/commit"
