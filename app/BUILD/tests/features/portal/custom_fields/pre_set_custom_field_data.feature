...
Feature: Check custom field pre set values
  ...
  Scenario: I check text field
    ...
    And the object "user@deskpro.dev" has "text_field" custom data with "some text"
  ...
  Scenario: I check textarea field
    ...
    And the object "user@deskpro.dev" has "textarea_field" custom data with "more text"
  ...
  Scenario: I check hidden field
    ...
    And the object "user@deskpro.dev" has "hidden_field" custom data with "value"
  ...
  Scenario: I check toggle field
    ...
    And the object "user@deskpro.dev" has "toggle_field_1" custom data with 1
    And the object "user@deskpro.dev" has "toggle_field_2" custom data with 0
  ...
  Scenario: I check single selectbox
    ...
    And the object "user@deskpro.dev" has "single_choice_field" custom data with "{single_choice_2}"
  ...
  Scenario: I check checkbox group
    ...
    And the object "user@deskpro.dev" has "checkbox_group_field" custom data with "{choice_2},{choice_3}"
  ...
  Scenario: I check radio group
    ...
    And the object "user@deskpro.dev" has "radio_group_field" custom data with "{choice_2}"
  ...
  Scenario: I check multi selectbox
    ...
    And the object "user@deskpro.dev" has "multi_choice_field" custom data with "{choice_2},{choice_3}"
  ...
  Scenario: I check date field
    ...
    And the object "user@deskpro.dev" has "date_field" custom data with "2016-06-15"
  ...
  Scenario: I check datetime field
    ...
    And the object "user@deskpro.dev" has "datetime_field" custom data with "2016-06-15 20:30:00"
