...
namespace DeskPRO\Component\Lock;
...
/**
 * Original Symfony PdoStore requires php >= 7.1 and presents in newer versions of Symfony framework.
 * So it's a php5 compatibility copy. Remove after Symfony update.
 *
