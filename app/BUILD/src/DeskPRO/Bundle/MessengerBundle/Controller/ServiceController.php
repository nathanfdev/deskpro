...
class ServiceController extends AbstractMessengerController
{
    ...
    public function getTranslationAction(Request $request)
    {
        ...
        $phrases                   = array_merge($messengerSettingsResolver->getEditablePhrases(), [
            ...
            'helpcenter.messenger.message_ended-by',
            'helpcenter.messenger.message_unassigned',
            'helpcenter.messenger.message_user-joined',
            'helpcenter.messenger.message_user-left',
            'helpcenter.messenger.powered_by',
            'helpcenter.messenger.tickets_form_addAttachment',
            'helpcenter.messenger.tickets_form_back',
            'helpcenter.messenger.tickets_form_category',
            'helpcenter.messenger.tickets_form_chooseAFile',
            'helpcenter.messenger.tickets_form_chooseFiles',
            'helpcenter.messenger.tickets_form_department',
            'helpcenter.messenger.tickets_form_dragNDrop',
