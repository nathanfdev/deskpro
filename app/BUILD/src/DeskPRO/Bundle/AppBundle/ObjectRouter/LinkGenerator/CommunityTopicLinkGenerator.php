...
/**
 * Creates the proper link for a community topic "serve" (a direct url to put in an img tag for ex.).
 */
class CommunityTopicLinkGenerator implements LinkGeneratorInterface
{
