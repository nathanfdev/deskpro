...
use DeskPRO\Bundle\AppBundle\Dpql2\Statement\Part\Alias;
use DeskPRO\Bundle\AppBundle\Dpql2\Statement\Part\AliasRef;
use DeskPRO\Bundle\AppBundle\Dpql2\Statement\Part\BinaryComparison;
use DeskPRO\Bundle\AppBundle\Dpql2\Statement\Part\BinaryInterval;
use DeskPRO\Bundle\AppBundle\Dpql2\Statement\Part\BinaryLogical;
use DeskPRO\Bundle\AppBundle\Dpql2\Statement\Part\BinaryMath;
use DeskPRO\Bundle\AppBundle\Dpql2\Statement\Part\Column;
use DeskPRO\Bundle\AppBundle\Dpql2\Statement\Part\ColumnStar;
use DeskPRO\Bundle\AppBundle\Dpql2\Statement\Part\Exists;
use DeskPRO\Bundle\AppBundle\Dpql2\Statement\Part\FunctionCall;
use DeskPRO\Bundle\AppBundle\Dpql2\Statement\Part\In;
use DeskPRO\Bundle\AppBundle\Dpql2\Statement\Part\InSubquery;
use DeskPRO\Bundle\AppBundle\Dpql2\Statement\Part\Like;
use DeskPRO\Bundle\AppBundle\Dpql2\Statement\Part\NullValue;
use DeskPRO\Bundle\AppBundle\Dpql2\Statement\Part\Number;
use DeskPRO\Bundle\AppBundle\Dpql2\Statement\Part\OrderDir;
use DeskPRO\Bundle\AppBundle\Dpql2\Statement\Part\Parentheses;
use DeskPRO\Bundle\AppBundle\Dpql2\Statement\Part\Placeholder;
use DeskPRO\Bundle\AppBundle\Dpql2\Statement\Part\Prepared;
use DeskPRO\Bundle\AppBundle\Dpql2\Statement\Part\Raw;
use DeskPRO\Bundle\AppBundle\Dpql2\Statement\Part\RegExp;
use DeskPRO\Bundle\AppBundle\Dpql2\Statement\Part\StringPart;
use DeskPRO\Bundle\AppBundle\Dpql2\Statement\Part\SubSelect;
use DeskPRO\Bundle\AppBundle\Dpql2\Statement\Part\UnaryOperator;
use DeskPRO\Bundle\AppBundle\Dpql2\Statement\Part\Variable;
...
class DpqlStatementFactory
{
     ...
     * @return Query
     */
    public function createQuery(array $parts)
    {
