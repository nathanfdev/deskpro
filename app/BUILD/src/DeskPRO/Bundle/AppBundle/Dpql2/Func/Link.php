...
use DeskPRO\Bundle\AppBundle\Dpql2\Renderer\Values\Html;
...
class Link extends AbstractFunc
{
     ...
     * @param array            $row
     * @param AbstractValues   $valueRenderer
     * @param AbstractRenderer $renderer
     *
     * @return string
     */
    public function formatLink($print, $format, array $argSelect, array $row, AbstractValues $valueRenderer, AbstractRenderer $renderer)
    {
        $breakEarly = $print === null || !($valueRenderer instanceof Html);
