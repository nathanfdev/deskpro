...
use DeskPRO\Bundle\AppBundle\Dpql2\DpqlDate;
...
abstract class AbstractDateRange extends AbstractPlaceholder
{
     ...
     */
    public function prepare(SqlSelect $statement, $section, array $stack, SqlSelect $select, ResultHandler $result)
    {
     ...
     * @return Prepared|bool Prepared results or false if there's no output
     */
    public function prepareWithIntervals(SqlSelect $statement, $section, array $stack, SqlSelect $select, ResultHandler $result, array $intervals = [])
    {
        $range = $this->getDateRange();
