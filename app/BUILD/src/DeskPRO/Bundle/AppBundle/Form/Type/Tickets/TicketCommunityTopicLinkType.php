...
/**
 * Class TicketCommunityTopicLinkType.
 */
class TicketCommunityTopicLinkType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('is_subscribe_ticket_owner', ApiBooleanType::class, [
                ...
                'mapped'      => false,
                'constraints' => [
                    new Assert\Callback([$this, 'validateCommunityTopicSubscriptionEnabled']),
                ],
            ])
