...
/**
 * Class ArticleCommentType.
 */
class ArticleCommentType extends CommentType
{
    /**
     * {@inheritdoc}
     */
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->addEventListener(FormEvents::POST_SUBMIT, function (FormEvent $event) {
            ...
            if ((null !== $comment->getParent() && null !== $comment->getArticle()) && $comment->getParent()->getArticle()->getId() !== $comment->getArticle()->getId()) {
