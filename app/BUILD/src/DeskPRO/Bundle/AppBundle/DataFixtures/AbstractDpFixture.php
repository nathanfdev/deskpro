...
abstract class AbstractDpFixture extends AbstractFixture implements ContainerAwareInterface
{
    ...
    const TABLE_CUSTOM_DATA_COMMUNITY_TOPIC        = 'custom_data_community_topic';
    const TABLE_CUSTOM_DATA_TICKET                 = 'custom_data_ticket';
    const TABLE_CUSTOM_DEF_COMMUNITY_TOPIC         = 'custom_def_community_topic';
    ...
    const TABLE_COMMUNITY_TOPICS_COMMENTS          = 'community_topics_comments';
    const TABLE_COMMUNITY_TOPICS_STATUS_CATEGORIES = 'community_topics_status_categories';
    const TABLE_GLOSSARY_WORD_DEFINITIONS          = 'glossary_word_definitions';
    const TABLE_GLOSSARY_WORDS                     = 'glossary_words';
    const TABLE_LABELS_COMMUNITY_TOPICS            = 'labels_community_topics';
    ...
    const TABLE_TICKET_COMMUNITY_TOPICS_LINKS      = 'ticket_community_topics_links';
    const TABLE_TICKET_FEEDBACK                    = 'ticket_feedback';
