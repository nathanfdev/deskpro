...
class Terms extends AbstractQueryDefinition
{
    ...
    {
        $defs = [
            self::TICKET_ID                    => ['type' => 'INT'],
            self::TICKET_STATUS                => ['type' => 'STRING'],
            self::TICKET_DEPARTMENT            => ['type' => 'INT'],
            self::TICKET_AGENT                 => ['type' => 'INT'],
            self::TICKET_AGENT_TEAM            => ['type' => 'INT'],
            self::TICKET_FOLLOWERS             => ['type' => 'INT[]'],
            self::TICKET_LANGUAGE              => ['type' => 'INT'],
            self::TICKET_PRODUCT               => ['type' => 'INT'],
            self::TICKET_CATEGORY              => ['type' => 'INT'],
            self::TICKET_PRIORITY              => ['type' => 'INT'],
            self::TICKET_URGENCY               => ['type' => 'INT'],
            self::TICKET_WORKFLOW              => ['type' => 'INT'],
            self::TICKET_LABELS                => ['type' => 'STRING[]'],
            self::TICKET_EMAIL_ACCOUNT         => ['type' => 'INT'],
            self::TICKET_IS_HOLD               => ['type' => 'BOOLEAN'],
            self::TICKET_SLAS                  => ['type' => 'INT[]'],
            ...
            self::PERSON_USERGROUPS            => ['type' => 'INT[]'],
            self::ORG_ID                       => ['type' => 'INT'],
            self::ORG_LABELS                   => ['type' => 'STRING[]'],
            self::ORG_USERGROUPS               => ['type' => 'INT[]'],
        ];
