...
class AccessRequest
{
    ...
    {
        return new AccessRequest(Domain\Constants::ACCESS_SERVICE_API, $authPerson, Domain\Constants::ACCESS_LEVEL_WRITE);
    }
    ...
    {
        return new AccessRequest(Domain\Constants::ACCESS_SERVICE_API, $authPerson, Domain\Constants::ACCESS_LEVEL_READ);
    }
    ...
    {
        return new AccessRequest(Domain\Constants::ACCESS_SERVICE_PROXY, $authPerson, Domain\Constants::ACCESS_LEVEL_READ);
    }
    ...
    {
        return new AccessRequest(Domain\Constants::ACCESS_SERVICE_PROXY, $authPerson, Domain\Constants::ACCESS_LEVEL_WRITE);
    }
