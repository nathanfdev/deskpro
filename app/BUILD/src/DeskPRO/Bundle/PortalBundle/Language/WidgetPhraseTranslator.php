...
class WidgetPhraseTranslator
{
    ...
    public function translatePhrases($languageId = null)
    {
        ...
        if ($languageId) {
            $language = $this->container->get('doctrine.orm.default_entity_manager')->getRepository(Language::class)
                ->find($languageId)
            ;
        }
        ...
        return $this->container->get('serializer')->toArray(new WidgetPhrases($translatedPhrases, $language));
    }
     ...
     */
    private function getBrandContainer()
    {
     ...
     */
    private function getPortalBrandTheme()
    {
        return $this->container->get('portal_brand_theme_loader')->getPortalBrandTheme($this->getBrandContainer()->getBrand());
    }
