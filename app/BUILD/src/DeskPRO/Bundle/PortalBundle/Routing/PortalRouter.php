...
class PortalRouter implements WarmableInterface, RouterInterface, RequestMatcherInterface, RouterDecorator
{
    ...
    public static $legacyPortalRoutes = [
        ...
        'user_community',
        'user_community_topic_new',
        'user_community_topic_newcommunitytopic_finishlogin',
        'user_community_topic_newcomment',
        'user_community_topic_vote',
