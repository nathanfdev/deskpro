...
class LanguageController extends AbstractApiController
{
    ...
    public function widgetPhrasesAction(Request $request)
    {
        $phrases = [
            ...
            'portal.chat.community_enter_message',
            'portal.chat.community_action',
            'portal.chat.community_label',
            'portal.chat.community_not_helpful_title',
            'portal.chat.community_title',
            'portal.chat.helpful',
