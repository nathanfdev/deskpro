 ...
 */
class DpqlYear extends AbstractDpqlFunc
{
    /**
     * {@inheritdoc}
     */
    public function prepare(array $arguments, SelectPart $statement, $section, array $stack, SqlSelect $select, ResultMetadata $metadata)
    {
        if (count($arguments) != 1) {
            throw new DpqlException('DPQL_YEAR() can only accept 1 argument.');
        }
        ...
        $res = new Prepared($sql, 'DPQL_YEAR('.$prepped->name().')', false, 'numberraw');
