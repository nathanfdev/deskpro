...
use DeskPRO\Bundle\AppBundle\Form\Type\Settings\Portal\GuidesSettingsType;
...
/**
 * Class GuidesSettingsController.
 *
 * @ApiModes("all")
 * @Rest\Route("/settings/brands/{brand}/portal/guides")
 */
class GuidesSettingsController extends AbstractBrandAwareSettingsController
{
    /**
     * @ApiDoc(
     ...
     *     },
     *     input= {
     *         "class"="DeskPRO\Bundle\AppBundle\Form\Type\Settings\Widget\Portal\GuidesSettingsType",
     *         "name"="",
     *         "options"={"method"="POST"},
     *     }
     *)
    ...
    {
        return $this->get('portal_settings_resolver')->getGuidesSettings($brand);
    }
    ...
    {
        return GuidesSettingsType::class;
    }

    /**
     * {@inheritdoc}
     *
     * @param GuidesSettings $model
     */
