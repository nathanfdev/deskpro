...
use DeskPRO\Bundle\AppBundle\Form\Type\Task\LinkedItem\TaskLinkedChatType;
use FOS\RestBundle\Controller\Annotations as Rest;

/**
 * Class TaskLinkedChatsController.
 *
 * @ApiModes("all")
...
{
    public static $linkedType = 'chat';
    public static $entity     = TaskLinkedChat::class;
    public static $type       = TaskLinkedChatType::class;
}
