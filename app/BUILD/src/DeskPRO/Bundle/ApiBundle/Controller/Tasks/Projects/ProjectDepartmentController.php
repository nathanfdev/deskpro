 ...
 *
 * @Annotations\Route("/project_members/{parentId}/departments")
 * @ApiDocSection("TaskProjects")
 * @OutputEntity("Application\DeskPRO\Entity\Department")
 * @ApiModes("all")
 */
class ProjectDepartmentController extends AbstractProjectCrudSubController
{
    /**
     * {@inheritdoc}
     */
    ...
    protected function findEntity($id, Request $request)
    {
        ...
        if (!$entity = $this->getDoctrine()->getRepository(self::$entity)->findOneBy(['department' => $id, 'project' => $parent])) {
    ...
    /**
     * Get departments - member of the project with specified id.
     *
     * @ApiDoc(
     *     section="TaskProjects",
     *     tags={"CRUD"="#ffa500"},
     *     resourceDescription="Operations about task projects",
     *     description="get departments for the project with specified id",
     *     requirements={
     ...
     *     },
     *     output="array<Application\DeskPRO\Entity\Department>"
     * )
     *
     * @Annotations\Get("")
     *
    ...
    {
        return $this->wrap($this->getProjectMembers($request->get('parentId'), Department::class));
    }
}
