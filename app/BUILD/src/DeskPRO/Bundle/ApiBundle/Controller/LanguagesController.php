...
class LanguagesController extends CrudController
{
    ...
    public function agentPhrasesAction(Request $request)
    {
        $phrases = [
            ...
            'agent.content_templates.filter.title',
            'agent.content_templates.filter.all',
            'agent.content_templates.filter.news',
            'agent.content_templates.filter.article',
            ...
            'agent.general.confirm_deletion',
            'agent.general.cancelled',
            'agent.general.category',
            'agent.general.change_status',
            'agent.general.chat',
            'agent.general.chats',
            ...
            'agent.general.sort_asc',
            'agent.general.sort_by',
            'agent.general.sort_desc',
            'agent.general.subject',
            'agent.general.status',
            'agent.general.sub_status',
            'agent.general.task',
            'agent.general.tasks',
            'agent.general.team',
            'agent.general.teams',
            ...
            'agent.general.url',
            'agent.general.usergroup',
            'agent.general.user',
            'agent.general.warning',
            'agent.general.when',
            'agent.general.width',
            ...
            'agent.tickets.approvals.id',
            'agent.tickets.approvals.type',
            'agent.tickets.approvals.name',
            'agent.tickets.approvals.description',
            'agent.tickets.approvals.approvers',
            'agent.tickets.approvals.to_approve',
            'agent.tickets.approvals.to_reject',
            ...
            'agent.tickets.approvals.response.vote_type.reject',
            'agent.tickets.approvals.template',
            'agent.tickets.approvals.choose_template',
            'agent.tickets.approvals.request.accept',
            'agent.tickets.approvals.request.reject',
