...
use Application\DeskPRO\Proxy\Exception\FailedToGetPusherSocketAuthSigException;
...
class OutboundHttpProxy
{
    ...
    /**
     * Get a service token for Pusher socket auth
     *
     * @param string $siteId
     ...
     * @throws FailedToExchangeRequestTokenException
     */
    public function getPusherServiceTokenSocketAuthSignature($siteId, $channel, $socketId)
    {
        return $this->fetchServiceToken($siteId, 'pusher', [
    ...
    /**
     * Request pusher socket auth signature
     *
     * @param string $serviceToken JWT generated by @see getPusherServiceToken
     * @return string
     * @throws FailedToGetPusherSocketAuthSigException
     */
    public function getPusherSocketAuthSignature($serviceToken)
    {
        global $DP_ENV;
        ...
        try {
            $response = $this->retry(function () use ($client, $serviceToken) {
                return $client->get('/pusher-socket/auth', [
                    'headers' => [
            ...
            throw new FailedToGetPusherSocketAuthSigException('Failed to get pusher socket auth signature', 0, $e);
        }
    }
