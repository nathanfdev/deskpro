...
class CustomDefDownload extends CustomDefAbstract
{
     ...
     * @return $this
     */
    public function setParent(CustomDefDownload $parent = null)
    {
    ...
    public static function loadMetadata(ClassMetadata $metadata)
    {
        ...
        $metadata->customRepositoryClassName = 'Application\DeskPRO\EntityRepository\CustomDefDownload';
        $metadata->setPrimaryTable(['name' => 'custom_def_download']);
        ...
        $metadata->mapManyToOne([
            'fieldName'    => 'parent',
            'targetEntity' => 'Application\\DeskPRO\\Entity\\CustomDefDownload',
            'mappedBy'     => null,
            'inversedBy'   => 'children',
            'joinColumns'  => [
                0 => [
