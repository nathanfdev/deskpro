...
class ContentSubscription extends \Application\DeskPRO\Domain\DomainObject
{
    ...
    public static function create($content_object, $person)
    {
        ...
        } elseif ($content_object instanceof CommunityTopic) {
    ...
    public static function loadMetadata(ClassMetadata $metadata)
    {
        ...
        $metadata->mapManyToOne(['fieldName' => 'topic', 'targetEntity' => 'Application\\DeskPRO\\Entity\\CommunityTopic', 'mappedBy' => null, 'inversedBy' => null, 'joinColumns' => [0 => ['name' => 'topic_id', 'referencedColumnName' => 'id', 'nullable' => true, 'onDelete' => 'cascade', 'columnDefinition' => null]]]);
