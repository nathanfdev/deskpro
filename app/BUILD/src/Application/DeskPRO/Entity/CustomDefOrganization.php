...
class CustomDefOrganization extends CustomDefAbstract
{
    ...
    public static function loadMetadata(ClassMetadata $metadata)
    {
        ...
        $metadata->mapOneToMany(array('fieldName' => 'children', 'targetEntity' => 'Application\\DeskPRO\\Entity\\CustomDefOrganization', 'cascade' => array(0 => 'remove', 1 => 'persist', 3 => 'merge'), 'mappedBy' => 'parent',  'orderBy' => array('display_order' => 'ASC'), 'orphanRemoval' => true));
