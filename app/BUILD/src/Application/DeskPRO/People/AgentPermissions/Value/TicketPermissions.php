...
class TicketPermissions implements PermissionValueInterface
{
    ...
    /** @var bool  */
    public $modify_add_approval_own = false;
    /** @var bool  */
    public $modify_cancel_approval_own = false;
    /**
     * Wherever the agent can edit/delete, they will be able to enable an option that disables saving the original to history.
     * This is usually used to allow an agent to permanently remove content such as sensitive information like credit-card numbers.
     *
     * @var bool
     */
    public $modify_messages_no_logging_own = false;
    /** @var bool */
    ...
    /** @var bool  */
    public $modify_add_approval_followed = false;
    /** @var bool  */
    public $modify_cancel_approval_followed = false;
    /**
     * Wherever the agent can edit/delete, they will be able to enable an option that disables saving the original to history.
     * This is usually used to allow an agent to permanently remove content such as sensitive information like credit-card numbers.
     *
     * @var bool
     */
    public $modify_messages_no_logging_followed = false;
    /** @var bool */
    ...
    /** @var bool  */
    public $modify_add_approval_unassigned = false;
    /** @var bool  */
    public $modify_cancel_approval_unassigned = false;
    /**
     * Wherever the agent can edit/delete, they will be able to enable an option that disables saving the original to history.
     * This is usually used to allow an agent to permanently remove content such as sensitive information like credit-card numbers.
     *
     * @var bool
     */
    public $modify_messages_no_logging_unassigned = false;
    /** @var bool */
    ...
    /** @var bool  */
    public $modify_add_approval_others = false;
    /** @var bool  */
    public $modify_cancel_approval_others = false;
    /**
     * Wherever the agent can edit/delete, they will be able to enable an option that disables saving the original to history.
     * This is usually used to allow an agent to permanently remove content such as sensitive information like credit-card numbers.
     *
     * @var bool
     */
    public $modify_messages_no_logging_others = false;
    /** @var bool */
    ...
    public function getNames()
    {
        return [
            ...
            'modify_messages_own', 'modify_messages_edit_own', 'modify_messages_delete_own', 'modify_messages_delete_voice_messages_own', 'modify_messages_delete_voice_recordings_own', 'modify_messages_edit_timelimited_notes_own', 'modify_messages_edit_notes_own', 'modify_add_approval_own', 'modify_cancel_approval_own',
            'modify_messages_delete_timelimited_notes_own', 'modify_messages_delete_notes_own', 'modify_messages_convert_notes_own', 'modify_messages_convert_messages_own', 'modify_messages_no_logging_own', 'modify_billing_own', 'delete_own',
            ...
            'modify_set_resolved_followed', 'modify_set_unresolved_followed', 'modify_messages_followed', 'modify_messages_edit_followed', 'modify_messages_delete_followed', 'modify_messages_delete_voice_messages_followed', 'modify_messages_delete_voice_recordings_followed', 'modify_messages_edit_timelimited_notes_followed', 'modify_messages_edit_notes_followed', 'modify_add_approval_followed', 'modify_cancel_approval_followed',
            'modify_messages_delete_timelimited_notes_followed', 'modify_messages_delete_notes_followed', 'modify_messages_convert_notes_followed', 'modify_messages_convert_messages_followed', 'modify_messages_no_logging_followed', 'modify_billing_followed', 'delete_followed', 'view_unassigned', 'reply_unassigned', 'modify_unassigned',
            ...
            'modify_set_resolved_unassigned', 'modify_set_unresolved_unassigned', 'modify_messages_unassigned', 'modify_messages_edit_unassigned', 'modify_messages_delete_unassigned', 'modify_messages_delete_voice_messages_unassigned', 'modify_messages_delete_voice_recordings_unassigned', 'modify_messages_edit_timelimited_notes_unassigned', 'modify_messages_edit_notes_unassigned', 'modify_add_approval_unassigned', 'modify_cancel_approval_unassigned',
            'modify_messages_delete_timelimited_notes_unassigned', 'modify_messages_delete_notes_unassigned', 'modify_messages_convert_notes_unassigned', 'modify_messages_convert_messages_unassigned', 'modify_messages_no_logging_unassigned', 'modify_billing_unassigned', 'delete_unassigned', 'view_others', 'reply_others', 'modify_others',
            ...
            'modify_messages_others', 'modify_messages_edit_others', 'modify_messages_delete_others', 'modify_messages_delete_voice_messages_others', 'modify_messages_delete_voice_recordings_others', 'modify_messages_edit_timelimited_notes_others', 'modify_messages_edit_notes_others', 'modify_add_approval_others', 'modify_cancel_approval_others',
            'modify_messages_delete_timelimited_notes_others', 'modify_messages_delete_notes_others', 'modify_messages_convert_notes_others', 'modify_messages_convert_messages_others', 'modify_messages_no_logging_others', 'delete_others', 'modify_billing_others',
    ...
    {
        return [
            'delete_own', 'delete_followed', 'delete_unassigned', 'delete_others',
            'modify_messages_own', 'modify_messages_followed', 'modify_messages_unassigned', 'modify_messages_others',
            'modify_messages_delete_own', 'modify_messages_delete_followed', 'modify_messages_delete_unassigned', 'modify_messages_delete_others',
            'modify_messages_delete_timelimited_notes_own', 'modify_messages_delete_timelimited_notes_followed', 'modify_messages_delete_timelimited_notes_unassigned', 'modify_messages_delete_timelimited_notes_others',
            'modify_messages_delete_notes_own', 'modify_messages_delete_notes_followed', 'modify_messages_delete_notes_unassigned', 'modify_messages_delete_notes_others',
            'modify_messages_delete_voice_messages_own', 'modify_messages_delete_voice_messages_followed', 'modify_messages_delete_voice_messages_unassigned', 'modify_messages_delete_voice_messages_others',
            'modify_messages_delete_voice_recordings_own', 'modify_messages_delete_voice_recordings_followed', 'modify_messages_delete_voice_recordings_unassigned', 'modify_messages_delete_voice_recordings_others',
            'modify_messages_no_logging_own', 'modify_messages_no_logging_followed', 'modify_messages_no_logging_unassigned', 'modify_messages_no_logging_others',
        ];
    }
}
