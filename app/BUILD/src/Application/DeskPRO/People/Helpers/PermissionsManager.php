...
class PermissionsManager implements \Orb\Helper\ShortCallableInterface
{
    ...
    public function hasPerm($name)
    {
        ...
        // agents might have perm to use pubish, but if its disabled everywhere then we dont want to show
        // the feature in agent interface
        if (($name === 'agent_publish.use' || $name === 'agent_publish.create') &&
