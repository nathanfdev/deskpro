...
class DevGenDpqlDocsCommand extends \Symfony\Bundle\FrameworkBundle\Command\ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        $tableDescriptions = [
            ...
            'community_topics'            => 'Customer community topics and suggestion records',
            'community_topic_attachments' => 'Attachments to community topics and suggestions',
            'community_topic_comments'    => 'Comments for community topics and suggestions',
        ...
        $conditionResolvers = [
            ...
            'custom_data_community_topics' => ['#', ' (Gets data for the community topic field with ID #)'],
