...
namespace Application\DeskPRO\Dpql2\Statement;

use Application\DeskPRO\App;
use Application\DeskPRO\Dpql2;
use Application\DeskPRO\Dpql2\Exception;
use Application\DeskPRO\Dpql2\Results;
use Application\DeskPRO\Dpql2\Statement\Part\AbstractPart;
...
class SelectPart
{
     ...
     * WHERE clause.
     *
     * @var \Application\DeskPRO\Dpql2\Statement\Part\AbstractPart|null
     */
     ...
     * SQL select object.
     *
     * @var \Application\DeskPRO\Dpql2\SqlSelect
     */
    protected $_sql;
     ...
     *
     * @var \Application\DeskPRO\Dpql2\SqlSelect|null
     */
    protected $_splitSql;
    ...
    /**
     * @var \Application\DeskPRO\Dpql2\ResultHandler
     */
     ...
     */
    public function __construct(array $select, $from)
    {
        $this->setSelect($select);
        $this->setFrom($from);

        $this->_sql              = new Dpql2\SqlSelect();
        $this->_resultHandler    = new Dpql2\ResultHandler();
        $this->_sqlSelectContext = new Dpql2\SqlSelectContext($this->_resultHandler, [
            new Dpql2\Plugin\Hierarchy\HierarchyPlugin($this),
        ]);
    }
     ...
     *
     * @return \Application\DeskPRO\Dpql2\Results
     */
    ...
    /**
     * @return \Application\DeskPRO\Dpql2\ResultHandler
     */
     ...
     *
     * @return \Application\DeskPRO\Dpql2\Renderer\AbstractRenderer
     */
    public function getRenderer($rendererType, array $results = null)
    {
        ...
        return \Application\DeskPRO\Dpql2\Renderer\AbstractRenderer::create(
    ...
    public function addPreparedSelectField(\Application\DeskPRO\Dpql2\Statement\Part\Prepared $select, $alias = false)
    {
        if ($select->hasValue()) {
    ...
    /**
     * @return \Application\DeskPRO\Dpql2\SqlSelect|null
     */
    ...
    public function stackForcedUtc(array $stack)
    {
        foreach ($stack as $element) {
            if ($element instanceof \Application\DeskPRO\Dpql2\Statement\Part\FunctionCall
    ...
    /**
     * @param \Application\DeskPRO\Dpql2\Statement\Part\AbstractPart[] $select
     */
    ...
    /**
     * @param \Application\DeskPRO\Dpql2\Statement\Part\AbstractPart|null $where
     */
    ...
    /**
     * @return \Application\DeskPRO\Dpql2\Statement\Part\AbstractPart|null
     */
    ...
    /**
     * @param \Application\DeskPRO\Dpql2\Statement\Part\AbstractPart[] $splitBy
     */
    ...
    /**
     * @param \Application\DeskPRO\Dpql2\Statement\Part\AbstractPart[] $groupBy
     */
    ...
    /**
     * @param \Application\DeskPRO\Dpql2\Statement\Part\AbstractPart[] $orderBy
     */
