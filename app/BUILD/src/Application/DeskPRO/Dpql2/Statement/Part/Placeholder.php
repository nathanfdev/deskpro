...
use Application\DeskPRO\Dpql2\Placeholder\AbstractPlaceholder;
...
class Placeholder extends AbstractPart
{
    ...
    public function prepareWithIntervals(
        SelectPart $statement, $section, array $stack, Dpql2\SqlSelect $select, Dpql2\ResultHandler $result, array $intervals = []
    ) {
     ...
     * @param \Application\DeskPRO\Dpql2\ResultHandler                 $result
     * @param \Application\DeskPRO\Dpql2\Statement\Part\BinaryInterval[] List of intervals that affect this calculation
     *
     * @throws \Application\DeskPRO\Dpql2\Exception
     *
    ...
    public function prepareComparison(
        ...
        Dpql2\SqlSelect $select, Dpql2\ResultHandler $result, array $intervals = []
    ) {
