...
namespace Application\DeskPRO\Dpql2\Plugin\Hierarchy;

use Application\DeskPRO\App;
use Application\DeskPRO\Dpql2\Exception;
use Application\DeskPRO\Dpql2\Plugin\PluginInterface;
use Application\DeskPRO\Dpql2\ResultHandler;
use Application\DeskPRO\Dpql2\SqlSelect;
use Application\DeskPRO\Dpql2\Statement\Part\Column;
...
class HierarchyPlugin implements PluginInterface
{
     ...
     */
    public function __construct(SelectPart $query)
    {
        $this->query = $query;
    }
    ...
    public function collectChildrenIds()
    {
        ...
        $repository = SelectPart::getRepositoryByTable($this->hierarchyDescendsFromTable);
