 ...
 *
 * @package Application\DeskPRO\Tickets
 */
abstract class AbstractExecutorContext implements ExecutorContextInterface
{
    /**
     ...
     * @var string
     */
    protected $event_type = 'update';

    /**
     * @var string
     */
    protected $event_method = 'system';

    /**
     * @var array
     */
    protected $event_method_options = [];

    /**
     * @var null
     */
    protected $event_performer = 'system';
