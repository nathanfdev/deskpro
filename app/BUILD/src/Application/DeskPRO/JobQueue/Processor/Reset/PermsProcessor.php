    ...
    protected function doProcess(array $data)
    {
        ...
        $this->em->getConnection()->executeUpdate("
            ...
            VALUES
                ...
                ($ugid, NULL, '1', 'agent_tickets.modify_messages_edit_own'),
                ($ugid, NULL, '1', 'agent_tickets.modify_messages_edit_timelimited_notes_own'),
                ($ugid, NULL, '1', 'agent_tickets.modify_messages_edit_notes_own'),
                ($ugid, NULL, '1', 'agent_tickets.modify_messages_convert_notes_own'),
                ($ugid, NULL, '1', 'agent_tickets.modify_messages_convert_messages_own'),
                ($ugid, NULL, '1', 'agent_tickets.modify_messages_edit_followed'),
                ($ugid, NULL, '1', 'agent_tickets.modify_messages_edit_timelimited_notes_followed'),
                ($ugid, NULL, '1', 'agent_tickets.modify_messages_edit_notes_followed'),
                ($ugid, NULL, '1', 'agent_tickets.modify_messages_convert_notes_followed'),
                ($ugid, NULL, '1', 'agent_tickets.modify_messages_convert_messages_followed'),
                ($ugid, NULL, '1', 'agent_tickets.modify_messages_edit_unassigned'),
                ($ugid, NULL, '1', 'agent_tickets.modify_messages_edit_timelimited_notes_unassigned'),
                ($ugid, NULL, '1', 'agent_tickets.modify_messages_edit_notes_unassigned'),
                ($ugid, NULL, '1', 'agent_tickets.modify_messages_convert_notes_unassigned'),
                ($ugid, NULL, '1', 'agent_tickets.modify_messages_convert_messages_unassigned'),
                ($ugid, NULL, '1', 'agent_tickets.modify_messages_edit_others'),
                ($ugid, NULL, '1', 'agent_tickets.modify_messages_edit_timelimited_notes_others'),
                ($ugid, NULL, '1', 'agent_tickets.modify_messages_edit_notes_others'),
                ($ugid, NULL, '1', 'agent_tickets.modify_messages_convert_notes_others'),
                ($ugid, NULL, '1', 'agent_tickets.modify_messages_convert_messages_others'),
