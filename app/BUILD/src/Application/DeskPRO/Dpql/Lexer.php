        ...
        do {
            if (preg_match($yy_global_pattern, $this->_input, $yymatches, null, $this->_counter)) {
                ...
                if ($r === null) {
                    ...
                    $yy_yymore_patterns = [
        1  => [0, "\G(,)|\G(\\()|\G(\\))|\G(;)|\G(@)|\G('([^\\\\']+|\\\\.)*')|\G(-?([0-9]*\\.[0-9]+|[0-9]+))|\G(%[a-zA-Z0-9_:.]+%)|\G([a-zA-Z_][a-zA-Z0-9_]*\\.([a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?\\.)*\\*)|\G([a-zA-Z_][a-zA-Z0-9_]*\\.([a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?\\.)*[a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?)|\G(\\+|-|\\*|\/|!=|<>|>=|<=|<|>|=|&&|\\|\\||!)|\G([a-zA-Z_][a-zA-Z0-9_]*)"],
        2  => [0, "\G(\\()|\G(\\))|\G(;)|\G(@)|\G('([^\\\\']+|\\\\.)*')|\G(-?([0-9]*\\.[0-9]+|[0-9]+))|\G(%[a-zA-Z0-9_:.]+%)|\G([a-zA-Z_][a-zA-Z0-9_]*\\.([a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?\\.)*\\*)|\G([a-zA-Z_][a-zA-Z0-9_]*\\.([a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?\\.)*[a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?)|\G(\\+|-|\\*|\/|!=|<>|>=|<=|<|>|=|&&|\\|\\||!)|\G([a-zA-Z_][a-zA-Z0-9_]*)"],
        3  => [0, "\G(\\))|\G(;)|\G(@)|\G('([^\\\\']+|\\\\.)*')|\G(-?([0-9]*\\.[0-9]+|[0-9]+))|\G(%[a-zA-Z0-9_:.]+%)|\G([a-zA-Z_][a-zA-Z0-9_]*\\.([a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?\\.)*\\*)|\G([a-zA-Z_][a-zA-Z0-9_]*\\.([a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?\\.)*[a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?)|\G(\\+|-|\\*|\/|!=|<>|>=|<=|<|>|=|&&|\\|\\||!)|\G([a-zA-Z_][a-zA-Z0-9_]*)"],
        4  => [0, "\G(;)|\G(@)|\G('([^\\\\']+|\\\\.)*')|\G(-?([0-9]*\\.[0-9]+|[0-9]+))|\G(%[a-zA-Z0-9_:.]+%)|\G([a-zA-Z_][a-zA-Z0-9_]*\\.([a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?\\.)*\\*)|\G([a-zA-Z_][a-zA-Z0-9_]*\\.([a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?\\.)*[a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?)|\G(\\+|-|\\*|\/|!=|<>|>=|<=|<|>|=|&&|\\|\\||!)|\G([a-zA-Z_][a-zA-Z0-9_]*)"],
        5  => [0, "\G(@)|\G('([^\\\\']+|\\\\.)*')|\G(-?([0-9]*\\.[0-9]+|[0-9]+))|\G(%[a-zA-Z0-9_:.]+%)|\G([a-zA-Z_][a-zA-Z0-9_]*\\.([a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?\\.)*\\*)|\G([a-zA-Z_][a-zA-Z0-9_]*\\.([a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?\\.)*[a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?)|\G(\\+|-|\\*|\/|!=|<>|>=|<=|<|>|=|&&|\\|\\||!)|\G([a-zA-Z_][a-zA-Z0-9_]*)"],
        6  => [0, "\G('([^\\\\']+|\\\\.)*')|\G(-?([0-9]*\\.[0-9]+|[0-9]+))|\G(%[a-zA-Z0-9_:.]+%)|\G([a-zA-Z_][a-zA-Z0-9_]*\\.([a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?\\.)*\\*)|\G([a-zA-Z_][a-zA-Z0-9_]*\\.([a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?\\.)*[a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?)|\G(\\+|-|\\*|\/|!=|<>|>=|<=|<|>|=|&&|\\|\\||!)|\G([a-zA-Z_][a-zA-Z0-9_]*)"],
        7  => [1, "\G(-?([0-9]*\\.[0-9]+|[0-9]+))|\G(%[a-zA-Z0-9_:.]+%)|\G([a-zA-Z_][a-zA-Z0-9_]*\\.([a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?\\.)*\\*)|\G([a-zA-Z_][a-zA-Z0-9_]*\\.([a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?\\.)*[a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?)|\G(\\+|-|\\*|\/|!=|<>|>=|<=|<|>|=|&&|\\|\\||!)|\G([a-zA-Z_][a-zA-Z0-9_]*)"],
        9  => [2, "\G(%[a-zA-Z0-9_:.]+%)|\G([a-zA-Z_][a-zA-Z0-9_]*\\.([a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?\\.)*\\*)|\G([a-zA-Z_][a-zA-Z0-9_]*\\.([a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?\\.)*[a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?)|\G(\\+|-|\\*|\/|!=|<>|>=|<=|<|>|=|&&|\\|\\||!)|\G([a-zA-Z_][a-zA-Z0-9_]*)"],
        11 => [2, "\G([a-zA-Z_][a-zA-Z0-9_]*\\.([a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?\\.)*\\*)|\G([a-zA-Z_][a-zA-Z0-9_]*\\.([a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?\\.)*[a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?)|\G(\\+|-|\\*|\/|!=|<>|>=|<=|<|>|=|&&|\\|\\||!)|\G([a-zA-Z_][a-zA-Z0-9_]*)"],
        12 => [4, "\G([a-zA-Z_][a-zA-Z0-9_]*\\.([a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?\\.)*[a-zA-Z_][a-zA-Z0-9_]*(\\[[a-zA-Z0-9_]+\\])?)|\G(\\+|-|\\*|\/|!=|<>|>=|<=|<|>|=|&&|\\|\\||!)|\G([a-zA-Z_][a-zA-Z0-9_]*)"],
        15 => [7, "\G(\\+|-|\\*|\/|!=|<>|>=|<=|<|>|=|&&|\\|\\||!)|\G([a-zA-Z_][a-zA-Z0-9_]*)"],
        19 => [7, "\G([a-zA-Z_][a-zA-Z0-9_]*)"],
        20 => [7, ''],
    ];
