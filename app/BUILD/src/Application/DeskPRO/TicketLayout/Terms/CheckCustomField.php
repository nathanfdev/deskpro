...
abstract class CheckCustomField extends \Application\DeskPRO\Tickets\Triggers\Terms\CheckTicketField implements TicketLayoutTermInterface
{
    /**
     * {@inheritdoc}
     */
    ...
    abstract protected function getSubmittedData(array $data);
    ...
    public function isSubmittedDataMatch(array $data)
    {
        ...
        $submitted   = $this->getSubmittedData($data);
        ...
        switch ($type) {
            ...
            case 'datetime':
                ...
                switch ($op) {
                    ...
                    case AbstractTriggerTerm::OP_BETWEEN:
                        if (!$date1 || !$date2) {
                            return false;
                        }
