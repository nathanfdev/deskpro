...
$collection->create('dashboards_list', [
    'path'       => '/dashboards',
...
$collection->create('dashboards_get', [
    'path'         => '/dashboards/{id}',
...
$collection->create('dashboard_create', [
    'path'       => '/dashboards',
    'controller' => 'LegacyApiBundle:Dashboard:save',
    'defaults'   => ['action' => 'save', 'id' => 0],
    'methods'    => ['POST'],
]);

$collection->create('dashboard_update', [
    'path'         => '/dashboards/{id}',
    'controller'   => 'LegacyApiBundle:Dashboard:save',
    'requirements' => ['id' => '\\d+'],
...
$collection->create('dashboard_clone', [
...
$collection->create('dashboard_delete', [
    'path'         => '/dashboards/{id}',
...
$collection->create('dashboards_reports_list', [
...
$collection->create('dashboard_reports_get', [
...
$collection->create('dashboard_reports_create', [
    'path'         => '/dashboards/reports/{dashboard_id}',
    'controller'   => 'LegacyApiBundle:DashboardReport:create',
    'defaults'     => ['action' => 'create'],
    'requirements' => ['dashboard_id' => '\\d+'],
    'methods'      => ['POST'],
]);

$collection->create('dashboard_reports_update', [
...
$collection->create('dashboards_reports_clone', [
    ...
    'requirements' => ['id' => '\\d+', 'dashboard_id' => '\\d+'],
    'defaults'     => ['action' => 'clone'],
    'methods'      => ['POST'],
]);

$collection->create('dashboards_reports_delete    ', [
    'path'         => '/dashboards/reports/{id}',
...
$collection->create('dashboards_permissions_list', [
...
$collection->create('dashboards_permissions_list_new_dashboard', [
...
$collection->create('dashboards_permissions_save', [
    'path'         => '/dashboards/permissions/{id}',
