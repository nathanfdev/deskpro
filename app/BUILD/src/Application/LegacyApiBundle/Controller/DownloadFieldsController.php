...
/**
 * Class DownloadFieldsController.
 *
 * @ApiModes("all")
 */
class DownloadFieldsController extends AbstractController implements ProtectedControllerInterface
{
    /**
     * {@inheritdoc}
     */
    ...
    public function listAction()
    {
        ...
        /** @var \Application\DeskPRO\CustomFields\FieldManager $fieldManager */
    ...
    {
        $field = $this->em->find(CustomDefDownload::class, $id);
    ...
    public function saveCustomFieldAction($id)
    {
        ...
        if ($id) {
            ...
            return $this->createSuccessResponse(
                [
                    'field_id' => $field->id,
                    $this->generateUrl('api_download_fields_get', ['id' => $field->id]),
                ]
            );
        }
    }
    ...
    public function saveDisplayOrderAction()
    {
        ...
        $this->em->getRepository(CustomDefDownload::class)->updateDisplayOrders($displayOrders);
