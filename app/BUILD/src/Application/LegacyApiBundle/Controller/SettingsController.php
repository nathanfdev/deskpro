        ...
        switch ($app) {
            ...
            case 'community':
                $settings = [
                    ...
                    'tab_enabled'   => (bool) $this->settings->get('user.portal_tab_community'),
                    'subscriptions' => (bool) $this->settings->get('user.community_subscriptions'),
                ];
                break;
        ...
        switch ($app) {
            ...
            case 'community':
                $settings = [
                    ...
                    'user.portal_tab_community'    => (int) ($this->in->getBool('settings.enabled') && $this->in->getBool('settings.tab_enabled')),
                    'user.community_subscriptions' => (int) $this->in->getBool('settings.subscriptions'),
                ];
                break;
