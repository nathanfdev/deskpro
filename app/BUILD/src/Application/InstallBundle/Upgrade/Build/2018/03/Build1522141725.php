...
class Build1522141725 extends AbstractBuild implements BlockingBuildInterface
{
    ...
    public function runAlters()
    {
        ...
        $queries['create'][] = 'CREATE TABLE ticket_filters2_set_teams (filter_set_id INT NOT NULL, agent_id INT NOT NULL, INDEX IDX_BF123BB83DD05366 (filter_set_id), INDEX IDX_BF123BB83414710B (agent_id), PRIMARY KEY(filter_set_id, agent_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci';
        ...
        $queries['alter'][]  = 'ALTER TABLE ticket_filters2_set_teams ADD CONSTRAINT FK_BF123BB83DD05366 FOREIGN KEY (filter_set_id) REFERENCES ticket_filters2_sets (id) ON DELETE CASCADE, ADD CONSTRAINT FK_BF123BB83414710B FOREIGN KEY (agent_id) REFERENCES agent_teams (id) ON DELETE CASCADE';
