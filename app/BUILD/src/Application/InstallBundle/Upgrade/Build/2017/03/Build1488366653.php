...
class Build1488366653 extends AbstractBuild
{
    public function run()
    {
        $this->out('Add manuals tables');
        ...
        $this->execDbQuery('default', 'ALTER TABLE manual_topics ADD CONSTRAINT FK_DE6B71F0727ACA70 FOREIGN KEY (parent_id) REFERENCES manual_topics (id) ON DELETE SET NULL');
        $this->execDbQuery('default', 'ALTER TABLE manual_topics ADD CONSTRAINT FK_DE6B71F09BA073D6 FOREIGN KEY (manual_id) REFERENCES manuals (id) ON DELETE CASCADE');
        $this->execDbQuery('default', 'ALTER TABLE manual_topics ADD CONSTRAINT FK_DE6B71F0217BBB47 FOREIGN KEY (person_id) REFERENCES people (id) ON DELETE SET NULL');
        $this->execDbQuery('default', 'ALTER TABLE manual_topics ADD CONSTRAINT FK_DE6B71F082F1BAF4 FOREIGN KEY (language_id) REFERENCES languages (id) ON DELETE CASCADE');
