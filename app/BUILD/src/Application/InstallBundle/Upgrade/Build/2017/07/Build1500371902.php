...
class Build1500371902 extends AbstractBuild implements BlockingBuildInterface, SkipPostBuildInterface
{
    ...
    {
        $this->execDbQuery('default', 'ALTER TABLE app2_app_state CHANGE scope scope VARCHAR(255) NOT NULL');
    }
