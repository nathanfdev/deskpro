...
class Build1493905797 extends AbstractBuild implements OnlineBuildInterface, SkipPostBuildInterface
{
    public function addNewTables()
    {
        ...
        $this->execDbQuery('default', 'CREATE TABLE app2_app_asset_blob (id INT AUTO_INCREMENT NOT NULL, app_id INT NOT NULL, blob_id INT NOT NULL, path VARCHAR(255) NOT NULL, blob_authcode VARCHAR(255) NOT NULL, INDEX IDX_B4A87CA07987212D (app_id), UNIQUE INDEX UNIQ_B4A87CA0ED3E8EA5 (blob_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->execDbQuery('default', 'CREATE TABLE app2_app_instance (id INT AUTO_INCREMENT NOT NULL, app_id INT NOT NULL, scope VARCHAR(100) NOT NULL, settings LONGTEXT DEFAULT NULL, secret_key LONGTEXT DEFAULT NULL, createdAt DATETIME DEFAULT NULL, INDEX IDX_B1B171047987212D (app_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->execDbQuery('default', "CREATE TABLE app2_app_state (id INT AUTO_INCREMENT NOT NULL, app_instance_id INT NOT NULL, owner_id INT DEFAULT NULL, scope VARCHAR(255) NOT NULL COMMENT \'(DC2Type:appstore_state_scope)\', name VARCHAR(255) NOT NULL, value LONGTEXT NOT NULL, ownerId INT DEFAULT NULL, targetId INT DEFAULT NULL, createdAt DATETIME DEFAULT NULL, INDEX IDX_F5878E6863B454A1 (app_instance_id), INDEX IDX_F5878E687E3C61F9 (owner_id), UNIQUE INDEX state_unique (app_instance_id, name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
