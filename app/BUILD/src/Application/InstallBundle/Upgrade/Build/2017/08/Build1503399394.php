...
class Build1503399394 extends AbstractBuild implements BlockingBuildInterface
{
    public function addNewTables()
    {
        ...
        $this->execDbQuery('default', "ALTER TABLE object_aliases ADD CONSTRAINT FK_1C80DCBB7987212D FOREIGN KEY (app_id) REFERENCES app2_app (id)");
        $this->execDbQuery('default', "ALTER TABLE object_aliases ADD CONSTRAINT FK_1C80DCBB9DA6716B FOREIGN KEY (custom_def_ticket_id) REFERENCES custom_def_ticket (id)");
        $this->execDbQuery('default', "ALTER TABLE object_aliases ADD CONSTRAINT FK_1C80DCBBE856A96F FOREIGN KEY (custom_def_organization_id) REFERENCES custom_def_organizations (id)");
        $this->execDbQuery('default', "ALTER TABLE object_aliases ADD CONSTRAINT FK_1C80DCBBDCE1FF8F FOREIGN KEY (custom_def_people_id) REFERENCES custom_def_people (id)");
        $this->execDbQuery('default', "ALTER TABLE object_aliases ADD CONSTRAINT FK_1C80DCBBE40E1167 FOREIGN KEY (ticket_triggers_id) REFERENCES ticket_triggers (id)");
    }
