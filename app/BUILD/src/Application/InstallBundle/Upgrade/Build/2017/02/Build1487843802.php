...
class Build1487843802 extends AbstractBuild
{
    public function run()
    {
        ...
        $this->execDbQuery('default', 'CREATE TABLE manual_topics (id INT AUTO_INCREMENT NOT NULL, manual_id INT DEFAULT NULL, parent_id INT DEFAULT NULL, person_id INT DEFAULT NULL, language_id INT DEFAULT NULL, slug VARCHAR(100) NOT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, content_input LONGTEXT NOT NULL, content_input_type VARCHAR(100) DEFAULT NULL, view_count INT NOT NULL, total_rating INT NOT NULL, num_comments INT NOT NULL, num_ratings INT NOT NULL, status VARCHAR(15) NOT NULL, hidden_status VARCHAR(15) DEFAULT NULL, no_content TINYINT(1) NOT NULL, display_order INT NOT NULL, date_created DATETIME NOT NULL, date_updated DATETIME DEFAULT NULL, date_published DATETIME DEFAULT NULL, date_last_comment DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_DF8545B8989D9B62 (slug), INDEX IDX_DF8545B89BA073D6 (manual_id), INDEX IDX_DE6B71F0727ACA70 (parent_id), INDEX IDX_DF8545B8217BBB47 (person_id), INDEX IDX_DF8545B882F1BAF4 (language_id), INDEX date_published_idx (date_published), INDEX date_updated_idx (date_updated), INDEX date_last_comment_idx (date_last_comment), INDEX status_idx (status), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci');
