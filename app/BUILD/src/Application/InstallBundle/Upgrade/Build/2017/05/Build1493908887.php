...
class Build1493908887 extends AbstractBuild implements BlockingBuildInterface, SkipPostBuildInterface
{
    ...
    {
        $this->execDbQuery('default', 'ALTER TABLE app2_app_asset CHANGE app_id app_id INT DEFAULT NULL');
        $this->execDbQuery('default', 'ALTER TABLE app2_app_asset_blob CHANGE app_id app_id INT DEFAULT NULL, CHANGE blob_id blob_id INT DEFAULT NULL');
        $this->execDbQuery('default', 'ALTER TABLE app2_app_instance ADD name VARCHAR(255) NOT NULL');
    }
