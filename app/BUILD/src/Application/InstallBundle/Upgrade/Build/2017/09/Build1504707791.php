...
class Build1504707791 extends AbstractBuild implements OnlineBuildInterface, SkipPostBuildInterface
{
    ...
    {
        $this->execDbQuery('default', 'CREATE TABLE snippet_use_log (id INT AUTO_INCREMENT NOT NULL, date_created DATETIME NOT NULL, ticket_message_id INT DEFAULT NULL, chat_message_id INT DEFAULT NULL, snippet_id INT DEFAULT NULL, language_id INT DEFAULT NULL, person_id INT DEFAULT NULL, rating LONGTEXT NOT NULL, type VARCHAR(255) DEFAULT NULL, INDEX IDX_43190050C5E9817D (ticket_message_id), INDEX IDX_43190050948B568F (chat_message_id), INDEX IDX_431900506E34B975 (snippet_id), INDEX IDX_4319005082F1BAF4 (language_id), INDEX IDX_43190050217BBB47 (person_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
