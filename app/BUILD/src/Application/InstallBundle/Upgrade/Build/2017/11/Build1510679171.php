...
class Build1510679171 extends AbstractBuild implements OnlineBuildInterface, SkipPostBuildInterface
{
    ...
    {
        $this->execDbQuery('default', 'CREATE TABLE chat_round_robin (id INT AUTO_INCREMENT NOT NULL, last_agent_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, online_only TINYINT(1) NOT NULL, INDEX IDX_9A12C3794C753495 (last_agent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->execDbQuery('default', 'CREATE TABLE chat_round_robin_agents (agent_id INT NOT NULL, robin_id INT NOT NULL, sort INT NOT NULL, INDEX IDX_4AF4702D3414710B (agent_id), INDEX IDX_4AF4702D654E52F7 (robin_id), PRIMARY KEY(agent_id, robin_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
