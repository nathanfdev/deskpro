...
class Build1565949454 extends AbstractBuild implements OnlineBuildInterface, SkipPostBuildInterface
{

    public function addNewTables()
    {
        $this->execDbQuery('default', 'CREATE TABLE approval_templates (id BIGINT AUTO_INCREMENT NOT NULL, type_id BIGINT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, approval_criteria LONGTEXT NOT NULL COMMENT \'(DC2Type:dp_json_obj)\', required_approvals INT NOT NULL, required_rejections INT NOT NULL, can_approvers_view_subject TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_92D5AF50C54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->execDbQuery('default', 'CREATE TABLE approvals (id BIGINT AUTO_INCREMENT NOT NULL, template_id BIGINT DEFAULT NULL, type_id BIGINT NOT NULL, ticket_id INT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, status VARCHAR(60) NOT NULL, approvers LONGTEXT NOT NULL COMMENT \'(DC2Type:json_array)\', last_approved_response_at DATETIME DEFAULT NULL, last_reject_response_at DATETIME DEFAULT NULL, completed_at DATETIME DEFAULT NULL, cancelled_at DATETIME DEFAULT NULL, required_approvals INT NOT NULL, required_rejections INT NOT NULL, can_approvers_view_subject TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, dtype VARCHAR(60) NOT NULL, INDEX IDX_B7A4D6DE5DA0FB8 (template_id), INDEX IDX_B7A4D6DEC54C8C93 (type_id), INDEX IDX_B7A4D6DE700047D2 (ticket_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
