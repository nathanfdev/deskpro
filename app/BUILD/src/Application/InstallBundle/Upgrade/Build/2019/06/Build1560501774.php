...
class Build1560501774 extends AbstractBuild implements OnlineBuildInterface
{
    public function addNewTables()
    {
        $this->execDbQuery('default', 'CREATE TABLE direct_message_threads (id INT AUTO_INCREMENT NOT NULL, participant_ids LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:simple_array)\', date_last_message DATETIME DEFAULT NULL, date_created DATETIME NOT NULL, UNIQUE INDEX UNIQ_4BC51CF17FF87BFB (participant_ids(255)), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
