...
class Build1562064076 extends AbstractBuild implements BlockingBuildInterface, SkipPostBuildInterface
{
    ...
    public function runAlters()
    {
        ...
        $this->execDbQuery('default', 'ALTER TABLE community_channel2usergroup DROP FOREIGN KEY FK_B304B93C12469DE2');
        $this->execDbQuery('default', 'ALTER TABLE community_channel2usergroup DROP FOREIGN KEY FK_B304B93CD2112630');
        $this->execDbQuery('default', 'DROP INDEX idx_b304b93c12469de2 ON community_channel2usergroup');
        $this->execDbQuery('default', 'CREATE INDEX IDX_5A6CA578433ED7B6 ON community_channel2usergroup (community_channel_id)');
        $this->execDbQuery('default', 'DROP INDEX idx_b304b93cd2112630 ON community_channel2usergroup');
        $this->execDbQuery('default', 'CREATE INDEX IDX_5A6CA578D2112630 ON community_channel2usergroup (usergroup_id)');
        $this->execDbQuery('default', 'ALTER TABLE community_channel2usergroup ADD CONSTRAINT FK_B304B93C12469DE2 FOREIGN KEY (community_channel_id) REFERENCES community_channels (id) ON DELETE CASCADE');
        $this->execDbQuery('default', 'ALTER TABLE community_channel2usergroup ADD CONSTRAINT FK_B304B93CD2112630 FOREIGN KEY (usergroup_id) REFERENCES usergroups (id) ON DELETE CASCADE');
