...
class Build1481307336 extends AbstractBuild
{
    public function run()
    {
        ...
        if (!$schemaHelper->tableHasColumn('email_accounts', 'cert_blob_id')) {
        ...
        if (!$schemaHelper->tableHasColumn('email_accounts', 'key_blob_id')) {
        ...
        if (!$schemaHelper->tableHasColumn('email_accounts', 'key_pass_phrase')) {
