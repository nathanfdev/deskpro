...
class Build1481109798 extends AbstractBuild
{
    public function run()
    {
        ...
        if (!$schemaHelper->tableHasColumn('email_acounts', 'cert_blob_id')) {
        ...
        if (!$schemaHelper->tableHasColumn('email_acounts', 'key_blob_id')) {
