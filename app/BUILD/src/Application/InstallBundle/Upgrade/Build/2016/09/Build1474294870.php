...
/*db:default*/ CREATE TABLE voice_targets (id INT AUTO_INCREMENT NOT NULL, queue_id INT DEFAULT NULL, agent_id INT DEFAULT NULL, type VARCHAR(30) NOT NULL, INDEX IDX_F637E580477B5BAE (queue_id), INDEX IDX_F637E5803414710B (agent_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
/*db:default*/ ALTER TABLE voice_targets ADD CONSTRAINT FK_F637E580477B5BAE FOREIGN KEY (queue_id) REFERENCES voice_queues (id) ON DELETE CASCADE;
