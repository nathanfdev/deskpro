...
/*db:default*/ CREATE TABLE twilio_queues (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, routing_model VARCHAR(255) NOT NULL, max_queue_size INT NOT NULL, greetAsset_id INT DEFAULT NULL, loopAsset_id INT DEFAULT NULL, voicemailAsset_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_9737CB2B96094606 (greetAsset_id), UNIQUE INDEX UNIQ_9737CB2BDC60BD4E (loopAsset_id), UNIQUE INDEX UNIQ_9737CB2B43642E22 (voicemailAsset_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
/*db:default*/ ALTER TABLE twilio_queues ADD CONSTRAINT FK_9737CB2B43642E22 FOREIGN KEY (voicemailAsset_id) REFERENCES twilio_assets (id);
