...
/*db:default*/ CREATE TABLE voice_phone_calls (id INT AUTO_INCREMENT NOT NULL, number_id INT DEFAULT NULL, sid VARCHAR(50) NOT NULL, from_number VARCHAR(50) NOT NULL, data LONGTEXT NOT NULL COMMENT '(DC2Type:json_array)', INDEX IDX_6679AE4C30A1DE10 (number_id), UNIQUE INDEX call_sid (sid), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
