...
<form id="admin_form" action="<?php echo $view['router']->generate('install_configedit') ?>" method="post">
    ...
    <fieldset>
        ...
        <div class="clearfix">
            ...
            <div class="input">
                <input type="text" name="DP_DATABASE_HOST" value="<?php if ($exist['DP_DATABASE_HOST']) {
    echo $exist['DP_DATABASE_HOST'];
} else {
    if ($is_win) {
        echo '127.0.0.1';
    } else {
        ...
        <div class="clearfix">
            ...
            <div class="input">
                <input type="text" name="DP_DATABASE_USER" value="<?php if ($exist['DP_DATABASE_USER']) {
    echo $exist['DP_DATABASE_USER'];
} else {
    echo 'root';
} ?>" size="30" />
            </div>
        ...
        <div class="clearfix">
            ...
            <div class="input">
                <input type="text" name="DP_DATABASE_PASSWORD" value="<?php if ($exist['DP_DATABASE_PASSWORD']) {
    echo $exist['DP_DATABASE_PASSWORD'];
} else {
    echo '';
} ?>" size="30" />
            </div>
        ...
        <div class="clearfix">
            ...
            <div class="input">
                <input type="text" name="DP_DATABASE_NAME" value="<?php if ($exist['DP_DATABASE_NAME']) {
    echo $exist['DP_DATABASE_NAME'];
} else {
    echo 'deskpro';
} ?>" size="30" />
            </div>
        ...
        <div class="clearfix">
            ...
            <div class="input">
                <input type="text" name="DP_TECHNICAL_EMAIL" value="<?php if ($exist['DP_TECHNICAL_EMAIL']) {
    echo $exist['DP_TECHNICAL_EMAIL'];
} else {
    echo '';
} ?>" placeholder="Enter an email address" size="30" />
