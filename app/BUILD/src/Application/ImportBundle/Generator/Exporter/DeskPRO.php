...
class DeskPRO extends AbstractExporter implements ExporterBatchInterface
{
    ...
    public function getCountByType($type)
    {
        ...
        return min($count, $this->getBatchConfig()->getBatchSize());
    }
    ...
    {
        /** @var Parser\DeskPRO\Tickets $tickets_parser */
        $tickets_parser = $this->getParserByType(Entity\EntityInterface::TYPE_TICKET);
        /** @var Parser\DeskPRO\People $people_parser */
    ...
    {
        return new Parser\DeskPRO\BatchConfig();
    }
