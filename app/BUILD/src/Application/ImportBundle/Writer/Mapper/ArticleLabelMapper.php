 ...
 * Class ArticleLabel
 */
class ArticleLabelMapper extends AbstractEntityManagerMapper
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $criteria = ['article' => $id];
        $entities = $this->em->getRepository(LabelArticle::class)->findBy($criteria);
