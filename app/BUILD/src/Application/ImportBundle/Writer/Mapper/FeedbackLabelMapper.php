 ...
 * Class FeedbackLabel
 */
class FeedbackLabelMapper extends AbstractEntityManagerMapper
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $criteria = ['feedback' => $id];
        $records  = $this->em->getRepository(LabelFeedback::class)->findBy($criteria);
