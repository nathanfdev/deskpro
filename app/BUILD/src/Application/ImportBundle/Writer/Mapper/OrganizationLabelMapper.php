 ...
 */
class OrganizationLabelMapper extends AbstractEntityManagerMapper
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return LabelOrganization::class;
    }
    ...
    public function findByOrganizationId($id, $throw_exception = true)
    {
        ...
        $entities = $this->em->getRepository(LabelOrganization::class)->findBy($criteria);
