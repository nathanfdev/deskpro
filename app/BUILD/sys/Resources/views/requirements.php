    ...
    <div class="sf-reset">
        <div class="block">
            <div class="symfony-block-content">
                ...
                <?php if ($checker->hasPhpIniConfigIssue()): ?>
                    <p id="phpini">*
                        <?php if ($checker->getPhpIniConfigPath()): ?>
                            Changes to the <strong>php.ini</strong> file must be done in "<strong><?php echo $checker->getPhpIniConfigPath() ?></strong>".
                        <?php else: ?>
                ...
                <ul class="symfony-install-continue">
                    <?php if (count($majorProblems) || count($minorProblems)): ?>
                        <li><a href="#" onclick="window.location.reload(); return false;">Re-check configuration</a></li>
                    <?php endif; ?>
                </ul>
            </div>
        </div>
