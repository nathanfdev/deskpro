        ...
        <nav>
            <ul>
                ...
                <?php if ($opcache->getOption('allow_reset')): ?>
                    <li><a href="<?php echo '?auth='.$_GET['auth'].'&reset' ?>" id="resetCache"
                           onclick="return confirm('Are you sure you want to reset the cache?');">Reset cache</a></li>
                <?php endif; ?>
        ...
        var Gauge = function(el, colour) {
            ...
            this.draw     = function() {
                ...
                self.loop = setInterval(function() {
                    self.animate();
                }, 1000 / (this.newdegs - this.degrees));
            };
            ...
            $('#toggleRealtime').click(function() {
                if (realtime === false) {
                    realtime = setInterval(function() {
                        updateStatus()
                    }, <?php echo (int) $opcache->getOption('refresh_time') * 1000; ?>);
                ...
                return (
                    React.createElement("div", null,
                        React.createElement("div", null,
                            ...
                            React.createElement("p", null, React.createElement(MemoryUsage, {
                        ...
                        React.createElement("div", null,
                            ...
                            React.createElement("p", null, React.createElement(HitRate, {
                                chart: this.state.chart,
                ...
                var directiveNodes = this.state.data.map(function(directive) {
                    ...
                    return (
                        React.createElement("tr", { key: directive.k },
                            React.createElement("td", { title: 'View ' + directive.k + ' manual entry' }, React.createElement("a", {
                                href:   'http://php.net/manual/en/opcache.configuration.php#ini.'
                                        + (directive.k).replace(/_/g, '-'),
                                target: "_blank"
                            }, dShow)),
            ...
            render:           function() {
                if (this.state.allowFiles) {
                    var fileNodes = this.state.data.map(function(file, i) {
                        ...
                        if (canInvalidate) {
                            invalidate = React.createElement("span", null, ", ",
                                React.createElement("a", {
                                    className:   "metainfo",
                                    href:        window.location+'&invalidate=' + file.full_path,
