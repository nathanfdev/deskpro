define(['DeskPRO/Util/Strings', 'DeskPRO/Util/Util'], function (Strings, Util) {
    return ['$scope', 'Api', '$q', '$modal', '$timeout', function ($scope, Api, $q, $modal, $timeout) {
        ...
        ['cert', 'sso_url'].forEach(function (field) {
      ...
      function checkRequirements() {
        Api.sendGet('/apps/packages/deskpro_us_bitium/check-requirements').then(function(res) {
      ...
      checkRequirements();
        ...
        $scope.openTestModal = function (existing_results) {
            ...
            return $modal.open({
                templateUrl: 'deskpro_us_bitium/Install/test-settings-modal.html',
