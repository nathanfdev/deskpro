...
return [
    ...
    'agent.voice.call_agent_invited'                        => 'Agent {{person_name}} {{person_email}} was invited',
    'agent.voice.call_agent_transfer'                       => 'Call transferred to agent {{person_name}} {{person_email}}',
    'agent.voice.call_user_joined'                          => 'User {{person_name}} {{person_email}} joined the call',
    'agent.voice.call_agent_joined'                         => 'Agent {{person_name}} {{person_email}} joined the call',
    'agent.voice.call_agent_cancel_invite'                  => 'Agent {{person_name}} {{person_email}} canceled invite',
    'agent.voice.call_agent_ignore_invite'                  => 'Agent {{person_name}} {{person_email}} ignore invite',
    'agent.voice.call_agent_left'                           => 'Agent {{person_name}} {{person_email}} left the call',
    'agent.voice.call_user_left'                            => 'User {{person_name}} {{person_email}} left the call',
    'agent.voice.call_user_disconnected'                    => 'User {{person_name}} {{person_email}} disconnected',
    'agent.voice.call_agent_disconnected'                   => 'Agent {{person_name}} {{person_email}} disconnected',
