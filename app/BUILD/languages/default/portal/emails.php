...
return array(
    ...
    'portal.emails.profile_email_link-validate' => 'Click on the following link to validate to your email address',
    ...
    'portal.emails.feedback_agent-validation'       => 'Note that your feedback will not appear publicly on our support portal until one of our agents manually approves it.',
    'portal.emails.feedback_approved'               => 'We are emailing to let you know that your feedback was approved and is now publicly visible on our support portal.',
    'portal.emails.feedback_closed'                 => 'Your submitted feedback "{{title}}" was closed: {{status}}',
    'portal.emails.feedback_disapproved'            => 'We are emailing to let you know that your feedback has been declined and will not appear publicly on our support portal.',
    'portal.emails.feedback_disapproved-reason'     => 'We are emailing to let you know that your feedback has been declined and will not appear publicly on our support portal. {{name}} gave the following reason:',
    ...
    'portal.emails.kb-explain'                      => 'You are receiving this email because you subscribed to updates about knowledgebase articles at <a href="{{ deskpro_url }}">{{ deskpro_url }}</a>.<br />Don\'t want these emails anymore? <a href="{{ unsubscribe_url }}">Click here to unsubscribe from all knowledgebase notifications.</a>',
    ...
    'portal.emails.news-explain'                    => 'You are receiving this email because you are subscribed to updates about feedback items at <a href="{{ deskpro_url }}">{{ deskpro_url }}</a>.<br />Don\'t want these emails anymore? <a href="{{ unsubscribe_url }}">Click here to unsubscribe from all news notifications.</a>',
    'portal.emails.feedback-explain'                => 'You are receiving this email because you are subscribed to updates about feedback items at <a href="{{ deskpro_url }}">{{ deskpro_url }}</a>.<br />Don\'t want these emails anymore? <a href="{{ unsubscribe_url }}">Click here to unsubscribe from all feedback notifications.</a>',
    ...
    'portal.emails.downloads-explain'               => 'You are receiving this email because you subscribed to updates about downloads available at <a href="{{ deskpro_url }}">{{ deskpro_url }}</a>.<br />Don\'t want these emails anymore? <a href="{{ unsubscribe_url }}">Click here to unsubscribe from all downloads notifications.</a>',
    ...
    'portal.emails.register-agent-validation'       => 'Note: Before your account is fully active, our agents must manually validate your account. Anything you submit will be held in a validation queue until an agent validates your account.',
    ...
    'portal.emails.reject_resolved-new'             => 'If you want to create a brand new ticket, you can send an email to <a href="mailto:{{email_to}}">{{email_to}}</a> or use our online form at:<br /><a href="{{link}}">{{link}}</a>',
