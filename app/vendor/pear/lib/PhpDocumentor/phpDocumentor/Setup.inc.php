...
class phpDocumentor_setup
{
    ...
    function readConfigFile($file)
    {
        ...
        {
            if ('C:\wamp\bin\php\php5.3.10\PEAR\\data' != '@'.'DATA-DIR@')
            {
                $configdir = str_replace('\\','/', 'C:\wamp\bin\php\php5.3.10\PEAR\\data/PhpDocumentor') . PATH_DELIMITER . 'user' . PATH_DELIMITER;
            } else {
    ...
    function parseIni()
    {
        ...
        if ('C:\wamp\bin\php\php5.3.10\PEAR\\data' != '@'.'DATA-DIR@')
        {
            $options = phpDocumentor_parse_ini_file(str_replace('\\','/', 'C:\wamp\bin\php\php5.3.10\PEAR\\data/PhpDocumentor') . PATH_DELIMITER . 'phpDocumentor.ini',true);
            phpDocumentor_out("   (found in " . 'C:\wamp\bin\php\php5.3.10\PEAR\\data/PhpDocumentor' . PATH_DELIMITER . ")...\n");
        } else {
