...
use DeskproPlugins\FacebookWidgets\PluginPackage\Installer;
use DeskproPlugins\FacebookWidgets\PluginPackage\Uninstaller;
...
class PluginPackage extends AbstractPluginPackage
{
	...
	{
		$installer = new Installer('DeskproPlugins\\FacebookWidgets\\PluginPackage', $install_controller);
	...
	{
		return "Facebook Like/Comments Widgets";
	}
	...
	{
		return "Add a facebook 'Like' button to articles, and optionally enable Facebook for comments on articles.";
	}
}