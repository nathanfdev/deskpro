<?php return array(
	...
	'user.emails.registration_closed'                                      => '{{name}}様  新たなリクエストの受付はヘルプデスクのメンバー様からに限定されています。既にアカウントをお持ちのお客様は、登録済みのメールアドレスからもう一度Eメールを送り直してください。',
	'user.emails.ticket_access_ticket_online'                              => 'このリクエストをウェブ上で表示し管理:',
	'user.emails.ticket_cc-new'                                            => '{{name}}さんにより作成されたリクエストにあなたは追加されました。',
	'user.emails.ticket_flood'                                             => 'ヘルプデスクへメールを頂いた方へ通知します。あなたから短い間隔で複数のメッセージを頂いたため、当社の自動システムはあなたからのメッセージを自動発信のメッセージであると判断しました。 双方の自動発信によるループトラフィックを避けるため、当社からの自動通知メッセージの送信を停止します。',
	...
	'user.emails.ticket_validate'                                          => 'ご連絡をいただきありがとうございます。 エージェントによる対応を開始する前に、あなたのメールアドレスの認証手続きを行ってください。',
