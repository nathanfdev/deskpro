<?php return array(
	...
	'user.knowledgebase.title-articles'      => 'There is {{count}} article|There are {{count}} articles',
	'user.knowledgebase.title-categories'    => 'There is {{count}} sub-category|There are {{count}} sub-categories',
