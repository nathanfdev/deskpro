<?php return array(
    ...
    'user.agents_working'                 => 'Our agents will now read and reply to all of your messages.',
    ...
    'user.comments_enter_details'    => 'Enter a question, keyword or topic..',
    'user.comments_logged_in_as'                       => 'Logged In As',
    'user.comments_login'                              => 'Login',
    'user.comments_add_a_comment'                => 'Add a comment',
    'user.comments_please_enter_email'                 => 'Please enter your email address',
    'user.comments_login_to_comment'            => '{link1} or {link2} to submit comments.',
    ...
    'user.title_links_safe'        => 'Don\'t worry, you can click a title and you will remain on this page.',
    ...
    'user.lost_password_sent'                  => 'If we have an account with this email address, then we have sent you instructions on how to reset your password.',
    'user.lost_qm'                                     => 'lost?',
    ...
    'user.register_email_exists'       => 'This email address already belongs to a registered user.',
    'user.register_extra_benefits'            => 'Here are some other benifits',
    ...
    'user.register_password_min_length'          => 'Please enter a password of at least 5 characters.',
    'user.register_please_enter_email'                 => 'Please enter email address',
    'user.register_enter_name'                  => 'Please enter your name.',
    'user.register_enter_valid_email'           => 'Please enter a valid email address.',
    'user.register_wait'                        => 'Please wait',
    'user.register_wait_while'                  => 'Please wait while we connect you to an agent',
    ...
    'user.register_similar_results'         => 'We\'ve found the following results that are similar to your message',
    ...
    'user.validation_email_sent'   => 'You should have recieved a validation email with a special link in it. If you never got this email, click the button below to request another one.',
    'user.resend_validation_email'                     => 'Resend Validation Email',
    'user.reset_password'                              => 'Reset Password',
    'user.resolved'                                    => 'Resolved',
    'user.save'                                        => 'Save',
    'user.search'                                      => 'Search',
    'user.is_search_relevant'                      => 'Did not find what you were looking for?',
    'user.send'                                        => 'Send',
    ...
    'user.you_have_validated' => 'Thank you for validating your email address.',
    ...
    'user.access_ticket_online'               => 'View and manage this ticket online:',
    ...
    'user.widget_good_result'            => 'This is not what I was looking for',
    'user.widget_bad_result'                => 'This is what I needed',
    'user.you'                                         => 'You',
