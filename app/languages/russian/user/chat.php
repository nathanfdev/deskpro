<?php return array(
	...
	'user.chat.message_long-wait'                                          => 'Мы все еще пытаемся подобрать Вам специалиста; обычно это занимает меньше минуты. <br /><br />Спешите? <a class="cancel-and-newticket-trigger">Лучше оставьте нам сообщение</a>',
	...
	'user.chat.message_user-joined'                                        => '{{name}} присоеденился к диалогу',
	'user.chat.message_user-left'                                          => '{{name}} прекратил диалог',
	'user.chat.message_user-returned'                                      => 'Пользовалель вернулся',
	'user.chat.message_user-timeout'                                       => 'Пользователь времеено вышел',
