<?php return array(
	...
	'user.emails.feedback_updated'                                         => 'Dit indlæg "{{title}}" er blevet opdateret og kan nu findes under den nye status "{{title}}"',
	...
	'user.emails.greeting'                                                 => 'Kære {{name}},',
	...
	'user.emails.register-confirm'                                         => 'Tak fordi du oprettede en konto. ⏎
Før at du kan bruge din konto, skal du bekræfte din email adresse på følgende link.',
	'user.emails.registration_closed'                                      => 'Kære {{name}},

Nye sager bliver kun accepteret fra vores helpdesk medlemmer. Hvis du allerede har en konto, så email os venligts igen fra den adresse du oprindeligt registrerede.',
	...
	'user.emails.ticket_flood'                                             => 'Du har for nyligt sendt en mail til vores helpdesk. Vores system har automatisk bemærket, at du har sendt mange beskeder hurtigt efter hinanden.
For at beskytte mod autosvar loop vil vores helpdesk ikke sende flere email notifikationer til dig.',
	...
	'user.emails.ticket_validate'                                          => 'Tak fordi du kontaktede os.
Før vore medarbejdere læser og svarer din besked, skal du bekræfte din email adresse.',
