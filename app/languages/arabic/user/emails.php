<?php return array(
	...
	'user.emails.register-confirm'                                         => 'شكرا لقيامك بتسجيل حسابك ⏎ قبل ان تكون قادر على إستخدام حسابك , يجب عليك تأكيد بريدك الإلكتروني عن طريق الرابط التالي',
	'user.emails.registration_closed'                                      => 'عزيزي {{name}},⏎ التذاكر الجديدة تقبل فقط من الأعضاء المسجلين . إذا كنتم عضو مسجل بالفعل , يرجي إعادة إرسال تذكرتك من خلال بريدك الإلكتروني المسجل به',
	...
	'user.emails.ticket_validate'                                          => 'شكرا لك علي الإتصال بنا ⏎ يجب عليك تأكيد صحة بريدك الإلكتروني , لكي يقوم أحد موظفينا بالرد عليك',
