<?php return array(
	...
	'user.emails.register-confirm'                                         => 'Merci d\'avoir créé un compte. Avant de pouvoir utiliser votre compte, vous devez valider votre adresse mail en cliquant sur le lien suivant',
	'user.emails.registration_closed'                                      => 'Chère/Cher {{name}},  Seuls les membres inscrits au service d\'aide sont habilités à poster de nouveaux tickets. Si vous possédez un compte, merci de nous écrire avec l\'adresse email enregistrée pour votre compte.',
	...
	'user.emails.ticket_flood'                                             => 'Vous avez récemment envoyé un email à notre service d\'assistance, suite à quoi notre système a détecté l\'envoi successifs par votre boite mail de nombreux messages certainement automatiques. Pour éviter la création d\'une chaine de messages automatiques notre service d\'assistance ne vous enverra plus de notifications automatiques par email.',
	...
	'user.emails.ticket_validate'                                          => 'Merci de nous avoir contacté. Avant que nos agents ne lisent et répondent à votre message, vous devez valider votre adresse email.',
