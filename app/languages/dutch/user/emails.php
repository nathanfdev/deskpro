<?php return array(
	...
	'user.emails.register-confirm'                                         => 'Bedankt voor het registreren van uw account. Voordat u het account kunt gebruiken, dient u uw e-mailadres te valideren via de volgende link:',
	'user.emails.registration_closed'                                      => 'Beste {{name}},  Nieuwe tickets worden alleen geaccepteerd van bestaande helpdesk leden. Als u al over een account beschikt, ontvangen wij graag een e-mail vanaf het geregistreerde e-mailadres.',
	...
	'user.emails.ticket_flood'                                             => 'U heeft onlangs een e-mail naar onze helpdesk gestuurd. Ons geautomatiseerd systeem heeft ontdekt dat er veel berichten zijn gestuurd. Ter bescherming tegen een hoop automatische antwoorden, zal onze helpdesk geen automatische meldingen naar uw e-mailadres verzenden.',
	...
	'user.emails.ticket_validate'                                          => 'Bedankt voor het contact opnemen. Voordat onze medewerkers u verder kunnen helpen, dient u uw e-mailadres te verifiëren.',
