...
'user.unassigned' => '[user.unassigned]',
  ...
  'user.more_btn' => '[user.more_btn]',
  'user.new' => '[user.new]',
  'user.accepted' => '[user.accepted]',
  'user.declined' => '[user.declined]',
  'user.completed' => '[user.completed]',
  'user.login_with_twitter' => '[user.login_with_twitter]',
  'user.register' => '[user.register]',
  'user.remove_participant' => '[user.remove_participant]',
  'user.add_using_name_and_email' => '[user.add_using_name_and_email]',
  'user.first_name' => '[user.first_name]',
  'user.last_name' => '[user.last_name]',
  'user.form_email' => '[user.form_email]',
  'user.btn_add' => '[user.btn_add]',
  'user.please_enter_department' => '[user.please_enter_department]',
);