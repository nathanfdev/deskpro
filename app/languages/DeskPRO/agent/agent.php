...
'agent.msg_user_timeout' => '[agent.msg_user_timeout]',
'agent.msg_agent_timeout' => '[agent.msg_agent_timeout]',
'agent.id' => '[agent.id]',
'agent.label' => '[agent.label]',
'agent.person_id' => '[agent.person_id]',
'agent.assigned_agent_id' => '[agent.assigned_agent_id]',
'agent.order_by' => '[agent.order_by]',
