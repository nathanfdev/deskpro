<?php return array(
    ...
    'portal.account.validation_alert' =>  'Please verify your email address (<strong>{{ email }}</strong>) by clicking the link we sent you. Some helpdesk features may be disabled until you verify. Click here to re-send the email.',
