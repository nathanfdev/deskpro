...
return array(
    ...
    'portal.account.emails_are_awaiting_validation'    => 'The following email addresses are awaiting validation:',
    'portal.account.impersonating'                     => 'you are impersonating the user',
    'portal.account.exit_impersonation'                => 'exit impersonation mode',
    'portal.account.validation_alert'                  => 'Please verify your email address ({{ email }}) by clicking the link we sent you. Some helpdesk features may be disabled until you verify. Click here to re-send.',
    'portal.account.validation_alert_extra_email'      => 'Please verify your email address ({{ email }}) by clicking the link we sent you. Click here to re-send the email.',
