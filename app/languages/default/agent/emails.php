<?php return array(
	...
	'agent.emails.subject_new_ticket'              => '[#{{ticket_id}} NEW TICKET] {{ticket_subject}}',
	'agent.emails.subject_new_ticket_assigned'     => '[#{{ticket_id}} NEW TICKET + ASSIGNED] {{ticket_subject}}',
	'agent.emails.subject_new_ticket_assignedteam' => '[#{{ticket_id}} NEW TICKET + ASSIGNED TEAM] {{ticket_subject}}',
