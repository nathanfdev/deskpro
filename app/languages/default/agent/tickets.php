<?php return array(
	...
	'agent.tickets.send_notifs_from_name_action'        => 'Send user notifications with then from name {{name}}',
	'agent.tickets.send_agent_notifs_from_email_action' => 'Send agent notifications from {{email}}',
	'agent.tickets.send_agent_notifs_from_name_action'  => 'Send agent notifications with then from name {{name}}',
