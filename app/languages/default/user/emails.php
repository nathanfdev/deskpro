...
return array(
    ...
    'user.emails.chat_validate_email'             => 'Please validate your email address online by entering code "{{validation_code}}" in the widget form or clicking the following link:',
    ...
    'user.emails.remind_unresolved_final_subject' => 'REMINDER: {{ ticket.subject }}',
    'user.emails.remind_unresolved_subject'       => 'REMINDER: {{ ticket.subject }}',
    ...
    'user.emails.kb-explain'                      => 'You are receiving this email because you are subscribed to our knowledgebase at <a href="{{ deskpro_url }}">{{ deskpro_url }}</a>.<br />Do not want these emails anymore? <a href="{{ unsubscribe_url }}">Click here to unsubscribe from all knowledgebase notifications.</a>',
    ...
    'user.emails.news-explain'                    => 'You are receiving this email because you are subscribed to our news at <a href="{{ deskpro_url }}">{{ deskpro_url }}</a>.<br />Do not want these emails anymore? <a href="{{ unsubscribe_url }}">Click here to unsubscribe from all news notifications.</a>',
    'user.emails.feedback-explain'                => 'You are receiving this email because you are subscribed to our news at <a href="{{ deskpro_url }}">{{ deskpro_url }}</a>.<br />Do not want these emails anymore? <a href="{{ unsubscribe_url }}">Click here to unsubscribe from all feedback notifications.</a>',
    ...
    'user.emails.downloads-explain'               => 'You are receiving this email because you are subscribed to our downloads at <a href="{{ deskpro_url }}">{{ deskpro_url }}</a>.<br />Do not want these emails anymore? <a href="{{ unsubscribe_url }}">Click here to unsubscribe from all downloads notifications.</a>',
    ...
    'user.emails.new-ticket-guest-link'           => 'Thank you for contacting us. You may view the status of your ticket online at this address:',
);
