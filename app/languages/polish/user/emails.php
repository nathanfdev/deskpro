<?php return array(
	...
	'user.emails.register-confirm'                                         => 'Dziękujemy za rejestrację konta. Żeby zacząć używać swojego konta, potwierdź swój adres email klikając na następujący link',
	'user.emails.registration_closed'                                      => 'Szanowny(a) {{name}},  Nowe petycje mogą być wysłane tylko przez zarejestrowanych użytkowników Helpdesku. Jeżeli już masz konto, napisz do nas ze swojego zarejestrowanego adresu email.',
	...
	'user.emails.ticket_flood'                                             => 'Niedawno wysłałeś(aś) email do naszego Helpdesku. Nasz system automatyczny wykrył, że wysłałeś(aś) wiele wiadomości w krótkim czasie, jak by były automatycznie zgenerowane. Żeby się zabezpieczyć przed pętlą automatycznych odpowiedzi, nasz Helpdesk nie będzie więcej wysyłał do Ciebie automatycznych powiadomień.',
	...
	'user.emails.ticket_validate'                                          => 'Dziękujemy za Twoją wiadomość. Zanim nasi pracownicy przeczytają i odpowiedzą na nią, musisz potwierdzić swój adres email.',
