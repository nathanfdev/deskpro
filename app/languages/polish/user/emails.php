...
Zanim będziesz mógł używać swojego konta, musisz kliknąć na następujący link, żeby potwierdzić swój adres email.',
	'user.emails.registration_closed'                                      => 'Szanowny(a) {{name}},

Nowe petycje mogą być wysłane tylko przez zarejestrowanych użytkowników Helpdesku. Jeżeli już masz konto, napisz do nas ze swojego zarejestrowanego adresu email.',
...
Żeby się zabezpieczyć przed pętlą automatycznych odpowiedzi, nasz Helpdesk nie będzie więcej wysyłał do Ciebie automatycznych powiadomień.',
	...
	'user.emails.ticket_validate'                                          => 'Dziękujemy za Twoją wiadomość.
Zanim nasi pracownicy przeczytają i odpowiedzą na nią, musisz potwierdzić swój adres email.',
