...
Żeby zacząć używać swojego konta, potwierdź swój adres email klikając na następujący link',
...
Nowe petycje mogą być wysłane tylko przez zarejestrowanych użytkowników Helpdesku. Jeżeli już masz konto, napisz do nas ze swojego zarejestrowanego adresu email.',
	...
	'user.emails.ticket_flood'                                             => 'Niedawno wysłałeś(aś) email do naszego Helpdesku. Nasz system automatyczny wykrył, że wysłałeś(aś) wiele wiadomości w krótkim czasie, jak by były automatycznie zgenerowane.
