...
export const forgotPassword = createAction(
  ...
  params =>
    api.sendPost('DP_API/cloud/forgot_password', params)
);
export const extendTrial = createAction(
  'EXTEND_SUBMIT',
  params =>
    api.sendPost('DP_API/cloud/submit_detail', params)
);
...
export const deleteFeedback = createAction(
  ...
  params =>
    api.sendPost('DP_API/cloud/delete_feedback', params)
);
export const submitQuestion = createAction(
  'EXTEND_SUBMIT_QUESTION',
  params =>
    api.sendPost('DP_API/cloud/question', params)
);
