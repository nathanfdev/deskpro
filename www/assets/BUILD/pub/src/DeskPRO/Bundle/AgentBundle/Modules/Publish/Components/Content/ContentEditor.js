        ...
        <div style={{ position: 'relative' }} ref={this.wrapperRef}>
          ...
          <ArticleEditor
            ...
            uppyOptions={{
              autoProceed: false,
              xhrUpload:   {
                endpoint:             `${window.ASSETS_BASE_URL_FULL.replace(/^http(s)?:/, window.location.protocol).replace(window.ASSETS_BASE_URL, '')}/agent/misc/accept-redactor-image-upload?source_ref=content.image`,
                fieldName:            'file',
