...
@injectIntl
export class APCTable extends Component {
  static propTypes = {
  ...
  renderRow(id) {
    ...
    return (
      <tr key={id}>
        ...
        <Td visible>
          <PersonInTable person={people.get(element.get('assigned_person'))}/>
        </Td>
        <Td className="item-title">
          <a href="#"><SlicedString string={element.get('comment')}/></a>
        </Td>
        <Td visible>
