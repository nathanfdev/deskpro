...
export const labelsSelector           = createSelector(stateSelector, state => state.get('labels'));
export const starsCountSelector       = createSelector(stateSelector, state => state.get('starsCount'));
...
export const loadingFilterIdsSelector = createSelector(
  stateSelector, state => state.getIn(['async', 'filtersLoading']));
