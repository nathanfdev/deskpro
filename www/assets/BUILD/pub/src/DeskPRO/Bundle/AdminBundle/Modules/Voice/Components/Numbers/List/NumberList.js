  ...
  renderEmpty() {
    ...
    return (
      <div className="page">
        ...
        { window.DP_IS_TESTING || window.DP_IS_DEV_ENV ? (<button className="ui primary button" onClick={onAddExistingNumber}>
          Add existing number
        </button>) : null }
      </div>
    );
  ...
  renderTable() {
    ...
    return (
      <div className="page">
        ...
        { window.DP_IS_TESTING || window.DP_IS_DEV_ENV ? (<button className="ui right floated basic button" onClick={onAddExistingNumber}>
          <i className="icon plus" />
          Add existing number
        </button>) : null }
