...
import HcAttach from '../../../../React/Form/DropZone/HcAttach';

export default class HcCustomFieldAttach extends PageWidget {
  ...
  renderWidget() {
    ...
    const component = React.createElement(HcAttach, {
