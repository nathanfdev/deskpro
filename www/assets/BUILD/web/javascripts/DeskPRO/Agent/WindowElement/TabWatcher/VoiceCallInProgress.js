...
/**
 * This handles increasing poll frequency when a voice is open
 */
DeskPRO.Agent.WindowElement.TabWatcher.VoiceCallInProgress = new Orb.Class({
  ...
  tabRemoved: function(tab) {
    ...
    var tabs = DeskPRO_Window.tabWatcher.findTabType('voice-call');
    if (!tabs.length) {
