...
DeskPRO.Agent.RuleBuilder.TimeTerm = new Orb.Class({
	...
	_initUi: function() {
        ...
        this.inputHour1 = $('select[name="Hour2"]', this.rowEl);
        this.inputMinute1 = $('select[name="Minute1"]', this.rowEl);
        this.inputHour2 = $('select[name="Hour2"]', this.rowEl);
        this.inputMinute2 = $('select[name="Minute2"]', this.rowEl);
        this.endDiv = $('.time_between_end', this.rowEl);
