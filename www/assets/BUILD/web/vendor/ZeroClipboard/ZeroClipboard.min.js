...
(function () {
  ...
  var a   = function () {
    ...
    var c = {left: 0, top: 0, width: 0, height: 0, zIndex: 999999999}, d = b(a, "z-index");
  ...
  o.prototype.setCurrent = function (a) {
    ...
    a = typeof a == "boolean" ? a : !!a, r.call(this, a), this.options.forceHandCursor = a
  };
  var r = function (a) {
    this.ready() && this.flashBridge.setHandCursor(a)
  };
  o.version = "1.2.0-beta.4";
  var s = {moviePath:  "ZeroClipboard.swf",
    trustedDomains:    null,
    text:              null,
  ...
  o.prototype.resetBridge = function () {
    this.htmlBridge.style.left = "-9999px", this.htmlBridge.style.top = "-9999px", this.htmlBridge.removeAttribute("title"), this.htmlBridge.removeAttribute("data-clipboard-text"), g(p, this.options.activeClass), p = null, this.options.text = null
    ...
    this.handlers.noflash && !o.detectFlashSupport() && this.receiveEvent("onNoFlash", null)
    ...
    if (!q.length && o.prototype._singleton) {
      var a = o.prototype._singleton.htmlBridge;
      a.parentNode.removeChild(a);
      delete o.prototype._singleton;
    }
