...
<div style="position: relative">
  <div id="dp_dev_bar_btn">
    <button><i class="fas fa-flask"></i> Devbar</button>
  </div>
  <div id="dp_dev_bar" style="display:none;">
    <button class="trigger_reloadcss"><i class="far fa-eye"></i> Reload CSS</button>
    <button class="trigger_reloadpage"><i class="fas fa-sync"></i> Reload Page</button>
    <button class="trigger_close"><i class="fas fa-times-circle"></i></button>
  </div>
</div>\
`,
