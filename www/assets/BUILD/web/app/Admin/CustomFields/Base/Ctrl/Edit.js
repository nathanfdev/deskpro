define([
  ...
  class Admin_CustomFields_Base_Ctrl_Edit extends Admin_Ctrl_Base {
    ...
    initialLoad() {
      const promises = [];
      promises.push(this.Api2.sendGet('/currencies').then(response => this.currencies = response.data.data));
    ...
    startDelete() {
      ...
      const doDelete = () => this.fieldDataService.deleteFieldById(this.field_id);
