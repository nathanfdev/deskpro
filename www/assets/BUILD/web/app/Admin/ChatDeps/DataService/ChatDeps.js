...
define([
  ...
  let ChatDeps;
  return ChatDeps = (function() {
    ChatDeps = class ChatDeps extends BaseListEdit {
      static initClass() {
        this.$inject = ['Api', 'Api2', '$q'];
      }

      url() { return '/chat_deps'; }
     ...
     * @return {promise}
      */
      ...
      saveDisplayOrders(orders) {
        ...
        const promise = this.Api.sendPostJson('/chat_deps/display_order', postData);
        return promise;
      }
