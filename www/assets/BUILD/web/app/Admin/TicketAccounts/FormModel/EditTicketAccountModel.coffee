define [
  ...
  class Admin_TicketAccounts_FormModel_EditTicketAccountModel
    constructor: (@account, deps, trigger) ->
      ...
      @form.in_office365_exchange_account  = {
      ...
      @form.out_office365_exchange_account  = {
        host: 'partner.outlook.cn'
      }
      ...
      if @account.incoming_account_type
        ...
        if @form.incoming_type == 'office365_exchange'
          @form.in_office365_exchange_account.host        = @account.incoming_account.host
          @form.in_office365_exchange_account.user        = @account.incoming_account.user
          @form.in_office365_exchange_account.password    = @account.incoming_account.password
      ...
      if @account.outgoing_account_type
        ...
        if @form.outgoing_type == 'office365_exchange'
          @form.out_office365_exchange_account.host        = @account.outgoing_account.host
          @form.out_office365_exchange_account.user        = @account.outgoing_account.user
          @form.out_office365_exchange_account.password    = @account.outgoing_account.password
