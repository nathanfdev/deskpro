define([
  ...
  class Admin_TicketFilters_Ctrl_List extends Admin_Ctrl_Base {
    ...
    init() {
      ...
      this.$scope.$watch('display_filter', () => this.updateFilterList()
      , true);
      ...
      return this.sortedListOptions = {
        ...
        update: (ev, data) => {
          ...
          return this.filterData.saveDisplayOrder(orders).then(() => this.pingElement('display_orders'));
        }
      };
    }
    ...
    startDelete(filter_id) {
      ...
      return inst.result.then(() => this.filterData.deleteFilterId(filter.id).then(() => {
