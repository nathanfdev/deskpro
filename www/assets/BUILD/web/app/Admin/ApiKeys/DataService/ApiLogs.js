...
define([
  ...
  let Admin_ApiKeys_DataService_ApiLogs;
  return Admin_ApiKeys_DataService_ApiLogs = (function() {
    Admin_ApiKeys_DataService_ApiLogs = class Admin_ApiKeys_DataService_ApiLogs extends BaseListEdit {
      static initClass() {
        this.$inject = ['Api2', '$q'];
      }
