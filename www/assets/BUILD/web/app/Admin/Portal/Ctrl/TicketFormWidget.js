define(['Admin/Main/Ctrl/Base', 'DeskPRO/Util/Functions', 'jquery'], function(Admin_Ctrl_Base) {
  class Admin_Portal_Ctrl_TicketFormWidget extends Admin_Ctrl_Base {
    ...
    initialLoad() {
      this.Api2.sendGet('/ticket_departments?selectable=1').then(({ data }) => this.$scope.departments = data.data || []);
    ...
    getCode() {
      ...
      return this.Api2.sendGet('/ticket-form-widget/code', params, httpParams).then(response => this.$scope.code = response.data);
    }
  }
