define ['Admin/Main/Ctrl/Base', 'angular'], (Admin_Ctrl_Base, angular) ->
  class AdminPortalCtrlPortalEditor extends Admin_Ctrl_Base
    ...
    save: =>
      request = @$http({
        method: 'PUT',
        url: window.DP_BASE_URL+'brand-'+@$scope.brand_id+'/portal/api/style/edit-theme-set/advanced-edits',
        data: @advanced
      })
    ...
    editTheme: =>
      request = @$http({
        method: 'PUT',
        url: window.DP_BASE_URL+'brand-'+@$scope.brand_id+'/portal/api/style/edit-theme-set/info',
        data: {
    ...
    editWelcomeBox: =>
      request = @$http({
        method: 'PUT',
        url: window.DP_BASE_URL+'brand-'+@$scope.brand_id+'/portal/api/style/edit-theme-set/welcome-message',
    ...
    saveValues: =>
      request = @$http({
        method: 'PUT',
        url: window.DP_BASE_URL+'brand-'+@$scope.brand_id+'/portal/api/style/edit-theme-set/variable-values',
        data: @$scope.values
      })
      @recompiling = true
      request.then(
    ...
    commit: () =>
      @showConfirm('Are you sure you want to apply this changes to the portal?', 'Confirm save').result.then(
        () =>
          ...
          all.then (
            () =>
              @$http.get(window.DP_BASE_URL+'brand-'+@$scope.brand_id+'/portal/api/style/edit-theme-set/commit').then(
    ...
    discard: () =>
      @showConfirm('Are you sure you want to discard all changes you\'ve made?', 'Confirm discard').result.then(
        () =>
          @recompiling = true
          request = @$http.get(window.DP_BASE_URL+'brand-'+@$scope.brand_id+'/portal/api/style/edit-theme-set/discard')
    ...
    initialLoad: =>
      @$q.all([
        @$http.get(window.DP_BASE_URL+'brand-'+@$scope.brand_id+'/portal/api/style/variable-groups').success((data) => @groups = data),
        @loadValues(),
        @loadAdvancedEdits(),
        @loadAssetFiles(),
        @loadLogo(),
    ...
    loadValues: (success) =>
      @$http.get(window.DP_BASE_URL+'brand-'+@$scope.brand_id+'/portal/api/style/edit-theme-set/variable-values').success(
        (values) =>
    ...
    loadTemplateOptions: () =>
      template_options = []
      @$http.get(window.DP_BASE_URL+'brand-'+@$scope.brand_id+'/portal/api/style/edit-theme-set/templates').success(
        (templates) =>
    ...
    editTemplate: =>
      @$http.get(window.DP_BASE_URL+'brand-'+@$scope.brand_id+'/portal/api/style/edit-theme-set/template-info?template=' + @selected_template).success((data) =>
        @selected_template_info = {
          code: data.source,
    ...
    saveTemplateEditor: () =>
      @$http({
        method: 'PUT',
        url: window.DP_BASE_URL+'brand-'+@$scope.brand_id+'/portal/api/style/edit-theme-set/template-sources?template=' + @selected_template,
    ...
    openCssEditor: (type) =>
      ...
      @$http.get(window.DP_BASE_URL+'brand-'+@$scope.brand_id+'/portal/api/style/edit-theme-set/advanced-edits').success((data) =>
        @css_template_info = {
          loaded: true,
          type: type,
          code: data[type]
    ...
    loadAdvancedEdits: (success) =>
      @$http.get(window.DP_BASE_URL+'brand-'+@$scope.brand_id+'/portal/api/style/edit-theme-set/advanced-edits').success(
        (advanced) =>
    ...
    loadAssetFiles: () =>
      @$http.get(window.DP_BASE_URL+'brand-'+@$scope.brand_id+'/portal/api/style/edit-theme-set/assets').success(
        (response) => angular.extend(@asset_files, response.data)
      )

    loadThemeSet: () =>
      @$http.get(window.DP_BASE_URL+'brand-'+@$scope.brand_id+'/portal/api/style/edit-theme-set/info').success((data) =>
        @theme_set = data
        @selected_theme = @theme_set.theme_id
      )

    loadWelcomeBox: () =>
      @$http.get(window.DP_BASE_URL+'brand-'+@$scope.brand_id+'/portal/api/style/edit-theme-set/welcome-message').success((response) =>
        @$scope.welcome_box = response.data
        @welcome_box = angular.copy(@$scope.welcome_box)
      )

    loadLogo: () =>
      @$http.get(window.DP_BASE_URL+'brand-'+@$scope.brand_id+'/portal/api/style/edit-theme-set/logo').success((response) => @custom_logo = response.data?.url)

    loadFavicon: () =>
      @$http.get(window.DP_BASE_URL+'brand-'+@$scope.brand_id+'/portal/api/style/edit-theme-set/favicon').success((response) => @custom_favicon = response.data?.url)

    upload: (files) =>
      for file in files
        @uploading_files_count++
        @$upload.upload({
          url: window.DP_BASE_URL+'brand-'+@$scope.brand_id+'/portal/api/style/edit-theme-set/assets',
          file: file
        }).then(
          (response) =>
            @uploading_files_count--
    ...
    uploadLogo: (files) =>
      @$upload
        .upload({url: window.DP_BASE_URL+'brand-'+@$scope.brand_id+'/portal/api/style/edit-theme-set/logo', file: files[0]})
        .then(
    ...
    uploadFavicon: (files) =>
      @$upload
        .upload({url: window.DP_BASE_URL+'brand-'+@$scope.brand_id+'/portal/api/style/edit-theme-set/favicon', file: files[0]})
        .then(
    ...
    delete: (file) =>
      if window.confirm('Are you sure you want to remove ' + file.name + '?')
        @$http.delete(window.DP_BASE_URL+'brand-'+@$scope.brand_id+'/portal/api/style/edit-theme-set/assets/' + file.id).success(
          () => @asset_files = @asset_files.filter (f) -> f isnt file
        )

    deleteLogo: () =>
      @$http.delete(window.DP_BASE_URL+'brand-'+@$scope.brand_id+'/portal/api/style/edit-theme-set/logo').success(() => @custom_logo = null)

    deleteFavicon: () =>
      @$http.delete(window.DP_BASE_URL+'brand-'+@$scope.brand_id+'/portal/api/style/edit-theme-set/favicon').success(() => @custom_favicon = null)
      ...
      modalInstance = @$modal.open({
        ...
        controller: ['$scope', '$modalInstance', '$http', 'preview_as', ($scope, $modalInstance, $http, preview_as) ->
          ...
          $scope.loadEmails = (val) ->
            $http.get(window.DP_BASE_URL+'brand-'+@$scope.brand_id+'/portal/api/emails?term=' + val + '&target=' + preview_as)
