...
define(['DeskPRO/Util/Util'], function(Util)  {
  let Admin_Portal_Service_PortalGeneralSettings;
  return Admin_Portal_Service_PortalGeneralSettings = (function() {
    Admin_Portal_Service_PortalGeneralSettings = class Admin_Portal_Service_PortalGeneralSettings {
      static initClass() {
