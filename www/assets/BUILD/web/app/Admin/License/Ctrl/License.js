define(['Admin/Main/Ctrl/Base', 'angular'], (Admin_Ctrl_Base, angular) => {
  class Admin_License_Ctrl_License extends Admin_Ctrl_Base {
    ...
    saveLicenseCode() {
      ...
      return this.Api.sendPost('dp_license', postData).success(() => this.DpLicense.getLicInfo(true).then(
          this.reloadLicData().then(() => this.stopSpinner('saving').then(() => this.Growl.success(this.getRegisteredMessage('saved_lic'))))
        )).error((data) => {
