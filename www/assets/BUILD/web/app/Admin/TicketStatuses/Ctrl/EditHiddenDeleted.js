define(['Admin/Main/Ctrl/Base'], function(Admin_Ctrl_Base) {
  class Admin_TicketStatuses_Ctrl_EditHiddenDeleted extends Admin_Ctrl_Base {
    ...
    initialLoad() {
      const promise = this.Api.sendGet("/ticket_statuses/deleted").success( data => {
        return this.$scope.settings.auto_purge_time = data.deleted_info.auto_purge_time;
      });
    ...
    saveSettings() {
      ...
      const promise = this.Api.sendPostJson('/ticket_statuses/deleted/settings', this.$scope.settings).then( () => {
