define(['Admin/Main/Ctrl/Base'], (Admin_Ctrl_Base) => {
  class Admin_Languages_Ctrl_Edit extends Admin_Ctrl_Base {
    ...
    init() {
      ...
      return this.$scope.isDefaultLang = () => this.lang && this.lang.id && (this.lang.id === parseInt(this.$scope.$parent.ListCtrl.default_lang_id));
    }
    ...
    startUninstall() {
      ...
      return inst.result.then(() => {
        ...
        return this.$scope.$parent.ListCtrl.uninstallLang(this.id).then(() => this.$state.go('setup.languages'));
      });
    }
    ...
    doSave() {
      ...
      }).then(() => this.stopSpinner('saving', true));
    }
  }
