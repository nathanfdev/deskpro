define [
	...
	return (Module) ->
		...
		Module.service('BrandData', ['em', 'Api', '$q', (em, Api, $q) ->
		...
		Module.factory('dpObTypesDefTicketFilter', [ '$q', 'Api', 'Api2', 'dpTemplateManager', ($q, Api, Api2, dpTemplateManager) ->
			return new Admin_OptionBuilder_TypesDef_TicketFilter($q, Api, Api2, dpTemplateManager)
		])
