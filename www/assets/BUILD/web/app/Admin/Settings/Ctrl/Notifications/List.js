  ...
  class Admin_Settings_Ctrl_Notifications extends Admin_Ctrl_Base {
    ...
    save() {
      ...
      return this.Api2.sendPutJson('/notify/setup/action-alerts/clients', params).success(
        ...
        () => this.Growl.error('Something went wrong. Please contact your administrator'));
    }
    ...
    testPusher() {
      ...
      , () => this.$scope.pusherTestResult = 'FAILED :: The test did not complete successfully');
    }
    ...
    testDeskpro() {
      ...
      , () => this.$scope.deskproTestResult = 'FAILED :: The test did not complete successfully');
    }
  }
