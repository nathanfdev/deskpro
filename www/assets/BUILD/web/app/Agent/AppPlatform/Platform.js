define([
...
], AppContext => new Orb.Class({
  initialize(ngModule, appsConfig) {
  ...
  start() {
     ...
     * @return {AppContext}
     */
  registerApp(contextClass, appInstanceInfo) {
    let appContext,
      i;
