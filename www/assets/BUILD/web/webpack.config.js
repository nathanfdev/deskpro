...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      ...
      "deskpro_magento":             path.resolve("../../../../../DeskPRO/app/BUILD/apps/deskpro_magento/js/"),
      "deskpro_salesforce":          path.resolve("../../../../../DeskPRO/app/BUILD/apps/deskpro_salesforce/js/"),
      "deskpro_sendgrid":            path.resolve("../../../../../DeskPRO/app/BUILD/apps/deskpro_sendgrid/js/"),
      "deskpro_slack":               path.resolve("../../../../../DeskPRO/app/BUILD/apps/deskpro_slack/js/"),
      "deskpro_us_active_directory": path.resolve("../../../../../DeskPRO/app/BUILD/apps/deskpro_us_active_directory/js/"),
      "deskpro_us_bitium":           path.resolve("../../../../../DeskPRO/app/BUILD/apps/deskpro_us_bitium/js/"),
      "deskpro_us_db":               path.resolve("../../../../../DeskPRO/app/BUILD/apps/deskpro_us_db/js/"),
      "deskpro_us_ezpublish":        path.resolve("../../../../../DeskPRO/app/BUILD/apps/deskpro_us_ezpublish/js/"),
      "deskpro_us_joomla":           path.resolve("../../../../../DeskPRO/app/BUILD/apps/deskpro_us_joomla/js/"),
      "deskpro_us_jwt":              path.resolve("../../../../../DeskPRO/app/BUILD/apps/deskpro_us_jwt/js/"),
      "deskpro_us_ldap":             path.resolve("../../../../../DeskPRO/app/BUILD/apps/deskpro_us_ldap/js/"),
      "deskpro_us_okta":             path.resolve("../../../../../DeskPRO/app/BUILD/apps/deskpro_us_okta/js/"),
      "deskpro_us_onelogin":         path.resolve("../../../../../DeskPRO/app/BUILD/apps/deskpro_us_onelogin/js/"),
