...
const structureNodes = {
  panels: [
    {
      title: 'What is a dog?',
      content: <p>A dog is a type of domesticated animal. Known for its loyalty and faithfulness, it can be found as a welcome guest in many households across the world.</p>
    },
    {
      title: 'What kinds of dogs are there?',
      content: <p>There are many breeds of dogs. Each breed varies in size and temperament. Owners often select a breed of dog that they find to be compatible with their own lifestyle and desires from a companion.</p>
    },
    {
      title: 'How do you acquire a dog?',
      content: [
