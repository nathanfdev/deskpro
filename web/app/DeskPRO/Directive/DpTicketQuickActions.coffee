define ->
    ...
    #
    ###
	DeskPRO_Directive_DpTicketQuickActions = ['$parse', 'formatTimestampAgoFilter', ($parse, formatTimestampAgo) ->
		...
		elements =
			...
			msg: $widget.find('div > span:eq(0)').dotdotdot({elipsis: '...', wrap: 'word', height: 62})
