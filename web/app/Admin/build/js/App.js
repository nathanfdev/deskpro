(function() {
  ...
  define(['angular', 'DP_LANG', 'AdminRouting', 'Admin/Main/Service/AppState', 'Admin/Main/Service/DpApi', 'Admin/Main/Service/Growl', 'Admin/Main/DataService/EntityManager', 'Admin/Main/DataService/Departments'], function(angular, DP_LANG, routing, Admin_Main_Service_AppState, Admin_Main_Service_DpApi, Admin_Main_Service_Growl, Admin_Main_DataService_EntityManager, Admin_Main_DataService_Departments) {
    ...
    Admin_App.directive('dpErrorClass', function() {
      return {
        restrict: 'A',
        link: function(scope, element, attrs) {
    ...
    Admin_App.directive('dpSubmitForm', function() {
      return {
        restrict: 'A',
        link: function(scope, element, attrs) {
