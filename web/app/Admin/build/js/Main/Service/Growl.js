(function() {
  define(['toastr'], function(toastr) {
    var Admin_Main_Service_Growl;
    return Admin_Main_Service_Growl = (function() {
      function Admin_Main_Service_Growl(options) {
      ...
      */
      ...
      Admin_Main_Service_Growl.prototype._getContent = function(content) {
        var message, title;
      ...
      */
      ...
      Admin_Main_Service_Growl.prototype._getOptions = function(options) {
        if (!options) {
          return {};
        }
      ...
      */
      ...
      Admin_Main_Service_Growl.prototype.error = function(content, options) {
      ...
      */
      ...
      Admin_Main_Service_Growl.prototype.info = function(content, options) {
        var message, title, _ref;
        _ref = this._getContent(content), title = _ref[0], message = _ref[1];
        options = this._getOptions(options);
      ...
      */
      ...
      Admin_Main_Service_Growl.prototype.success = function(content, options) {
        var message, title, _ref;
        _ref = this._getContent(content), title = _ref[0], message = _ref[1];
        options = this._getOptions(options);
      ...
      */
      ...
      Admin_Main_Service_Growl.prototype.warning = function(content, options) {
        var message, title, _ref;
        _ref = this._getContent(content), title = _ref[0], message = _ref[1];
        options = this._getOptions(options);
      ...
      */
      ...
      Admin_Main_Service_Growl.prototype.clearAll = function() {
        return toastr.clear();
      };
      ...
      */
      ...
      Admin_Main_Service_Growl.prototype.clearNotif = function(notify) {
        return toastr.clear(notify);
      };

      return Admin_Main_Service_Growl;
