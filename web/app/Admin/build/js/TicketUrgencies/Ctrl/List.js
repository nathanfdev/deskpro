(function() {
  ...
  define(['Admin/Main/Ctrl/Base', 'Admin/App'], function(Admin_Ctrl_Base) {
    var Admin_TicketUrgencies_Ctrl_List, _ref;
    Admin_TicketUrgencies_Ctrl_List = (function(_super) {
      ...
      function Admin_TicketUrgencies_Ctrl_List() {
        _ref = Admin_TicketUrgencies_Ctrl_List.__super__.constructor.apply(this, arguments);
        return _ref;
      }
      ...
      Admin_TicketUrgencies_Ctrl_List.prototype.initialLoad = function() {
        var promise,
          _this = this;
        promise = this.Api.sendGet("/ticket_urgencies").success(function(data) {
          var num, _i, _results;
