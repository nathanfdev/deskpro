(function() {
  ...
  define(['Admin/Main/Ctrl/Base'], function(Admin_Ctrl_Base) {
    var Admin_KbSettings_Ctrl_KbSettings, _ref;
    Admin_KbSettings_Ctrl_KbSettings = (function(_super) {
      ...
      function Admin_KbSettings_Ctrl_KbSettings() {
        _ref = Admin_KbSettings_Ctrl_KbSettings.__super__.constructor.apply(this, arguments);
        return _ref;
      }
      ...
      */
      ...
      Admin_KbSettings_Ctrl_KbSettings.prototype.initialLoad = function() {
        var data_promise,
          _this = this;
        data_promise = this.Api.sendGet('/enable_settings/app_kb').then(function(res) {
