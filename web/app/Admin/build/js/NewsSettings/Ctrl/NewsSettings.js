(function() {
  ...
  define(['Admin/Main/Ctrl/Base'], function(Admin_Ctrl_Base) {
    var Admin_NewsSettings_Ctrl_NewsSettings, _ref;
    Admin_NewsSettings_Ctrl_NewsSettings = (function(_super) {
      ...
      function Admin_NewsSettings_Ctrl_NewsSettings() {
        _ref = Admin_NewsSettings_Ctrl_NewsSettings.__super__.constructor.apply(this, arguments);
        return _ref;
      }
      ...
      */
      ...
      Admin_NewsSettings_Ctrl_NewsSettings.prototype.initialLoad = function() {
        var data_promise,
          _this = this;
        data_promise = this.Api.sendGet('/enable_settings/app_news').then(function(res) {
