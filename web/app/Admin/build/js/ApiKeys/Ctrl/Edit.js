    ...
    Admin_ApiKeys_Ctrl_Edit = (function(_super) {
      ...
      */
      ...
      Admin_ApiKeys_Ctrl_Edit.prototype.initialLoad = function() {
        var promise,
          _this = this;
        promise = this.keyData.loadEditApiKeyData(this.$stateParams.id || null).then(function(data) {
