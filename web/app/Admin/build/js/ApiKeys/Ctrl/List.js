    ...
    Admin_ApiKeys_Ctrl_List = (function(_super) {
      ...
      */
      ...
      Admin_ApiKeys_Ctrl_List.prototype.initialLoad = function() {
        var promise,
          _this = this;
        promise = this.keyData.loadList().then(function(list) {
      ...
      */
      ...
      Admin_ApiKeys_Ctrl_List.prototype.startDelete = function(for_key_id) {
        ...
        return inst.result.then(function() {
          return _this.deleteUserRule(key);
        });
      };
      ...
      */
      ...
      Admin_ApiKeys_Ctrl_List.prototype.deleteUserRule = function(for_key) {
        var _this = this;
