(function() {
  define(['angular'], function(angular) {
    var AdminModule;
    AdminModule = angular.module('Admin_App', ['ngAnimate', 'ngSanitize', 'ui.router', 'ui.bootstrap', 'ui.select2', 'ui.sortable', 'ui.ace', 'angularMoment', 'blueimp.fileupload', 'uiSlider', 'ngGrid', 'deskpro.option_builder', 'deskpro.category_builder']);
    AdminModule.config([
