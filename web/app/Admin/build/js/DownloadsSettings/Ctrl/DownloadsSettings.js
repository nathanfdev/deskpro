(function() {
  ...
  define(['Admin/Main/Ctrl/Base'], function(Admin_Ctrl_Base) {
    var Admin_DownloadsSettings_Ctrl_DownloadsSettings, _ref;
    Admin_DownloadsSettings_Ctrl_DownloadsSettings = (function(_super) {
      ...
      function Admin_DownloadsSettings_Ctrl_DownloadsSettings() {
        _ref = Admin_DownloadsSettings_Ctrl_DownloadsSettings.__super__.constructor.apply(this, arguments);
        return _ref;
      }
      ...
      */
      ...
      Admin_DownloadsSettings_Ctrl_DownloadsSettings.prototype.initialLoad = function() {
        var data_promise,
          _this = this;
        data_promise = this.Api.sendGet('/enable_settings/app_downloads').then(function(res) {
