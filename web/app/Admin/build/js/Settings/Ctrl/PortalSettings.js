(function() {
  ...
  define(['Admin/Main/Ctrl/Base', 'angular'], function(Admin_Ctrl_Base, angular) {
    var Admin_Settings_Ctrl_PortalSettings, _ref;
    Admin_Settings_Ctrl_PortalSettings = (function(_super) {
      ...
      function Admin_Settings_Ctrl_PortalSettings() {
        _ref = Admin_Settings_Ctrl_PortalSettings.__super__.constructor.apply(this, arguments);
        return _ref;
      }
      ...
      Admin_Settings_Ctrl_PortalSettings.prototype.save = function() {
        ...
        return promise = this.Api.sendPostJson('/portal_settings', postData).success(function() {
