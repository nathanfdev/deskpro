(function() {
  ...
  define(['Admin/Main/Ctrl/Base'], function(Admin_Ctrl_Base) {
    var Admin_Templates_Ctrl_TemplateEditor, _ref;
    Admin_Templates_Ctrl_TemplateEditor = (function(_super) {
      ...
      function Admin_Templates_Ctrl_TemplateEditor() {
        _ref = Admin_Templates_Ctrl_TemplateEditor.__super__.constructor.apply(this, arguments);
        return _ref;
      }
      ...
      Admin_Templates_Ctrl_TemplateEditor.prototype.initialLoad = function() {
        var promise,
          _this = this;
        promise = this.Api.sendGet("/templates/" + this.templateName).success(function(data) {
          _this.tpl = data;
