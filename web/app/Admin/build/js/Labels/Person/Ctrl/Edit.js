(function() {
  ...
  define(['Admin/Labels/Base/Ctrl/Edit', 'Admin/App'], function(Admin_Labels_Base_Ctrl_Edit) {
    ...
    Admin_Labels_Person_Ctrl_Edit = (function(_super) {
      ...
      Admin_Labels_Person_Ctrl_Edit.CTRL_AS = 'LabelsEdit';

      Admin_Labels_Person_Ctrl_Edit.DEPS = ['em', '$stateParams', '$rootScope', 'LabelManager'];

      Admin_Labels_Person_Ctrl_Edit.CTRL_TYPE = 'page';

      Admin_Labels_Person_Ctrl_Edit.prototype.init = function() {
        Admin_Labels_Person_Ctrl_Edit.__super__.init.call(this);
        this.api_endpoint = '/person_labels';
        this.ng_route = 'crm.user_labels';
        return this.typename = 'labels_people';
      };

      return Admin_Labels_Person_Ctrl_Edit;

    })(Admin_Labels_Base_Ctrl_Edit);
    return Admin_Labels_Person_Ctrl_Edit.EXPORT_CTRL();
  });
