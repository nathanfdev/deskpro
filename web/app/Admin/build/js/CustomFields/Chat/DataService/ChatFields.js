(function() {
  ...
  define(['Admin/Main/DataService/BaseListEdit', 'Admin/CustomFields/FieldFormMapper'], function(BaseListEdit, FieldFormMapper) {
    ...
    return ChatFields = (function(_super) {
      ...
      function ChatFields() {
        _ref = ChatFields.__super__.constructor.apply(this, arguments);
        return _ref;
      }
      ...
      ChatFields.prototype._doLoadList = function() {
        ...
        this.Api.sendDataGet(['/chat_fields']).then(function(res) {
          var custom_fields, f, _i, _len, _ref1;
          custom_fields = [];
          _ref1 = res.data.api_chat_fields.custom_fields;
      ...
      */
      ...
      ChatFields.prototype.deleteFieldById = function(id) {
        var promise,
          _this = this;
        promise = this.Api.sendDelete('/chat_fields/' + id).then(function() {
      ...
      */
      ...
      ChatFields.prototype.loadEditFieldData = function(id) {
        ...
        deferred = this.$q.defer();
        if (id) {
          this.Api.sendGet("/chat_fields/" + id).then(function(result) {
            var data;
            data = {};
