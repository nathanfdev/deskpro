(function() {
  ...
  define(['Admin/Main/DataService/BaseListEdit', 'Admin/CustomFields/FieldFormMapper'], function(BaseListEdit, FieldFormMapper) {
    var TicketFields, _ref;
    return TicketFields = (function(_super) {
      __extends(TicketFields, _super);

      function TicketFields() {
        _ref = TicketFields.__super__.constructor.apply(this, arguments);
        return _ref;
      }
      ...
      TicketFields.prototype._doLoadList = function() {
        ...
        this.Api.sendDataGet(['/ticket_fields']).then(function(res) {
          var custom_fields, f, _i, _j, _len, _len1, _ref1, _ref2;
          _ref1 = ['category', 'priority', 'workflow', 'product'];
          ...
          custom_fields = [];
          _ref2 = res.data.api_ticket_fields.custom_fields;
      ...
      */
      ...
      TicketFields.prototype.deleteFieldById = function(id) {
        var promise,
          _this = this;
        promise = this.Api.sendDelete('/ticket_fields/' + id).then(function() {
      ...
      */
      ...
      TicketFields.prototype.loadEditFieldData = function(id) {
        ...
        deferred = this.$q.defer();
        if (id) {
          this.Api.sendGet("/ticket_fields/" + id).then(function(result) {
            var data;
            data = {};
