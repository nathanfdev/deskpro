(function() {
  ...
  define(['Admin/Main/Ctrl/Base', 'angular'], function(Admin_Ctrl_Base, angular) {
    var Admin_ServerMysqlSortOrder_Ctrl_ServerMysqlSortOrder, _ref;
    Admin_ServerMysqlSortOrder_Ctrl_ServerMysqlSortOrder = (function(_super) {
      ...
      function Admin_ServerMysqlSortOrder_Ctrl_ServerMysqlSortOrder() {
        _ref = Admin_ServerMysqlSortOrder_Ctrl_ServerMysqlSortOrder.__super__.constructor.apply(this, arguments);
        return _ref;
      }
      ...
      Admin_ServerMysqlSortOrder_Ctrl_ServerMysqlSortOrder.prototype.initialLoad = function() {
        var data_promise,
          _this = this;
        data_promise = this.Api.sendGet('/server_mysql_sort_order').then(function(res) {
      ...
      Admin_ServerMysqlSortOrder_Ctrl_ServerMysqlSortOrder.prototype.save = function() {
        ...
        return this.Api.sendPostJson('/server_mysql_sort_order', postData).success(function() {
