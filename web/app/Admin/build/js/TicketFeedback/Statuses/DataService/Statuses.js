(function() {
  ...
  define(['Admin/Main/DataService/Base', 'Admin/Main/Model/Base', 'Admin/Main/Collection/OrderedDictionary'], function(Admin_Main_DataService_Base, Admin_Main_Model_Base, Admin_Main_Collection_OrderedDictionary) {
    var Admin_TicketFeedbackStatuses_DataService;
    return Admin_TicketFeedbackStatuses_DataService = (function(_super) {
      __extends(Admin_TicketFeedbackStatuses_DataService, _super);

      function Admin_TicketFeedbackStatuses_DataService(em, Api, $q) {
        Admin_TicketFeedbackStatuses_DataService.__super__.constructor.call(this, em);
        this.$q = $q;
        this.Api = Api;
      ...
      */
      ...
      Admin_TicketFeedbackStatuses_DataService.prototype.loadList = function(reload) {
        ...
        http_def = this.Api.sendGet('/feedback/statuses').success(function(data, status, headers, config) {
      ...
      Admin_TicketFeedbackStatuses_DataService.prototype.remove = function(id) {
        this.recs.remove(id);
        return this.em.removeById('feedback_status', 'id');
      };

      Admin_TicketFeedbackStatuses_DataService.prototype._setListData = function(raw_recs) {
      ...
      */
      ...
      Admin_TicketFeedbackStatuses_DataService.prototype.updateModel = function(status) {
        var new_model;
        new_model = this.em.createEntity('feedback_status', 'id', status);
      ...
      */
      ...
      Admin_TicketFeedbackStatuses_DataService.prototype.addToList = function(rec) {
        var model;
        if (!rec._is_model) {
          model = this.em.createEntity('feedback_status', 'id', rec);
        } else {
      ...
      return Admin_TicketFeedbackStatuses_DataService;
