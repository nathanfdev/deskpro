(function() {
  ...
  define(['Admin/Main/Ctrl/Base'], function(Admin_Ctrl_Base) {
    var Admin_TicketFields_Ctrl_EditPriorities, _ref;
    Admin_TicketFields_Ctrl_EditPriorities = (function(_super) {
      ...
      function Admin_TicketFields_Ctrl_EditPriorities() {
        _ref = Admin_TicketFields_Ctrl_EditPriorities.__super__.constructor.apply(this, arguments);
        return _ref;
      }
      ...
      Admin_TicketFields_Ctrl_EditPriorities.prototype.save = function() {
        ...
        return promise = this.Api.sendPostJson('/ticket_pris', postData).success(function() {
