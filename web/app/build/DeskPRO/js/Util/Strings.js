(function() {
  ...
  define(function() {
    ...
    DeskPRO_Util_Strings = (function() {
      ...
      DeskPRO_Util_Strings.prototype.getDiacriticsMap = function() {
        var diacriticsRemovalMap, info, letter, _i, _j, _len, _len1, _ref;
        ...
        this._diacriticsMap = {};
        for (_i = 0, _len = diacriticsRemovalMap.length; _i < _len; _i++) {
          info = diacriticsRemovalMap[_i];
          _ref = info.letters.split("");
      ...
      DeskPRO_Util_Strings.prototype.stripDiacritics = function(str) {
        var map;
        map = this.getDiacriticsMap();
