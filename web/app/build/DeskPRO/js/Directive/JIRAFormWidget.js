(function() {
  define(function() {
    return function($compile) {
      var remap, templates;
      templates = {
        'com.atlassian.jira.plugin.system.customfieldtypes:textfield': "<input type=\"text\" ng-model=\"value\" ng-required=\"field.required\" />",
        'com.atlassian.jira.plugin.system.customfieldtypes:textarea': "<textarea ng-model=\"value\" ng-required=\"field.required\"></textarea>",
        'com.atlassian.jira.plugin.system.customfieldtypes:select': "<select  ui-select2 ng-model=\"value\" style=\"min-width: 200px;\" ng-required=\"field.required\" data-placeholder=\"Choose one\">\n  <option value=\"\"></option>\n  <option ng-repeat=\"val in field.allowedValues\" ng-value=\"val.id\">{{ field.schema.system ? val.name : val.value }}</option>\n</select>",
        'com.atlassian.jira.plugin.system.customfieldtypes:multiselect': "<select ui-select2 ng-model=\"value\" style=\"min-width: 200px;\" multiple ng-required=\"field.required\">\n  <option ng-repeat=\"val in field.allowedValues\" ng-value=\"val.id\">{{ field.schema.system ? val.name : val.value }}</option>\n</select>",
        'com.atlassian.jira.plugin.system.customfieldtypes:multicheckboxes': "<label ng-repeat=\"val in field.allowedValues\" ng-init=\"$parent.value = []\">\n  <input type=\"checkbox\" ng-value=\"val.id\"\n      ng-checked=\"$parent.value.indexOf(val.id) > -1\"\n      ng-click=\"checkboxToggle(val.id)\"\n      />\n  {{ field.schema.system ? val.name : val.value }}\n</label>",
        'com.atlassian.jira.plugin.system.customfieldtypes:radiobuttons': "<label ng-repeat=\"val in field.allowedValues\">\n  <input name=\"{{ field.id }}\" type=\"radio\" ng-value=\"val.id\" ng-model=\"$parent.value\" />\n  {{ field.schema.system ? val.name : val.value }}\n</label>",
        'com.atlassian.jira.plugin.system.customfieldtypes:labels': "<input type=\"text\" ui-select2=\"{multiple: true, simple_tags: true, tags: []}\" ng-model=\"value\" ng-required=\"field.required\" />",
        'com.atlassian.jira.plugin.system.customfieldtypes:datepicker': "<div class=\"dropdown\" style=\"display: inline-block\">\n  <a class=\"dropdown-toggle\" role=\"button\" data-toggle=\"dropdown\" data-target=\"#\" href=\"#\">\n    <div class=\"input-group\">\n      <input type=\"text\" class=\"form-control\" ng-model=\"value\" ng-required=\"field.required\">\n      <span class=\"input-group-addon\"><i class=\"fa fa-calendar\"></i></span>\n    </div>\n  </a>\n  <ul class=\"dropdown-menu\">\n    <datetimepicker ng-model=\"value\" data-datetimepicker-config=\"{minView: 'day'}\"/>\n  </ul>\n</div>",
        'com.atlassian.jira.plugin.system.customfieldtypes:datetime': "<div class=\"dropdown\" style=\"display: inline-block\">\n  <a class=\"dropdown-toggle\" role=\"button\" data-toggle=\"dropdown\" data-target=\"#\" href=\"#\">\n    <div class=\"input-group\">\n      <input type=\"text\" class=\"form-control\" ng-model=\"value\" ng-required=\"field.required\">\n      <span class=\"input-group-addon\"><i class=\"fa fa-calendar\"></i></span>\n    </div>\n  </a>\n  <ul class=\"dropdown-menu\">\n    <datetimepicker ng-model=\"value\" data-datetimepicker-config=\"{minView: 'minute'}\"/>\n  </ul>\n</div>"
      };
      remap = {
      ...
      return {
        ...
        link: function($scope, $el, $attr) {
          ...
          if (!(field != null ? field.schema : void 0)) {
            return;
          }
