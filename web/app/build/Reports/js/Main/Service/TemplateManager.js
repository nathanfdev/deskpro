(function() {
  ...
  define(function() {
    var Reports_Main_Service_TemplateManager;
    Reports_Main_Service_TemplateManager = (function() {
      function Reports_Main_Service_TemplateManager($templateCache, $http, $q) {
