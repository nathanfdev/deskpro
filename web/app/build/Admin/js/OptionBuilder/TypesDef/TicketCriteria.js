  ...
  define(['Admin/OptionBuilder/TypesDef/BaseCriteriaTypesDef'], function(BaseCriteriaTypesDef) {
    ...
    return Admin_OptionBuilder_TypesDef_TicketCriteria = (function(_super) {
      ...
      Admin_OptionBuilder_TypesDef_TicketCriteria.prototype.getOptionsForTypes = function(types, typesData) {
        var f, options, set_options, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
        if (typesData == null) {
          typesData = null;
        }
        set_options = [];
        ...
        if (this.options_data.ticket_fields) {
          _ref2 = this.options_data.ticket_fields;
        ...
        if (this.options_data.contextual_fields) {
          _ref3 = this.options_data.contextual_fields;
