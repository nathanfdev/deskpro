(function() {
  ...
  define(['DeskPRO/Util/Arrays', 'Admin/Main/Ctrl/Base', 'Admin/TicketTriggers/TriggerEditFormMapper'], function(Arrays, Admin_Ctrl_Base, TriggerEditFormMapper) {
    var Admin_TicketTriggers_Ctrl_EditBase;
    return Admin_TicketTriggers_Ctrl_EditBase = (function(_super) {
      __extends(Admin_TicketTriggers_Ctrl_EditBase, _super);

      function Admin_TicketTriggers_Ctrl_EditBase() {
        return Admin_TicketTriggers_Ctrl_EditBase.__super__.constructor.apply(this, arguments);
      }

      Admin_TicketTriggers_Ctrl_EditBase.CTRL_ID = 'Admin_TicketTriggers_Ctrl_Edit';

      Admin_TicketTriggers_Ctrl_EditBase.CTRL_AS = 'TicketTriggersEdit';

      Admin_TicketTriggers_Ctrl_EditBase.DEPS = ['dpObTypesDefTicketCriteria', 'dpObTypesDefTicketActions'];

      Admin_TicketTriggers_Ctrl_EditBase.prototype.init = function() {
      ...
      Admin_TicketTriggers_Ctrl_EditBase.prototype.customInit = function() {
        return null;
      };

      Admin_TicketTriggers_Ctrl_EditBase.prototype.updateCriteriaOptionTypes = function() {
      ...
      Admin_TicketTriggers_Ctrl_EditBase.prototype.initialLoad = function() {
