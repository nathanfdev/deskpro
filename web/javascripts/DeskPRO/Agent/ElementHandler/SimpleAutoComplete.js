...
DeskPRO.Agent.ElementHandler.SimpleAutoComplete = new Orb.Class({
	...
	initPage: function() {
        var self = this;
        this.searchUrl = BASE_URL + 'old-agent/people-search/search-quick?format=json&limit=10&start_with=a';
        this.el.on('click focus', '.cc-people-search-trigger', function() {
            self.open();
        });
	},
