...
DeskPRO.Agent.PageHelper.ValidatingEdit = new Orb.Class({
	...
	approveEdit: function() {
		$.ajax({
			url: BASE_URL + 'old-agent/publish/content/approve/' + this.options.typename + '/' + this.options.contentId + '.json?specific_type=' + this.options.singleType,
			type: 'POST',
			context: this,
			dataType: 'json',
	...
	disapproveEdit: function() {
		...
		$.ajax({
			url: BASE_URL + 'old-agent/publish/content/disapprove/' + this.options.typename + '/' + this.options.contentId + '.json?specific_type=' + this.options.singleType,
			type: 'POST',
			context: this,
			data: {reason: reason},
			dataType: 'json',
	...
	skipValidateEdit: function() {
		$.ajax({
			url: BASE_URL + 'old-agent/publish/content/get-next-validating/' + this.options.typename + '/' + this.options.contentId + '.json?specific_type=' + this.options.singleType,
			type: 'POST',
			context: this,
			dataType: 'json',
			success: function(info) {
