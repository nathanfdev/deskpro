...
/**
 * Positions a popover that scrolls with SLA items
 */
DeskPRO.Agent.Widget.SlaOptionsPop = new Orb.Class({
	...
	initialize: function(options) {
		this.options = {
			 ...
			 * @option {jQuery}
			 */
			controlEl: '#ticket_sla_group_editor',
	...
	_initControl: function() {
		...
		this.controlRealEl = $('.sla-group-editor', this.controlEl);
