...
export class ViewOptionsSubmenu extends Component {
  ...
  render() {
    const {viewModeOptions, listViewFields, tableViewFields, viewMode, displayFieldsStatus} = this.props;
    return (
      <div className="dpw-navigation-dropdown dpw-navigation-dropdown-secondary">
        <ul>
          {viewModeOptions.map((option, index)=>
              <ViewConfigOption key={index} active={viewMode === option.field} option={option}
