...
const initialState = {
  ...
  messages: [
    {id: 104, content: 'my message my message my message my message', author: null, is_sys: false},
    {id: 103, content: 'agent reply agent reply agent reply agent reply agent reply agent reply', author: 1, is_sys: false},
